...
<!--
UWR 996273: R10.9 Drop 2 - 04/29/2025 - Updated By Developer Fahd M. Saleem
-->
...
-->
	<xsl:template match="/">
		...
		<html lang="EN-US">
            ...
            OMB No. 1545-0123
              ...
              <br/>
					...
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="padding-left:0mm">1</div>
						<div class="styLNDesc">
			    ...
			    <span style="width:2px;"/>
					...
					<!-- Schedule A, line 2 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="padding-left:0mm">2</div>
						<div class="styLNDesc">
					...
					<!-- Schedule A, line 3 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="padding-left:0mm">3</div>
						<div class="styLNDesc">
					...
					<!-- Schedule A, line 4 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="padding-left:0mm">4</div>
						<div class="styLNDesc">
			    ...
			    <span style="width:2px;"/>
					...
					<!-- Schedule A, line 5 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="padding-left:0mm">5</div>
						<div class="styLNDesc">
			    ...
			    <span style="width:2px;"/>
					...
					<!-- Schedule A, line 6 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="padding-left:0mm">6</div>
						<div class="styLNDesc">
					...
					<!-- Schedule A, line 7 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="padding-left:0mm">7</div>
						<div class="styLNDesc">
					...
					<!-- Schedule A, line 8 -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="padding-left:0mm">8</div>
						<div class="styLNDesc">
			      ...
			      <span style="float:left">
			       appropriate line of your tax return. See instructions
					...
					<!-- Schedule A, line 9a -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBoxSD" style="height:4.5mm;padding-top:1.5mm;padding-left: 0mm;">9a</div>
						<div class="styLNDesc" style="width:178mm;height:4.5mm;padding-top:1.5mm;">
						Check all methods used for accounting and valuing closing inventory.  See instructions.
						 </div>
					</div>
         ...
         Cost
				...
				Other (Specify method used and attach explanation.)
					...
					<label style="padding-left:8.5mm;">For certain small business taxpayers, alternative methods of accounting for inventories: </label>
					
					<!-- Schedule A, line 9a(iv) -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:4.5mm;"/>
						<div class="styGenericDiv" style="height:4mm; text-align:right; width:5mm; padding-top:1.8mm;">
							<i>(iv)</i>
						...
						<div class="styLNDesc" style="width:170mm;height:4.5mm;vertical-align:baseline;">
							<input type="checkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form1125AData/NonincidentalMtrlSupMethodInd"/>
									<xsl:with-param name="BackupName">IRS1125AScheduleANonincidentalMtrlSupMethod</xsl:with-param>
								</xsl:call-template>
							</input>
							<label>
								<xsl:call-template name="PopulateLabel">
				...
				Non-Incidental Materials and Supplies Method
			  </label>
						</div>
					</div>
					
					<!-- Schedule A, line 9a(v) -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:4.5mm;"/>
						<div class="styGenericDiv" style="height:4mm; text-align:right; width:5mm; padding-top:1.8mm;">
							<i>(v)</i>
						...
						<div class="styLNDesc" style="width:170mm;height:4.5mm;vertical-align:baseline;">
							<input type="checkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form1125AData/AFSMethodInd"/>
									<xsl:with-param name="BackupName">IRS1125AScheduleAAFSMethod</xsl:with-param>
								</xsl:call-template>
							</input>
							<label>
								<xsl:call-template name="PopulateLabel">
				...
				AFS Method
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:170mm;height:4.5mm;vertical-align:baseline;">
							<input type="checkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form1125AData/NonAFSMethodInd"/>
									<xsl:with-param name="BackupName">IRS1125AScheduleANonAFSMethod</xsl:with-param>
								</xsl:call-template>
							</input>
							<label>
								<xsl:call-template name="PopulateLabel">
				...
				Non-AFS Method 
					...
					<!-- Schedule A, line 9b -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:4.5mm;padding-top:3mm;padding-left:1.5mm;">b</div>
					...
					<!-- Schedule A, line 9c -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:4.5mm;padding-top:2mm;padding-left:1.5mm;">c</div>
                ...
                <label for="LIFOCheck">
					...
					<!-- Schedule A, line 9d(i) -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:7mm;padding-left:1.5mm;">d<i>(i)</i></div>
			  ...
			  <span style="float:left;">under LIFO </span>
					...
					<!-- Schedule A, line 9d(ii) -->
					<div style="width:187mm;padding-top:2.5mm;">
						<div class="styLNLeftNumBox" style="height:7mm;padding-left:1.5mm;">d<i>(ii)</i></div>
						<div class="styLNDesc" style="height:7mm;">
			  If the LIFO inventory method was used for this tax year, enter amount of the closing LIFO Reserve
							<!--Dotted Line-->
							<div class="styDotLn" style="float:right;">..................................</div>
						</div>
						<div class="styGenericDiv" style="width:35mm;height:3mm;"/>
						<div style="float:right; white-space:nowrap;">
							...
							<div class="styLNAmountBox">
								<xsl:choose>
									<xsl:when test="$Form1125AData/LIFOClosingReservePercent">
										<xsl:call-template name="PopulatePercent">
											<xsl:with-param name="TargetNode" select="$Form1125AData/LIFOClosingReservePercent"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:when test="$Form1125AData/LIFOClosingReserveAmt">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form1125AData/LIFOClosingReserveAmt"/>
										</xsl:call-template>
									</xsl:when>
									<xsl:otherwise/>
								</xsl:choose>
					...
					<!-- Schedule A, line 9e -->
					<div style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:4.5mm;padding-top:1.5mm;padding-left:1.5mm;">e</div>
				  ...
				  No
					...
					<!-- Schedule A, line 9f -->
					<div class="styBB" style="width:187mm;">
						<div class="styLNLeftNumBox" style="height:7mm;padding-top:1.5mm;padding-left:1.5mm;">f</div>
       ...
       Cat. No. 55988R 
        ...
        Form <span class="styBoldText" style="font-size:8pt;">1125-A</span> (11-2024)
    </div>
					</div>
					<!-- END PAGE I FOOTER -->
