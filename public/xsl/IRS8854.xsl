...
<!-- Last modified 09/03/2025 by Yee Chen - F8854 - TY2025-->
	...
	<xsl:template name="SetPageEndFooter">
		...
		<div class="pageEnd" style="width:187mm;padding-top:1mm;">
			...
			<div style="float:right;">
				...
				Form <span class="styBoldText" style="font-size:8pt;">8854</span> (2025)
			</div>
		</div>
		...
		<div class="styTBB" style="width:187mm;padding-top:.5mm;float:none;clear:both;">
			<div style="float:left;">
				Form 8854 (2025)<span style="width:148mm;"/>
			</div>
			<div style="float:right;">
		...
		<html lang="EN-US">
				...
				<form name="IRS8854">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:2px;height:auto;">
						...
						<div class="styFTBox" style="width:130mm;height:22mm;">
							<div class="styMainTitle" style="height:10mm;padding-top:5mm;">Initial and Annual Expatriation Statement</div>
							<!-- BEGIN:	2nd Title -->
					...
					<div class="styStdDiv" style="height:6mm;  border-bottom:1px solid black; ">
						...
						<span style="width:25mm;padding-left:3px;text-align:center;border-bottom:2px solid black;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8854LineItem" style="margin-bottom:3mm;">
							...
							<div class="styIRS8854LNDesc" style="width:179mm">
								...
								<input type="checkbox" aria-label="Initial expatriation statement" class="styCkbox">
								...
								Initial expatriation statement for persons who expatriated in 2025. Complete Part II.
								<br/>
								<!-- ++++++++++++++ 2nd Checkbox +++++++++++++ -->
								<span style="width:1mm;"/>
								<input type="checkbox" aria-label="Annual expatriation statement" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
								...
								<span style="width:2mm;"/>
									Annual expatriation statement for persons who expatriated before 2025. Complete Part III.
								<br/>
							</div>
						</div>
						<!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
						...
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="width:179mm">
								...
								<!-- ++++++++++++++ 1st Checkbox +++++++++++++ -->
								<span style="width:1mm;"/>
								<input type="checkbox" aria-label="Citizen" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
								...
								<!-- ++++++++++++++ 2nd Checkbox +++++++++++++ -->
								<span style="width:1mm;"/>
								<input type="checkbox" aria-label="Long-term resident" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
								...
								<!-- ++++++++++++++ 3rd Checkbox +++++++++++++ -->
								<span style="width:1mm;"/>
								<input type="checkbox" aria-label="Long-term resident with dual residency" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styIRS8854LineItem" style="margin-bottom:2mm;">
							...
							<div class="styIRS8854LNDesc" style="width:179mm">
								...
								<input type="checkbox" aria-label="USCitizenByBirthInd" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
								...
								<input type="checkbox" aria-label="USCitizenByNaturalizationInd" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styIRS8854LineItem" style="margin-bottom:2mm; margin-left:2mm;">
							...
							<div class="styIRS8854LNDesc" style="width:179mm">
								...
								<span style="width:50mm;border-bottom:1px dashed black;">
										<xsl:call-template name="PopulateMonthDayYear">
											<xsl:with-param name="TargetNode" select="$Form8854Data/LawfulPrmnntResRescindDt"/>
										</xsl:call-template>
										<span style="width:7mm;"/>
								</span>
							</div>
						...
						<div class="styIRS8854LineItem" style="margin-bottom:2mm; margin-left:2mm;">
							...
							<div class="styIRS8854LNDesc" style="width:179mm">
								...
								<span style="width:80mm;border-bottom:1px dashed black;">
										<xsl:call-template name="PopulateMonthDayYear">
											<xsl:with-param name="TargetNode" select="$Form8854Data/RelinquishedPermanentResCardDt"/>
										</xsl:call-template>
										<span style="width:7mm;"/>
								</span>
							</div>
					...
					<div style="width:187mm;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;">
							Initial Expatriation Statement for Persons Who Expatriated in 2025
						</div>
					</div>
					<!-- END: Part II (Header)-->
					<!-- END Page Header -->
					...
					<div class="styTBB" style="width:187mm;float:none;display:block;">
						...
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="width:144mm">
								Have there been significant changes in your assets and liabilities for the 5 years ending before the date of your expatriation? See Instructions
								<span style="width:1px"/>
								<span class="styBoldText" sytle="width:11px;">
									<span style="width:11px"/>.
									<span style="width:11px"/>.
									<span style="width:11px"/>.
									<span style="width:11px"/>.
								...
								<xsl:call-template name="SetFormLinkInline">
									<xsl:with-param name="TargetNode" select="$Form8854Data/ExpatriationInformationGrp/ChangeAstLiab5YrBfrExptrtInd"/>
								</xsl:call-template>
							</div>
							<div class="styIRS8854LNDesc" style="width:35mm;padding-top:14px;">
								...
								<span>
									...
									<input type="checkbox" aria-label="asset and liabilities five years Yes check box checked" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/ExpatriationInformationGrp/ChangeAstLiab5YrBfrExptrtInd"/>
											<xsl:with-param name="BackupName">IRS8854ChangeAstLiab5YrBfrExptrtInd</xsl:with-param>
										</xsl:call-template>
									</input>
								</span>
								<span style="width:1mm;"/>
								...
								<span>
									...
									<input type="checkbox" aria-label="asset and liabilities five years No check box not checked" class="styCkbox">
						...
						<!-- \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\ -->
						<div class="styIRS8854LineItem">
							<div class="styIRS8854LNLeftNumBox" style="padding-top:2mm;">4</div>
							<div class="styIRS8854LNDesc" style="width:144mm;padding-top:2mm;">
							...
							<div class="styIRS8854LNDesc" style="width:35mm;padding-top:14px;">
								...
								<span>
									...
									<input type="checkbox" aria-label="birth citizen Yes check box not checked" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/ExpatriationInformationGrp/DualCitizenBirthUSOthCntryInd"/>
								...
								<span>
									...
									<input type="checkbox" aria-label="birth citizen No check box checked" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/ExpatriationInformationGrp/DualCitizenBirthUSOthCntryInd"/>
											<xsl:with-param name="BackupName">IRS8854DualCitizenAtBirthAndContInd</xsl:with-param>
										</xsl:call-template>
						...
						<div class="styIRS8854LineItem">
							<div class="styIRS8854LNLeftNumBox">5</div>
							<div class="styIRS8854LNDesc" style="width:144mm">
								If you answered "Yes" to question 4, have you been a resident of the United States for not more than 10 of<br/>
							...
							<div class="styIRS8854LNDesc" style="width:35mm;padding-top:14px;">
								...
								<span>
									...
									<input type="checkbox" aria-label="resident of united state Yes check box checked" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/ExpatriationInformationGrp/USResNoMoreThan10Of15YrInd"/>
								...
								<span>
									...
									<input type="checkbox" aria-label="resident of united state No check box not checked" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/ExpatriationInformationGrp/USResNoMoreThan10Of15YrInd"/>
											<xsl:with-param name="BackupName">IRS8854USResForNoMoreThan10Of15YrInd</xsl:with-param>
										</xsl:call-template>
						...
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="width:35mm;padding-top:14px;">
								...
								<span>
									...
									<input type="checkbox" aria-label="under age expatriated Yes check box not checked" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/ExpatriationInformationGrp/Under18USResLessThan10YrInd"/>
								...
								<span>
									...
									<input type="checkbox" aria-label="under age expatriated No check box checked" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/ExpatriationInformationGrp/Under18USResLessThan10YrInd"/>
											<xsl:with-param name="BackupName">IRS8854Under18AndUSResLessThan10YrInd</xsl:with-param>
										</xsl:call-template>
						...
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="width:35mm;padding-top:14px;">
								...
								<span>
									...
									<input type="checkbox" aria-label="complied with all your tax obligation Yes check box checked" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/ExpatriationInformationGrp/InCompliance5PrecTaxYearInd"/>
								...
								<span>
									...
									<input type="checkbox" aria-label="complied with all your tax obligation No check box not checked" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/ExpatriationInformationGrp/InCompliance5PrecTaxYearInd"/>
											<xsl:with-param name="BackupName">IRS8854InComplianceFor5PrecTaxYearInd</xsl:with-param>
										</xsl:call-template>
          ...
          <!--div class="pageEnd" style="width:187mm;">
            <div style="float:left;padding-top:.5mm;">
              <b>For Paperwork Reduction Act Notice, see the separate instructions.</b>
            ...
            <div style="float:right;">
              <span style="width:50px;"/>  
                Form 
              <span class="styBoldText" style="font-size:8.5pt;">8854</span> (2025)
            </div>
          </div-->
						...
						<span style="margin-left:16mm;font-size:6.5pt;">Cat. No. 24126N</span>
						<span style="float:right;font-size:6.5pt;">Form<b><span style="font-size:8pt;padding-right:1mm;padding-left:1mm;">8854</span></b>(2025)</span>	
					</div>
 		  <!--p style="page-break-before: always"/-->
					...
					<div class="styBB" style="width:187mm;float:none;border-bottom:1px solid black;border-top:2px solid black;">
						<div class="styIRS8854LNDesc" style="width:18mm;border-top-width:0px;height:5mm;border-bottom-width:0px;border-right-width:1px;border-left-width:0px;border-color:#000000;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8854LineItem">
							...
							<xsl:call-template name="CreateDataRowPartVSchA">
								<xsl:with-param name="TargetNode" select="$Form8854Data/InitialExptrtStmtBalSheetGrp/PensionsOrSmlrRetireArrngmGrp"/>
							</xsl:call-template>
						</div>
						<!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
						<!-- End (Line) 6-->
						...
						<div class="styIRS8854LineItem">
							...
							<xsl:call-template name="CreateDataRowPartVSchA">
								<xsl:with-param name="TargetNode" select="$Form8854Data/InitialExptrtStmtBalSheetGrp/DeferredCompensationStkOptGrp"/>
							</xsl:call-template>
						</div>
						<!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
						<!-- End (Line) 7-->
					...
					<div class="styBB" style="width:187mm;">
						<div class="styIRS8854LineItem" style="height:4mm;">
							<!-- Assets -->
							<div class="styIRS8854LNDesc" style="width:87mm;height:100%;float:left;text-align:center;border-color:black;padding-top:0px;">
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styIRS8854LineItem">
							<div class="styIRS8854LNDesc" style="width:40%;border-right-width:0px;float:left;padding-top:0px;padding-bottom:0px;">
								<div class="styIRS8854LNLeftNumBox" style="height:1mm;padding-left:0px;">25</div>
								<div class="styIRS8854LNDesc" style="width:60mm;padding-left:0px;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8854LNDesc" style="width:180mm;padding-left:12mm;">
							...
							<span style="width:12px;"/>
								more than $206,000.00, your net worth on the date of your expatriation (see line 2 in Section A) was under $2 million, and you<br/> 
							<span style="width:12px;"/>	
						...
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="width:35mm;padding-top:26px;">
								...
								<span>
									...
									<input type="checkbox" aria-label="eligible deferred compensation item Yes check box checked" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/PropertyOwnedDtExpatriationGrp/EligibleDeferredCompItemsInd"/>
								...
								<span>
									...
									<input type="checkbox" aria-label="eligible deferred compensation item No check box not checked" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/PropertyOwnedDtExpatriationGrp/EligibleDeferredCompItemsInd"/>
											<xsl:with-param name="BackupName">IRS8854EligibleDeferredCompItemsInd</xsl:with-param>
										</xsl:call-template>
						...
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="width:35mm;padding-top:14px;">
								...
								<span>
									...
									<input type="checkbox" aria-label="ineligible deferred compensation item Yes check box checked" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/PropertyOwnedDtExpatriationGrp/IneligibleDeferredCompItemsInd"/>
								...
								<span>
									...
									<input type="checkbox" aria-label="ineligible deferred compensation item No check box not checked" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/PropertyOwnedDtExpatriationGrp/IneligibleDeferredCompItemsInd"/>
											<xsl:with-param name="BackupName">IRS8854IneligibleDeferredCompItemsInd</xsl:with-param>
										</xsl:call-template>
						...
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="width:35mm;padding-top:14px;">
								...
								<span>
									...
									<input type="checkbox" aria-label="specified tax deferred account Yes check box checked" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/PropertyOwnedDtExpatriationGrp/SpecifiedTaxDeferredAccountInd"/>
								...
								<span>
									...
									<input type="checkbox" aria-label="specified tax deferred account No check box not checked" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/PropertyOwnedDtExpatriationGrp/SpecifiedTaxDeferredAccountInd"/>
											<xsl:with-param name="BackupName">IRS8854SpecifiedTaxDeferredAccountInd</xsl:with-param>
										</xsl:call-template>
						...
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="width:35mm;padding-top:0px;">
								...
								<span>
									...
									<input type="checkbox" aria-label="nongrantor trust Yes check box checked" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/PropertyOwnedDtExpatriationGrp/NongrantorTrustInterestInd"/>
								...
								<span>
									...
									<input type="checkbox" aria-label="nongrantor trust No check box not checked" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/PropertyOwnedDtExpatriationGrp/NongrantorTrustInterestInd"/>
											<xsl:with-param name="BackupName">IRS8854InterestInNongrantorTrustInd</xsl:with-param>
										</xsl:call-template>
					...
					<div class="styTBB" style="width:187mm;">
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="width:179mm">
								...
								<span style="font-size:7pt;display:inline;"> You can defer tax only if you enter into a tax deferral agreement with the IRS. See instructions.</span>
							</div>
						</div>
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="width:144mm">
								...
								<br/>
								<br/>
								If you checked "Yes" on line 1, continue to lines 2 through 5. Otherwise, continue to Part III.<br/>
								<br/>
							</div>
							<div class="styIRS8854LNDesc" style="width:35mm;padding-top:6mm;">
								...
								<span>
									...
									<input type="checkbox" aria-label="election to defer tax Yes check box not checked" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/ExptrtTaxDeferralGrp/TaxDeferSect877AbElectionInd"/>
								...
								<span>
									...
									<input type="checkbox" aria-label="election to defer tax No check box checked" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/ExptrtTaxDeferralGrp/TaxDeferSect877AbElectionInd"/>
											<xsl:with-param name="BackupName">IRS8854ElectionToDeferTaxSect877AbInd</xsl:with-param>
										</xsl:call-template>
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="height:auto;">
									...
									including the day before the expatriation date
									<span style="width:3px;"/>
								<!--Dotted Line-->
								<span class="styBoldText">
							...
							<div class="styLNRightNumBox" style="height:8mm;padding-top:1.5mm;"><br />2</div>
							<div class="styLNAmountBox" style="width:33mm;height:8mm;padding-top:1.5mm;"><br />
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form8854Data/ExptrtTaxDeferralGrp/TotalTaxWithSect877AaAmt"/>
								</xsl:call-template>
							</div>
							<div class="styLNAmountBox" style="height:0.5mm;width:33mm;border-bottom-width:0px;float:right;"/>
							<div class="styLNRightNumBox" style="background-color:lightgrey;height:0.5mm;border-bottom-width:0px;float:right;"/>
						</div>
						<!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
						<!-- End (Line) 2-->
						<!-- Begin (Line) 3 -->
						...
						<div class="styIRS8854LineItem">
						<div class="styIRS8854LNDesc" style="height:12mm; padding-left:11mm">
						<br/>
								<img src="{$ImagePath}/8854_Bullet_Round.gif" alt="Bullet Round"/>
								<span style="width:3px;"/>
									If you are filing Form 1040, 1040-SR or 1040-NR, enter this amount in brackets to the left of the entry space for line
									24. Identify as "EXP."<br/>
								<br/>
							</div>
							<div class="styLNAmountBox" style="background-color:lightgrey;height:12mm;width:33mm;border-left-width:0px;border-bottom-width:0px;float:right;"/>
							<div class="styLNRightNumBox" style="background-color:lightgrey;height:12mm;border-right-width:0px;border-bottom-width:0px;float:right;"/>
						</div></div>
						<!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
						<!-- End (Line) 5-->
					...
					<div style="width:187mm;float:none;clear:both;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;">
							Annual Expatriation Statement for Persons Who Expatriated Before 2025
						</div>
					</div>
					<!-- END: Part III (Header)-->
					<!-- BEGIN: Part III (Body) -->
					...
					<div class="styBB" style="width:187mm;float:none;display:block;">
						...
						<div class="styIRS8854LineItem">
							...
							<div class="styIRS8854LNDesc" style="width:179mm">
								...
								column (d) for any property you disposed of in 2025 and see the instructions for Part III.
								<!--+++++++++++++++++++ Table Toggle Button +++++++++++++++++++-->
					...
					<div style="width:187mm;float:none;clear:both;" class="styBB">
						<div class="styPartName" style="width:15mm;">Part III</div>
						<div class="styPartDesc" style="padding-left:3mm;">
							Annual Expatriation Statement for Persons Who Expatriated Before 2025 (continued)
						</div>
					</div>
					<!-- END: Part III (Header)-->
						<!-- Begin (Line) 2 -->
						...
						<div class="styIRS8854LineItem">
							<div class="styIRS8854LNLeftNumBox">2</div>
							<div class="styIRS8854LNDesc" style="width:144mm">
								Did you receive any distributions of eligible deferred compensation items for 2025?
								<!--Dotted Line-->
								<span class="styBoldText">
									<span style="width:18px"/>.
										<span style="width:11px"/>.
							...
							<div class="styIRS8854LNDesc" style="width:35mm">
								...
								<span>
									...
									<input type="checkbox" aria-label="deferred compensation item Yes check box checked" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/AnnualExptrtStmtBfrSpcfdYrGrp/EligDeferredCompItemsDistriInd"/>
								...
								<span>
									...
									<input type="checkbox" aria-label="deferred compensation item No check box not checked" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/AnnualExptrtStmtBfrSpcfdYrGrp/EligDeferredCompItemsDistriInd"/>
											<xsl:with-param name="BackupName">IRS8854EligDeferredCompItemsDistriInd</xsl:with-param>
										</xsl:call-template>
						...
						<div class="styIRS8854LineItem">
							<div class="styIRS8854LNLeftNumBox">3</div>
							<div class="styIRS8854LNDesc" style="width:144mm">
								Did you receive any distributions from a nongrantor trust for 2025?
								<!--Dotted Line-->
								<span class="styBoldText">
									<span style="width:18px"/>.
										<span style="width:11px"/>.
							...
							<div class="styIRS8854LNDesc" style="width:35mm">
								...
								<span>
									...
									<input type="checkbox" aria-label="receive non grantor trust Yes check box checked" class="styCkbox">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/AnnualExptrtStmtBfrSpcfdYrGrp/NongrantorTrustDistriInd"/>
								...
								<span>
									...
									<input type="checkbox" aria-label="receive non grantor trust No check box not checked" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8854Data/AnnualExptrtStmtBfrSpcfdYrGrp/NongrantorTrustDistriInd"/>
											<xsl:with-param name="BackupName">IRS8854NongrantorTrustDistriInd</xsl:with-param>
										</xsl:call-template>
					...
					<div class="styStdDiv" style="border-bottom:1px solid black;">
						...
						<div style="width:167.2mm;float:left;border-top:1px solid black;border-left:1px solid black;">
							...
							<div style="width:36.8mm;padding-left:3px;float:left;">
								<span style="padding-right: 1mm;">Firm's EIN <!--img src="{$ImagePath}/8854_Bullet_Sm.gif" alt="Small Arrow"/--></span> <br/>
								<xsl:call-template name="PopulateReturnHeaderPaidPreparerInformation">
						...
						<div style="width:167.2mm;float:left;border-top:1px solid black;border-left:1px solid black;">
							...
							<div style="width:36.8mm;padding-left:3px;float:left;word-break:break-all;">
								Phone no. <span style="width:6px;"/><br/>
								<xsl:choose>
								<xsl:when test="$RtnHdrData/PaidPreparerInformationGrp/PhoneNum">
										<xsl:call-template name="PopulateReturnHeaderPaidPreparerInformation">
