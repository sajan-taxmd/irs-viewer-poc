...
<!-- Last Modified by Jermaine Merchant 8/7/2025 -->
				...
				<form id="Form1040ScheduleLEP">
					...
					<div class="styStdDiv">
						...
						<div class="styTYBox" style="width:30mm;height:18.5mm;">
							<div class="styOMB" style="height:auto;font-size:6pt;padding-top:3.5mm;padding-bottom:2mm;">OMB No. 1545-0074</div>
					...
					<div class="styStdDiv" style="border-top:1px solid black;border-bottom:1px solid black;">
						<div class="styNameBox" style="width:120mm;height:9mm">
							Name of person making request (as shown on tax return)<br />
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/PersonNm"/>
							</xsl:call-template>
						</div>
						<div class="styEINBox" style="width:67mm;height:9mm;padding-left:1mm;font-weight:normal;">
					...
					<div class="styStdDiv" style="height:auto;margin-bottom:4mm;margin-top:4mm;font-size:8pt;">
						...
						<div class="styGenericDiv" style="width:85mm;padding-left:8mm;">
							...
							<span style="vertical-align:top;">
								...
								</xsl:call-template>000 Cancel previous election</label>
							</span>
							<br />
							<input type="checkbox" class="styCkboxNM" style="margin-right:12px;margin-bottom:4px;">
								<xsl:call-template name="PopulateEnumeratedCheckbox">
					...
					<div class="styStdDiv" style="border-top:2px solid black;">
						...
						<span style="margin-left:13.5mm;">Cat. No. 74174D</span>
						<span style="float:right;font-weight:bold;font-family:Arial;">Schedule LEP (Form 1040) (Rev. 12-2024)</span>
					</div>
