			...
			<body class="styBodyClass">
				<form id="Form1120SScheduleK3">
					...
					<div class="styStdDivLS">
						...
						<div class="styFTBox" style="width:186mm;height:21mm;">
						...
						<div class="styTYBox" style="width:33mm;height:21mm;">
					...
					<div class="styStdDivLS" style="overflow:visible;border-top:2px solid black;">
						<div class="styGenericDiv" style="width:128mm;border-right:2px solid black;">
						...
						<div class="styGenericDiv" style="width:127mm;">
					...
					<div class="styStdDivLS" style="">
						...
						<div class="styLNDesc" style="width:206mm;">
					...
					<div class="styLNLeftLtrBox" style="width:6mm;padding-left:2mm;">F</div>
					...
					<div class="styStdDivLS" style="border-top:2px solid black;height:34mm;">
						<div style="transform:rotate(270deg);font-size:8pt;margin-top:15mm;margin-left:-10mm;">&nbsp; For IRS Use Only &nbsp;</div>
					</div>
					
					<div class="styStdDivLS pageEnd" style="border-top:2px solid black;font-weight:bold;font-family:Arial;">
						...
						<span style="float:right;">Schedule K-3 (Form 1120-S) 2025</span>
					</div>
					
					<!-- Page 2 -->
					<div class="styStdDivLS">
						Schedule K-3 (Form 1120-S) 2025
					...
					<!-- Part 6 tables -->
					<xsl:variable name="sep6" select="($Print = $Separated) and (count($FormData/SchK2K3ShrSect951a1InclsnGrp[1]/SchK2K3PrtshpCFCOwnrInfoGrp) &gt; 11)"/>
						...
						<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
							...
							<tbody>
								<xsl:if test="not($sep6)">
									<xsl:for-each select="$FormData/SchK2K3ShrSect951a1InclsnGrp[1]/SchK2K3PrtshpCFCOwnrInfoGrp">
										<tr style="vertical-align:bottom;">
											<td class="styTableCellCtrInherit" style="font-weight:bold;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="AlphaRowId"/>
								...
								<xsl:if test="$sep6 or (count($FormData/SchK2K3ShrSect951a1InclsnGrp[1]/SchK2K3PrtshpCFCOwnrInfoGrp) &lt; 11)">
									<xsl:call-template name="FillTable8Cols">
										<xsl:with-param name="LineNumber" select="1 + count($FormData/SchK2K3ShrSect951a1InclsnGrp[1]/SchK2K3PrtshpCFCOwnrInfoGrp)"/>
						...
						<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
							<thead class="styTableThead">
								...
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:28mm;font-weight:normal;">
										<strong>(e)</strong> Shareholder's share of fair market value (FMV) of PFIC shares held by corporation at beginning of tax year
									</th>
									<th class="styTableCellHeader" scope="col" style="width:28mm;font-weight:normal;">
										<strong>(f)</strong> Shareholder's share of FMV of PFIC shares held by corporation at end of tax year
									</th>
									<th class="styTableCellHeader" scope="col" style="width:20mm;font-weight:normal;border-right-width:0px;">
						...
						<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
							<thead class="styTableThead">
								...
								<tr>
								    <th class="styTableCellHeader" scope="col" style="width:8mm;">&nbsp;</th>
									<th class="styTableCellHeader" scope="col" style="width:32mm;font-weight:normal;">
										<strong>(h)</strong> Shareholder's share of amount of cash and FMV of property distributed by PFIC during the current tax year (if applicable)
									</th>
									<th class="styTableCellHeader" scope="col" style="width:32mm;font-weight:normal;">
