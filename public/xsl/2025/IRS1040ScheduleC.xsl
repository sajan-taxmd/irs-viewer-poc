...
<!-- Last Modified by Corey on 5/29/2025 -->
  ...
  <form name="Form1040ScheduleC">
	...
	<div class="styFTBox" style="width:127mm;height:21mm;">
		...
		<div class="styFBT" style="height:3mm;margin-top:1mm;font:size:6pt;width:127mm;">
			 Attach to Form 1040, 1040-SR, 1040-SS, 1040-NR, or 1041; partnerships must generally file Form 1065.<br/>
			  <span style="margin-top:1mm;">Go to <i><a href="http://www.irs.gov/schedulec">www.irs.gov/ScheduleC</a></i> for instructions and the latest information.</span>        
		</div>
	</div>	
	...
	<div class="styBB" style="width:187mm;border-bottom-width: 0px;float:none;clear:both;height:auto;">        
		...
		<div class="styGenericDiv" style="width:187mm;border-bottom-width: 0px;">        
			...
			<div class="styGenericDiv" style="width:159mm;padding-top:0mm;">
				<span style="float:left;">Did you make any payments in 2025 that would require you to file Form(s) 1099? See instructions</span>
			...
			<div class="styBB" style="width:187mm;border-bottom-width: 0px;">        
				...
				<div class="styLNDesc" style="width:159mm;padding-top:0mm;">
					<span style="float:left;">If "Yes," did you or will you file required Form(s) 1099?</span>
					<!--Dotted Line-->
                    <span class="styDotLn" style="float:right;padding-right:1mm;">......................</span>
				</div>
				<div class="styGenericDiv" style="width:24mm;height:4mm;float:right;">
...
<div class="styBB" style="width:187mm;float:none;clear:both;">      
	...
	<table class="styTable" style="width:94mm;float:left;font-size:7pt;" cellspacing="0">
		...
		<tbody>
			...
			<!--Line 17-->
			<tr>
				<td class="styLNLeftNumBox" style="width:5mm;padding-bottom:0mm;"><div style="height:6.5mm;">17</div></td>
				<td class="styGenericDiv" style="width:46mm;height:6.5mm;">Legal and professional services</td>
				<td class="styLNRightNumBox" style="width:7.25mm;height:6.5mm;border-bottom:0mm;">
					17
				</td>
				<td class="styLNAmountBox" style="border-right-width:1px;width:31.5mm;height:6.5mm;border-bottom-width: 0px;">
					<xsl:call-template name="PopulateAmount">
	...
	<table class="styTable" style="width:93mm;float:left;font-size:7pt;heght:auto;" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:49mm;font-size:7pt;padding-top:0mm;padding-bottom:0mm;">
			...
			<tr>
				...
				<td class="styGenericDiv" style="width:50mm;padding-top:0.5mm;padding-left:1mm;">
				    <span style="float:left;padding-left:1mm;">Energy efficient commercial bldgs deduction (attach Form 7205)</span>
					<!--Dotted Line-->
					<!--<span class="styDotLn" style="float:right;padding-right:1mm;">.</span>-->   
				</td>
				<td class="styLNRightNumBox" style="height:7mm;width:7.25mm;padding-top:4mm">
					27a
				</td>
				<td class="styLNAmountBox" style="height:7mm;width:31.5mm;padding-top:4mm">     
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$Form1040ScheduleCData/EnergyEffcntCmrclBldgDedAmt"/>
			...
			<!--Blank Line-->
			<tr>
				<td class="styLNLeftNumBoxSD" style="height:4.5mm;width:5mm;padding-left:3.5mm;">
					 b
				</td>
				<td class="styGenericDiv" style="width:49mm;padding-top:0.5mm;"> 
				    <span style="float:left;padding-left:1mm;">Other expenses (from line 48)
				    <xsl:call-template name="SetFormLinkInline">
				    <xsl:with-param name="TargetNode" select="$Form1040ScheduleCData/TotalOtherExpensesAmt"/>
						<!--<xsl:with-param name="TargetNode" select="$Form1040ScheduleCData/EnergyEffcntCmrclBldgDedAmt"/>-->
...
<!--Dotted Line-->
				...
				<td class="styLNRightNumBox" style="height:6mm;width:7.25mm;border-bottom-width:0px;padding-top:3mm">
					27b
				</td>
				<td class="styLNAmountBox" style="height:6mm;width:31.5mm;border-bottom-width:0px;padding-top:3mm"> &#160;    
					<xsl:call-template name="PopulateAmount">
						<xsl:with-param name="TargetNode" select="$Form1040ScheduleCData/TotalOtherExpensesAmt"/>
						<!--<xsl:with-param name="TargetNode" select="$Form1040ScheduleCData/EnergyEffcntCmrclBldgDedAmt" />-->
					</xsl:call-template>
...
<div style="width:187mm;float:none;clear:both; ">  
	...
	<div class="styGenericDiv" style="font-weight:bold;float:right">Schedule C (Form 1040) 2025 </div>
</div> 
<!--</div> --> 
 <!--Begin Page 2 -->
...
<p style="page-break-before: always"/>
    ...
    <div class="styBB" style="width:187mm;float:left;clear:all;">  
      <div style="float:left;">Schedule C (Form 1040) 2025 <span style="width:90mm;"/></div>
 ...
 <!--Line 41-->   
	...
	<table class="styTable" cellspacing="0" style="font-size:7pt;height:auto;" summary="Additional Vehicle Information " name="AVtable" id="AVtable">
	  ...
	  <tr>
		<td class="styBB" style="width:186mm;height:auto;">
		  ...
		  <div class="styPartDesc" style="width:169mm;height:auto;margin-top:0px;font-weight:normal">
			  <b> Information on Your Vehicle.</b> Complete this part
			   <b>only</b> if you are claiming car or truck expenses on line 9 and are not required to file Form 4562
				for this business. See the instructions for line 13 to find out if you must file Form 4562. 
		  </div>   
		</td>
		</tr>
		<tr>				
	...
	<div style="height:auto;">	  
		<div class="styBB" style="width:187mm;height:auto;">
			...
			<span class="styNormalText"> List below business expenses not included on lines 8-27a, or line 30.
			</span> 
		</div>	
		<!--Table-->
		<!-- Table expand/collapse toggle button -->
  ...
  <!--Line 48-->
      ...
      <div class="styLNDesc" style="width: 139mm; height:4mm;">        
            <span style="float:left;"><b>Total other expenses.</b> Enter here and on line 27b
                <xsl:call-template name="LinkToLeftoverDataTableInline">
    ...
    <div style="width:187mm;clear:all;">    
      ...
      <div class="stySmallText" style="width:52mm;text-align:right;"><span class="styBoldText" style="font-weight:bold;">Schedule C (Form 1040) 2025</span> </div>
    </div>
    <!--    </div> -->      
