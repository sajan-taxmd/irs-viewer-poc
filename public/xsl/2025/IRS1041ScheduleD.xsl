		...
		<body class="styBodyClass" style="width:187mm">
			<form name="Form1041ScheduleD">
				...
				<!--<div style="width:187mm;">-->
					<div class="styBB" style="width: 187mm;">
						...
						<div class="styFTBox" style="width:130mm;height:20mm;">
							...
							<div style="padding-top:3.5mm;">
								<span style="font-weight:bold; height:4mm;">
									...
									Go to 
									<a style="text-decoration:none;color:black;" href="http://www.irs.gov/Form1041" title="Link to IRS.gov"><i>www.irs.gov/Form1041</i> for instructions and the lastest information.</a>
								</span>              
							</div>
						</div>
						<!-- Tax Year Box -->
						<div class="styTYBox" style="width:31mm;height:20mm;border-left-width:2px;">
							...
							<!-- Tax Year -->
							<div class="styTaxYear" style="height:8mm;padding-top:3.5mm;">20<span style="color:green;">25</span></div>            
						</div>
					</div>
					<!-- END FORM HEADER -->
					<!-- BEGIN TAXPAYER INFO -->
					<div class="styBB" style="width:187mm;float:left;clear:none;border-top-width:1px;">
						...
						<div class="styNameBox" style="width:136mm;font-size:7pt;font-weight:normal;">Name of estate or trust<br/>
							<span style="height:6.5mm;">
								<!-- 06/18/24 Per defect 1478595, updated test condition to accomodate for all 3 header type: 990T, 5227, and 1041  -->
								<xsl:choose>
									...
									<!-- 03/13/24 Per TESTINC0008798 - Catch for 5227 to display TrusteeBusinessName which is not currently supported by the PopulateReturnHeaderFiler method -->
					...
					<div style="width:187mm;float:none;clear:both;">
						...
						<div style="float:left;clear:none;width:183mm;">
							<div style="font-size:7pt;float:left;clear:none;padding-top:0.9mm">Did you dispose of any investment(s) in a qualified opportunity fund during the tax year?
							</div>
							<!--Dotted Line-->
							<span class="styDotLn" style="padding-left:1mm;padding-top:0.5mm;">............</span>
							<div style="float:left;clear:none;font-size:6pt;">
								<!-- Checkbox -->
								<!--07/15/2025 updated aira-label for 508 compliance ticket-->
								<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$FormData/DisposeInvestmentQOFInd"/>
									 </xsl:call-template>
									<input type="Checkbox" aria-label="Dispose of Investment Yes" class="styCkbox">
							...
							<div style="float:left;clear:none;font-size:6pt;">
								...
								<span>
									...
									<input type="Checkbox" aria-label="Dispose of Investment No" class="styCkbox">
							...
							<div style="font-size:7pt;float:left;clear:none;">If "Yes",attach Form 8949 and see its instructions for additional requirements for reporting your gain or loss.
							</div>
							</div>
						</div>
					<!-- BEGIN NOTE -->
					<div class="styBB" style="width:187mm;padding-top:1.5mm;">
						<b>Note: </b>Form 5227 filers need to complete <b>only</b> Parts I and II.
					</div>
					<!-- END NOTE -->
					<!-- BEGIN PART I HEADER -->
					<div class="styBB" style="width:187mm;">
						<span class="styPartName" style="width:12mm;font-size:9pt;">Part I</span>
						<div class="styPartDesc" style="padding-left:1mm;width:168mm;font-size:9pt;font-weight:normal"><b>Short-Term Capital Gains and Losses&#151;Assets Held One Year or Less </b>(see instructions)
						</div>
					</div>
					<!-- END PART I HEADER -->
					...
					<div>
						<table class="IRS1041ScheduleD_styTable" cellspacing="0" name="STCapGainTable" id="STCapGainTable">
							...
							<!-- Line 1a -->
							<tr>
								<td class="IRS1041ScheduleD_styTableCellNote" style="width:8mm;height:20mm;border-right-width:0px">
									<span class="styLNLeftNumBoxSD">1a</span>
								</td>
								<td class="IRS1041ScheduleD_styTableCellNote" style="width:67mm;height:20mm">
									<span class="styDesc" style="width:67mm;padding-top:.5mm">Totals for all short-term transactions reported on Form 1099-B or Form 1099-DA for which
										basis was reported to the IRS and for which you have no adjustments (see instructions). However, if you choose to
										report all these transactions on Form <br/>
										<span style="float:left;"> 8949, leave this line blank and go to line 1b</span>
										<!--Dotted Line-->
										<span class="styDotLn" style="float:right;padding-right:1mm;">..</span>
									</span>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:20mm;padding-top:17mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099BssRptNoAdjGrp/TotalProceedsSalesPriceAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:20mm;padding-top:17mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099BssRptNoAdjGrp/TotalCostOrOtherBasisAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:28mm;height:20mm;vertical-align:bottom;background-color:lightgrey;"><br/></td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:27mm;height:20mm;border-right-width:0px;padding-top:17mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099BssRptNoAdjGrp/TotalGainOrLossAmt"/>
										</xsl:call-template>
								</td>
							</tr>
							<!-- Line 1b -->
							<tr>
								...
								<td class="IRS1041ScheduleD_styTableCellNote" style="width:67mm;height:8mm">
									...
									<span style="float:left;"> with <b>Box A or Box G</b> checked</span>
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;">......</span>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099ShowsBasisGrp/TotalProceedsSalesPriceAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099ShowsBasisGrp/TotalCostOrOtherBasisAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099ShowsBasisGrp/TotAdjustmentsToGainOrLossAmt"/>
										</xsl:call-template>
								</td>
							...
							<tr>
								...
								<td class="IRS1041ScheduleD_styTableCellNote" style="width:67mm;height:8mm">
									<span style="float:left;">Totals for all transactions reported on Form(s) 8949</span><br/>
									<span style="float:left;"> with <b>Box B or Box H</b> checked</span>
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;">......</span>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099NotShowBasisGrp/TotalProceedsSalesPriceAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099NotShowBasisGrp/TotalCostOrOtherBasisAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099NotShowBasisGrp/TotAdjustmentsToGainOrLossAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:27mm;height:8mm;padding-top:4mm;border-right-width:0px;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099NotShowBasisGrp/TotalGainOrLossAmt"/>
										</xsl:call-template>
								</td>
							</tr>
							<!-- Line 3 -->
							<tr>
								...
								<td class="IRS1041ScheduleD_styTableCellNote" style="width:67mm;height:8mm">
									<span style="float:left;">Totals for all transactions reported on Form(s) 8949</span><br/>
									<span style="float:left;">  with <b>Box C or Box I</b> checked</span>
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;">......</span>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099NotReceivedGrp/TotalProceedsSalesPriceAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099NotReceivedGrp/TotalCostOrOtherBasisAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099NotReceivedGrp/TotAdjustmentsToGainOrLossAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:27mm;height:8mm;padding-top:4mm;border-right-width:0px;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalSTCGL1099NotReceivedGrp/TotalGainOrLossAmt"/>
										</xsl:call-template>
								</td>
							</tr>
						</table>
					...
					<div class="styGenericDiv" style="width:187mm;height:7mm;">
						...
						<div class="styLNDesc" style="width:143.7mm;">Short-term capital loss carryover. Enter the amount, if any, from line 9 of the 2024 Capital Loss <br/>
							<span style="float:left;">Carryover Worksheet</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">...........................</span>
						</div>
						<div class="styLNRightNumBox" style="width:7mm;height:7mm;"><br/>6</div>
						<div class="styLNAmountBox" style="width:27mm;height:7mm;"><br/>(
							<xsl:call-template name="PopulateAmount">
				   ...
				   <div class="styBB" style="width:187mm;border-top:1px solid black;">
					...
					<div>
						<table class="IRS1041ScheduleD_styTable" cellspacing="0" name="STCapGainTable" id="STCapGainTable">
							...
							<!-- Line 8a -->
							<tr>
								<td class="IRS1041ScheduleD_styTableCellNote" style="width:8mm;height:21mm;border-right-width:0px">
									<span class="styLNLeftNumBoxSD" style="height:auto;">8a</span>
								</td>
								<td class="IRS1041ScheduleD_styTableCellNote" style="width:67mm;height:21mm">
									<span class="styDesc" style="width:67mm;padding-top:.5mm">Totals for all long-term transactions reported on Form 1099-B or Form 1099-DA for which
										basis was reported to the IRS and for which you have no adjustments (see instructions). However, if you choose to
										report all these transactions on Form <br/>
										<span style="float:left;"> 8949, leave this line blank and go to line 8b</span>
										<!--Dotted Line-->
										<span class="styDotLn" style="float:right;padding-right:1mm;">..</span>
									</span>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:21mm;padding-top:17mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099BssRptNoAdjGrp/TotalProceedsSalesPriceAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:21mm;padding-top:17mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099BssRptNoAdjGrp/TotalCostOrOtherBasisAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:28mm;height:21mm;vertical-align:bottom;background-color:lightgrey;"><br/></td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:27mm;height:21mm;padding-top:17mm;border-right-width:0px;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099BssRptNoAdjGrp/TotalGainOrLossAmt"/>
										</xsl:call-template>
								</td>
							</tr>
							<!-- Line 8b -->
							<tr>
								...
								<td class="IRS1041ScheduleD_styTableCellNote" style="width:67mm;height:8mm">
									<span style="float:left;">Totals for all transactions reported on Form(s) 8949</span><br/>
									<span style="float:left;"> with <b>Box D or Box J</b> checked</span>
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;">......</span>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099ShowsBasisGrp/TotalProceedsSalesPriceAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099ShowsBasisGrp/TotalCostOrOtherBasisAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099ShowsBasisGrp/TotAdjustmentsToGainOrLossAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:27mm;height:8mm;padding-top:4mm;border-right-width:0px;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099ShowsBasisGrp/TotalGainOrLossAmt"/>
										</xsl:call-template>
								</td>
							</tr>
							<!-- Line 9 -->
							<tr>
								...
								<td class="IRS1041ScheduleD_styTableCellNote" style="width:67mm;height:8mm">
									<span style="float:left;">Totals for all transactions reported on Form(s) 8949</span><br/>
									<span style="float:left;"> with <b>Box E or Box K</b> checked</span>
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;">......</span>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099NotShowBasisGrp/TotalProceedsSalesPriceAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099NotShowBasisGrp/TotalCostOrOtherBasisAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099NotShowBasisGrp/TotAdjustmentsToGainOrLossAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:27mm;height:8mm;padding-top:4mm;border-right-width:0px;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099NotShowBasisGrp/TotalGainOrLossAmt"/>
										</xsl:call-template>
								</td>
							</tr>
							<!-- Line 10 -->
							<tr>
								...
								<td class="IRS1041ScheduleD_styTableCellNote" style="width:67mm;height:8mm">
									<span style="float:left;">Totals for all transactions reported on Form(s) 8949</span><br/>
									<span style="float:left;"> with <b>Box F or Box L</b> checked</span>
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;">......</span>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099NotReceivedGrp/TotalProceedsSalesPriceAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellDt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099NotReceivedGrp/TotalCostOrOtherBasisAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:28mm;height:8mm;padding-top:4mm;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099NotReceivedGrp/TotAdjustmentsToGainOrLossAmt"/>
										</xsl:call-template>
								</td>
								<td class="IRS1041ScheduleD_styTableCellAmt" style="width:27mm;height:8mm;padding-top:4mm;border-right-width:0px;text-align:right;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalLTCGL1099NotReceivedGrp/TotalGainOrLossAmt"/>
										</xsl:call-template>
								</td>
							</tr>
						</table>
					...
					<!-- END LINE 14 -->
					<!-- BEGIN LINE 15 -->
					<div class="styGenericDiv" style="width:187mm;height:7mm;float:none;clear:both;">
						<div class="styLNLeftNumBox">15</div>
						<div class="styLNDesc" style="width:143.7mm;">Long-term capital loss carryover. Enter the amount, if any, from line 14 of the 2024 Capital Loss <br/>
							<span style="float:left;">Carryover Worksheet</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">...........................</span>
						</div>
						<div class="styLNRightNumBox" style="width:7mm;height:7mm;"><br/>15</div>
						<div class="styLNAmountBox" style="width:27mm;height:7mm;"><br/>(
							<xsl:call-template name="PopulateAmount">
					...
					<div class="pageEnd" style="width:187mm;border-top:1px solid black;border-top-width:2px;">
						...
						<div class="stySmallText" style="width:48mm;text-align:right;"><span class="styBoldText">Schedule D (Form 1041) 2025</span>       </div>
					</div>
					...
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
						<span class="" style="float:left;clear:none;">Schedule D (Form 1041) 2025</span>
					...
					<div class="styGenericDiv" style="width:187mm;height:7mm;">
						...
						<div class="styLNRightNumBox" style="height:7mm;"><br />18b</div>
					...
					<div class="styGenericDiv" style="width:187mm;padding-top:1mm;padding-bottom:1mm;border-bottom:1px solid black;">
						<b>Note: </b>If line 19, column (3), is a net gain, enter the gain on Form 1041, line 4 (or Schedule A (Form 990-T), Part I, line 4a). If lines 18a and 19, column (2), are net
					...
					<!-- BEGIN Note -->
					<div class="styGenericDiv" style="width:187mm;padding-top:1mm;padding-bottom:1mm;border-bottom:1px solid black;">
						<b>Note: </b>If the loss on line 19, column (3), is more than $3,000, <b>or</b> if Form 1041, page 1, line 23 (or Form 990-T, Part I, line 11), is a loss, complete the
						<b>Capital Loss Carryover Worksheet</b> in the instructions to figure your capital loss carryover.
					</div>
					<!-- END Note -->  
					<!--  PART V HEADER -->
					<div class="styBB" style="width:187mm;float:none;clear:both;">
						...
						<div class="styGenericDiv" style="width:187mm;padding-top:1mm;font-size:8pt;font-weight:normal;">
							...
							• Either line 18b, column (2), or line 18c, column (2), is more than zero; or<br />
							• Both Form 1041, line 2b(1), and Form 4952, line 4g, are more than zero; or<br />
							• There are amounts on lines 4e and 4g of Form 4952.<br />
						</div>
						<div class="styGenericDiv" style="width:187mm;padding-top:1mm;padding-bottom:1mm;font-size:8pt;font-weight:normal;">
							<b>Form 990-T trusts.</b> Complete this part <b>only</b> if both lines 18a and 19 are gains, or qualified dividends are included in income
							 ...
							 in the instructions if either line 18b, column (2) or line 18c, column (2) is more than zero.
						</div>
					</div> 
					<!-- END PART V HEADER -->
					...
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;height:4.4mm;">
						...
						<div class="styLNAmountBox" style="height:4.4mm;padding-right:0.5mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
						...
						<div class="styLNRightNumBox" style="height:7mm;"><br />22</div>
						...
						<div class="styLNRightNumBox" style="width:8mm;height:7mm;background-color:lightgrey;border-bottom-width:0px;" />
						<div class="styLNAmountBox" style="border-bottom:0px;width:32mm;height:7mm;" />
						<div class="styLNRightNumBox" style="width:8mm;height:7mm;background-color:lightgrey;border-bottom-width:0px;" />
						<div class="styLNAmountBox" style="border-bottom:0px;height:7mm;width:10mm;" />
					</div>
					<!-- END LINE 22 -->
					<!-- BEGIN LINE 23 -->               
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
						...
						<div class="styLNRightNumBox" style="height:13mm;"><br /><br /><br />23</div>
						<div class="styLNAmountBox" style="height:13mm;padding-right:0.5mm;"><br /><br /><br />
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/QlfyDividendsEstateTrustAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox" style="width:8mm;height:13mm;background-color:lightgrey;border-bottom-width:0px;" />
						<div class="styLNAmountBox" style="border-bottom:0px;width:32mm;height:13mm;" />
						<div class="styLNRightNumBox" style="width:8mm;height:13mm;background-color:lightgrey;border-bottom-width:0px;" />
						<div class="styLNAmountBox" style="border-bottom:0px;width:32mm;height:13mm;" />
					</div>
					<!-- END LINE 23 -->
					...
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
						...
						<div class="styLNRightNumBox" style="height:9mm;padding-top:5.5mm;">25</div>
						<div class="styLNAmountBox" style="height:9mm;padding-top:5.5mm;padding-right:0.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/InvestmentIncomeElectionAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBox" style="width:8mm;height:9mm;background-color:lightgrey;border-bottom-width:0px;" />
						<div class="styLNAmountBox" style="border-bottom:0px;width:32mm;height:9mm;" />
						<div class="styLNRightNumBox" style="width:8mm;height:9mm;background-color:lightgrey;border-bottom-width:0px;" />
						<div class="styLNAmountBox" style="border-bottom:0px;width:32mm;height:9mm;" />
					</div>
					<!-- END LINE 25 -->
					...
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
						...
						<div class="styLNDesc" style="width:98.8mm;height:4.4mm;">
							<span style="float:left;">Enter the <b>smaller</b> of the amount on line 21 or $3,250</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">.......</span>					
						</div>
					...
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
						...
						<div class="styLNRightNumBox" style="height:4.4mm;border-bottom-width:1px;">31</div>
						<div class="styLNAmountBox" style="height:4.4mm;border-bottom-width:1px;padding-right:0.5mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
						...
						<div class="styLNDesc" style="width:98.8mm; height:4.4mm;">
							<span style="float:left;">Enter the <b>smaller</b> of line 21 or $15,900</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">...........</span>						
						</div>
					...
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
						...
						<div class="styLNDesc" style="width:98.8mm;">Figure the tax on the amount on line 27. Use the 2025 Tax Rate Schedule<br />
							for Estates and Trusts (see the Schedule G instructions in the Instructions<br />
							<span style="float:left;">for Form 1041)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">...................</span>		
						</div>
						<div class="styLNRightNumBox" style="height:9mm;border-bottom-width:1px;padding-top:5mm;">42</div>
						<div class="styLNAmountBox" style="height:9mm;border-bottom-width:1px;padding-top:5mm;padding-right:0.5mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styGenericDiv" style="width:187mm;float:none;clear:both;">
						...
						<div class="styLNDesc" style="width:98.8mm;height:10mm;">Figure the tax on the amount on line 21. Use the 2025 Tax Rate Schedule<br/>
							for Estates and Trusts (see the Schedule G instructions in the Instructions<br/>
							<span style="float:left;">for Form 1041)</span>
							<!--Dotted Line-->
							<span class="styDotLn" style="float:right;padding-right:1mm;">...................</span>
						...
						<div class="styLNAmountBox" style="height:10mm;border-bottom-width:1px;padding-right:0.5mm;"><br /><br />
							<xsl:call-template name="PopulateAmount">
				...
				<div class="styBB" style="width:187mm;border-top-width: 2px;border-bottom-width:0px;">
					<span style="font-weight:bold;float:right" class="styGenericDiv">Schedule D (Form 1041) 2025</span>
				</div>
