...
<!-- Form 1040SchD - TY25 - Last Modified by Deevena Gurrapu on 8/21/2025 -->
        ...
        <form name="Form1040ScheduleD">
          ...
          <div class="styBB" style="width: 187mm;">
            ...
            <div class="styTYBox" style="width:31mm;height:20mm;">
              ...
              <!-- Tax Year -->
              <div class="styTaxYear" style="height:8mm;">20<span style="color:green;">25</span>
              </div>
...
<div class="styIRS4835CleanDiv" style="width:28mm;float:right;">
								...
								<span>
                                    ...
                                    <input type="checkbox" aria-label="Dispose Investment Yes" class="styCkbox">
                               ...
                               <input type="checkbox" aria-label="Dispose Investment No" class="styCkbox">
          ...
          <div class="styGenericDiv" id="STCapGainTableContainer">
            <table class="IRS1040ScheduleD_styTable" cellspacing="0" name="STCapGainTable" id="STCapGainTable">
              ...
              <tr>
                <th class="IRS1040ScheduleD_styTableCellNote" style="font-weight:normal;height:20mm;width:75mm;" scope="col">
                ...
                <th class="IRS1040ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;height:20mm;width:28mm;" scope="col">
                ...
                <th class="IRS1040ScheduleD_styTableCellAmt" style="text-align:center;font-weight:normal;border-right-width:0px;height:20mm;width:28mm;" scope="col">
              ...
              <!-- Line 1a -->
              <tr>
				<td class="IRS1040ScheduleD_styTableCellNote" style="height:26mm;width:75mm;" >
					<span class="styLNLeftNumBoxSD">1a</span>
					<span class="styLNDesc" style="width:65mm;padding-right:4px;">
				...
				<td class="IRS1040ScheduleD_styTableCellAmt" style="height:26mm;width:28mm;">
					<br/>
					<br/>
					<br/>
					<br/>
				...
				<td class="IRS1040ScheduleD_styTableCellAmt" style="background-color:lightgrey;height:26mm;width:28mm;">
				<br/>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt" style="border-right-width:0px;height:26mm;width:28mm;">
					<br/>
     				<br/>
					<br/>
					<br/>
              ...
              <!-- Line 1b -->
              <tr>
				<td class="IRS1040ScheduleD_styTableCellNote" style="width:75mm;">
					<span class="styLNLeftNumBoxSD">1b</span>
					<span class="styLNDesc" style="width:65mm;padding-right:4px;">
						Totals for all transactions reported on Form(s) 8949 with <b>Box A</b> or <b>Box G</b> checked 
					</span>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt" style="width:28mm;">
					<br/>
				...
				<td class="IRS1040ScheduleD_styTableCellAmt" style="border-right-width:0px;width:28mm;">
					<br/>
              ...
              <tr>
				<td class="IRS1040ScheduleD_styTableCellNote" style="width:75mm;">
					...
					<span class="styLNDesc" style="width:65mm;padding-right:4px;">
						Totals for all transactions reported on Form(s) 8949 with <b>Box B</b> or <b>Box H</b> checked 
					</span>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt" style="width:28mm;">
					<br/>
              ...
              <tr>
				<td class="IRS1040ScheduleD_styTableCellNote" style="width:75mm;">
					...
					<span class="styLNDesc" style="width:65mm;padding-right:4px;">
						Totals for all transactions reported on Form(s) 8949 with <b>Box C</b> or <b>Box I</b> checked
					</span>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt" style="width:28mm;">
					<br/>
          ...
          <div class="styBB" style="width:187mm;border-bottom-width:0px;">
            ...
            <div class="styLNRightNumBox" style="width:12mm;">4</div>
          ...
          <div class="styGenericDiv" style="width:187mm;height:6mm;">
            ...
            <div class="styLNRightNumBox" style="height:7mm;width:12mm;"><br/>5</div>
            <div class="styLNAmountBox" style="height:7mm;width:28mm;">
				<br/>
				<xsl:call-template name="PopulateAmount">
          ...
          <div class="styGenericDiv" style="width:187mm;height:6mm;">
            ...
            <div class="styLNRightNumBox" style="height:7mm;width:12mm;"><br/>6</div>
            <div class="styLNAmountBox" style="height:7mm;width:28mm;">
				<br/>
				(<xsl:call-template name="PopulateAmount">
          ...
          <div class="styBB" style="width:187mm;">
            ...
            <div class="styLNRightNumBox" style="height:7.5mm;border-bottom-width:0px;padding-top:3.5mm;width:12mm;">7</div>
            <div class="styLNAmountBox" style="height:7.5mm;border-bottom-width:0px;padding-top:3.5mm;width:28mm;">
				<xsl:call-template name="PopulateAmount">
            ...
            <table class="IRS1040ScheduleD_styTable" cellspacing="0" name="LTCapGainTable" id="LTCapGainTable">
              ...
              <tr>
				<td class="IRS1040ScheduleD_styTableCellNote" style="width:75mm;">
					...
					<span class="styLNDesc" style="width:65mm;padding-right:4px;">
						Totals for all transactions reported on Form(s) 8949 with <b>Box D</b> or <b>Box J</b> checked
					</span>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt" style="width:28mm;">
					<br/>
              ...
              <tr>
				<td class="IRS1040ScheduleD_styTableCellNote" style="width:75mm">
					...
					<span class="styLNDesc" style="width:65mm;padding-right:4px;">
						Totals for all transactions reported on Form(s) 8949 with <b>Box E</b> or <b>Box K</b> checked
					</span>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt" style="width:28mm;">
					<br/>
              ...
              <tr>
				<td class="IRS1040ScheduleD_styTableCellNote" style="width:75mm;">
					...
					<span class="styLNDesc" style="width:65mm;padding-right:4px;">
						Totals for all transactions reported on Form(s) 8949 with <b>Box F</b> or <b>Box L</b> checked
					</span>
				</td>
				<td class="IRS1040ScheduleD_styTableCellAmt" style="width:28mm;">
					<br/>
          ...
          <div class="styGenericDiv" style="width:187mm;height:6mm;">
			  ...
			  <div class="styLNRightNumBox" style="height:6mm;padding-top:2.5mm;width:12mm;">11</div>
			  <div class="styLNAmountBox" style="height:6mm;padding-top:2.5mm;width:28mm;">
          ...
          <div class="styGenericDiv" style="width:187mm;height:4mm;">
			  ...
			  <div class="styLNRightNumBox" style="width:12mm;">12</div>
			  <div class="styLNAmountBox" style="width:28mm;">
				  <xsl:call-template name="PopulateAmount">
          ...
          <div class="styGenericDiv" style="width:187mm;height:4mm">
			  ...
			  <div class="styLNRightNumBox" style="width:12mm;">13</div>
			  <div class="styLNAmountBox" style="width:28mm;">
				  <xsl:call-template name="PopulateAmount">
					  <xsl:with-param name="TargetNode" select="$FormData/CapitalGainDistributionsAmt"/>
				  </xsl:call-template>
          ...
          <div style="width:187mm;height:6mm;">
			  ...
			  <div class="styLNRightNumBox" style="height:6mm; padding-top:2mm; width:12mm;">14</div>
          ...
          <div class="styBB" style="width:187mm;height:8mm;">
			  ...
			  <div class="styLNRightNumBox" style="height:8mm;border-bottom-width:0px; padding-top:3mm; width:12mm;">15</div>
			  <div class="styLNAmountBox" style="height:8mm;border-bottom-width:0px;padding-top:3mm; width:28mm;">
				  <xsl:call-template name="PopulateAmount">
          ...
          <div class="stySmallText" style="width:110mm;">
           <span class="styBoldText">For Paperwork Reduction Act Notice, see your tax return instructions.</span>
            ...
            <div class="stySmallText" style="width:55mm;text-align:right;"><span class="styBoldText">Schedule D (Form 1040) 2025</span>
                   </div>
          </div>
          
        <!--Begin Page 2 -->
        <div class="styBB" style="width:187mm; border-bottom-width:1px; margin-top:2mm">
          <span style="width:65mm;font-size:7pt;" class="styGenericDiv">Schedule D (Form 1040) 2025</span>
       ...
       <div class="styBB" style="width:187mm;border-bottom-width:0px;">
        ...
        <div class="styGenericDiv " style="width:187mm;height:5mm;">
          ...
          <div class="styLNDesc" style="width:135mm;height:5mm;">
            <input type="checkbox" aria-label="Both Gains Yes" class="styCkBox">
              <xsl:call-template name="PopulateYesCheckbox">
                <xsl:with-param name="TargetNode" select="$FormData/STAndLTGainInd"/>
        ...
        <div class="styGenericDiv " style="width:187mm;">
           <div class="styLNLeftNumBox" style="width:6mm;padding-top:1mm;"/>
          <div class="styLNDesc" style="width:135mm;">
            <input type="checkbox"  aria-label="Both Gains No" class="styCkBox">
              <xsl:call-template name="PopulateNoCheckbox">
                <xsl:with-param name="TargetNode" select="$FormData/STAndLTGainInd"/>
                 <xsl:with-param name="BackupName">IRS1040ScheduleD/STAndLTGainInd</xsl:with-param>
              </xsl:call-template>
        ...
        <div class="styGenericDiv " style="width:187mm;">
         ...
         <div class="styLNLeftNumBox" style="width:6mm;"/>
          <div class="styLNDesc" style="width: 135mm;">
            <input type="checkbox"  aria-label="Not Filing Form 4952 Yes" class="styCkBox">
              <xsl:call-template name="PopulateYesCheckbox">
                <xsl:with-param name="TargetNode" select="$FormData/ZeroOrBlankInd"/>
        ...
        <div class="styGenericDiv " style="width:187mm;">
          <div class="styLNLeftNumBox" style="width:6mm;"/>
          <div class="styLNDesc" style="width: 135mm;">
            <input type="checkbox"  aria-label="Not Filing Form 4952 No" class="styCkBox">
              <xsl:call-template name="PopulateNoCheckbox">
                <xsl:with-param name="TargetNode" select="$FormData/ZeroOrBlankInd"/>
                <xsl:with-param name="BackupName">IRS1040ScheduleD/ZeroOrBlankInd</xsl:with-param>
              </xsl:call-template>
        ...
        <div class="styGenericDiv " style="width:187mm;height:7.5mm">
           ...
           <div class="styLNLeftNumBox" style="width:6mm;"/>
          <div class="styLNDesc" style="width:135mm;">
            <input type="checkbox"  aria-label="Qualified Dividend Yes" class="styCkBox">
              <xsl:call-template name="PopulateYesCheckbox">
                <xsl:with-param name="TargetNode" select="$FormData/QualifiedDividendsInd"/>
        ...
        <div class="styGenericDiv " style="width:187mm;height:8mm">
          <div class="styLNLeftNumBox" style="width:6mm;"/>
          <div class="styLNDesc" style="width:135mm;">
            <input type="checkbox"  aria-label="Qualified Dividend No" class="styCkBox">
              <xsl:call-template name="PopulateNoCheckbox">
                <xsl:with-param name="TargetNode" select="$FormData/QualifiedDividendsInd"/>
                <xsl:with-param name="BackupName">IRS1040ScheduleD/QualifiedDividendsInd</xsl:with-param>
              </xsl:call-template>
        ...
        <div class="styBB" style="width:187mm;border-top-width: 1px;border-bottom-width:0px;">
          <span style="font-weight:bold;float:right" class="styGenericDiv">Schedule D (Form 1040) 2025</span>
        </div>
        <!--  PART III HEADER -->
