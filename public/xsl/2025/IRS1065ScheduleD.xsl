         ...
         Employer identification number<br/>
					...
					<table class="styTable" style="width:187mm;height:auto;" cellspacing="0">
							...
							<tr>
							  <th class="styTableCellHeader" style="width:1mm;border-right-width:0px;" scope="col"/>
								<th class="styTableCellHeader" style="width:56mm;font-weight:normal;text-align:left"
								  scope="col">
								  See instructions for how to figure the amounts to enter on the lines below. This form may be easier to complete if you 
						...
						<tbody style="font-size:7pt">
							<tr style="height:8mm">
							  <td class="styTableCell" style="width:4mm;text-align:right;border-right-width:0px;
								...
								<td class="styTableCell" style="text-align:left;width:56mm;padding-top:0px;padding-left:14px">
								  Totals for all short-term transactions reported on Form 1099-B or Form 1099-DA for which basis was reported to the IRS and for which you have no adjustments
								   (see instructions). However, if you choose to report all these transactions on Form 8949, leave this line blank and go to line 1b
							...
							<tr style="height:7mm">
								<td class="styTableCell" style="width:8mm;text-align:right;border-right-width:0px;
					...
					<table class="styTable" style="width:187mm;height:auto;" cellspacing="0">
						...
						<tfoot/>
							<tbody style="font-size:7pt">
								...
								<td class="styTableCell" style="text-align:left;width:56mm;padding-top:0px;padding-left:14px">
								  Totals for all long-term transactions reported on Form 1099-B or Form 1099-DA for which basis was reported to the IRS and for which you have no adjustments
								  (see instructions). However, if you choose to report all these transactions on Form 8949, leave this line blank and go to line 8b
									<span style="width:1.8mm"/>
									<span style=" letter-spacing:3.1mm; font-weight:bold; ">.</span></td>
								<td class="styTableCell" style="width:30mm;">
									<xsl:call-template name="PopulateAmount">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;font-size:7pt">
						...
						<div style="float:right;">
							<span class="styBoldText">Schedule D (Form 1065) 2025</span>
						</div>
					</div>
