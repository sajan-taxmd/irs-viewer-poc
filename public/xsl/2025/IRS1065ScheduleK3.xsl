			...
			<body class="styBodyClass">
				<form id="Form1065ScheduleK2" style="width:256mm;">
					...
					<div class="styStdDiv" style="overflow:visible;border-top:2px solid black;">
						...
						<div class="styGenericDiv" style="width:93mm;">
							...
							<div class="" style="width:100%;border-top:1px solid black;">
								...
								<div class="styLNDesc" style="width:87mm;font-family:Arial Narrow;font-size:7.5pt;">Name, address, city, state, and ZIP code for partner entered in box C. See instructions.</div>
					...
					<div class="styStdDiv" style="">
						...
						<div class="styLNRightNumBoxNBB" style="height:4.5mm;border-bottom:0px;">
						...
						<div class="styLNRightNumBoxNBB" style="height:4.5mm;border-bottom:0px;border-right-width:1px;">
					...
					<div class="styStdDiv" style="border-top:1px solid black;height:5mm;">
						<div class="styLNLeftLtrBox" style="width:6mm;padding-left:2mm;padding-top:1.5mm;">F</div>
						<div class="styLNDesc" style="width:30mm;padding-top:1.5mm;">
						...
						Final K-3-->
						<input type="checkbox" class="styCkboxNM" style="margin-top:3px;" alt="Amended K3">
							<xsl:call-template name="PopulateCheckbox">
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;font-weight:bold;font-family:Arial;">
						...
						<span style="float:right;">Schedule K-3 (Form 1065) 2025</span>
					</div>
					<!-- Page 2 -->
					<div class="styStdDivLS">
						Schedule K-3 (Form 1065) 2025
					...
					<div class="styStdDivLS">
						...
						<div class="styLNDesc" style="width:120mm;height:10.5mm;text-align:center;font-weight:bold;padding-top:3.5mm;border-bottom:1px solid black;">Description</div>
						...
						<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
							<thead class="styTableThead">
								...
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:25mm;font-weight:normal;">
										<strong>(m)</strong> Box is checked if PFIC is also a CFC within the meaning of section 957.
									</th>
					...
					<div class="styStdDivLS" style="font-size:8pt;font-weight:bold;">
						<div class="styLNDesc" style="width:255mm;height:auto;border-bottom:1px solid black;">
							Section 1 &mdash; Applicable Taxpayer <span style="font-weight:normal;">(see instructions for more information and definitions of terms)</span>
						</div>
					</div>
					<div class="styStdDivLS" style="border-bottom:1px solid black;">
					...
					<div class="styStdIBDivLS">
						...
						<div class="styLNDesc" style="width:152mm;height:10mm;">
							Base erosion tax benefits related to payments reported on lines 6 through 16, on which tax is imposed by section 871, 881 or 884(f), with respect to which tax has been withheld under section 1441 or 1442 at the 30% (0.30) statutory withholding tax rate or subject to tax under Section 1.884-4(a)(2)(ii) at the 30% (0.30) statutory rate. See Instructions
							<!--<span class="sty1065K2DotLn">..</span>-->
						</div>
						<div class="styLNAmountBox" style="background-color:lightgrey;height:10mm;border-bottom:0;">&nbsp;</div>
						<div class="styLNAmountBox" style="background-color:lightgrey;height:10mm;border-bottom:0;">&nbsp;</div>
						<div class="styLNAmountBox" style="height:10mm;border-bottom:0;"><br /><br />
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styStdDivLS">
						...
						<div class="styLNDesc" style="width:152mm;height:16mm;">
							Portion of base erosion tax benefits reported on lines 6 through 16, on which tax is imposed by section 871 or 881, with respect to which tax has been withheld under section 1441 or 1442 at a reduced withholding rate pursuant to an income tax treaty or subject to a reduced rate of tax under Section 1.884-4(a)(2)(ii). Multiply the amount of the base erosion tax benefit by a fraction equal to the rate of tax imposed under the treaty over the 30% (0.30) statutory rate. See instructions
							<span class="sty1065K2DotLn">..................................</span>
						</div>
						<div class="styLNAmountBox" style="background-color:lightgrey;height:16mm;">&nbsp;</div>
						<div class="styLNAmountBox" style="background-color:lightgrey;height:16mm;">&nbsp;</div>
						<div class="styLNAmountBox" style="height:16mm;padding-top:9mm;">
							<xsl:call-template name="SetFormLinkInline">
						...
						<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
							...
							<tbody>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherGainGrp[1]"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 16 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherGainGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 17 -->
								<tr>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherIncomeNotIncludedGrp[1]"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 20 -->
								<tr style="vertical-align:bottom;">
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK3FrgnPrtnrSrceIncmDedGrp/OtherIncomeNotIncludedGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 21 -->
								<tr style="vertical-align:bottom;border-top:2px solid black;">
							...
							<thead class="styTableThead">
								<tr style="border-top:1px solid black;">
									...
									<th class="styTableCellHeader" scope="col" style="width:50mm;font-weight:normal;border-right-width:0px;">
										<strong>(e)</strong> Total <br /> (four decimal places)
									</th>
								</tr>
							</thead>
							<tbody>
...
<!-- Additonal Data Title Bar and Button -->
							...
							<thead class="styTableHead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="width:200mm;text-align:left">
										Part XIII - Line C4 - Other Description
									</th>
								</tr>
							</thead>
								<tr>
									...
									<td class="styTableCell" style="text-align:left;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/SchK3SharePrtshpIntTrnsfrGrp/OtherPrtshpIntTrnsfrInd/@desc"/>
										</xsl:call-template>
									</td>
								</tr>
					</table>
	...
	<xsl:template name="K3DistributiveSharelocal">
			...
			<div class="styLNDesc" style="width:20mm;">Other
				<xsl:call-template name="LinkToLeftoverDataTableInline">
					<xsl:with-param name="Desc">
						Form 1065 Schedule K-3, Part XIII, Line C4</xsl:with-param>
					<xsl:with-param name="TargetNode" select="$FormData/SchK3SharePrtshpIntTrnsfrGrp/OtherPrtshpIntTrnsfrInd/@desc"/>
				</xsl:call-template>
			</div>
		</div>
		...
		<div class="styStdIBDivLS">
			...
			<div class="styLNAmountBox" style="background-color:lightgrey;border-bottom-width:0px;">&nbsp;</div>
			<!--<div class="styLNAmountBox">
				<xsl:call-template name="PopulateAmount">
	...
	<xsl:template name="FillTable5ColsPart12">
		...
		<tr style="vertical-align:bottom;">
			...
			<td class="styTableCellCtrInherit">&nbsp;</td>
			<td class="styTableCellCtrInherit" style="border-right:none;">&nbsp;</td>
		</tr>
		<xsl:choose>
