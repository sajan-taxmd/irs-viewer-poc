...
<!--F5405 Last modified by Emanesse Fleurancy - 12/13/2024-->
				...
				<form name="IRS5405" style="font-family:arial;">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:1px;">
						<div class="styFNBox" style="width:31mm;height:18.5mm;border-right-width:1px;">
							...
							<span class="styAgency">(Rev. November 2024)</span>
						...
						<div class="styTYBox" style="width:30mm;border-left-width:1px;height:18.50mm;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS5405LineItem" style="height:7mm;">
							...
							<div class="styIRS5405CleanDiv" style="width:181mm;height:auto;padding:0px 0px 0px 0px;">
								<div class="styIRS5405LNDesc" style="width:auto;height:100%;">
									<input type="checkbox" class="styCkbox" alt="Sold to non-relative for gain">
										<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styIRS5405LineItem" style="height:style:4mm;">
							...
							<div class="styIRS5405CleanDiv" style="width:181mm;height:auto;padding:0px 0px 0px 0px;">
								<div class="styIRS5405LNDesc" style="width:auto;height:100%;">
									<input type="checkbox" class="styCkbox" alt="Sold to non-relative for no gain">
										<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styIRS5405LineItem" style="height:8mm;padding-top:2mm;">
							...
							<div class="styIRS5405CleanDiv" style="width:181mm;height:auto;padding:0px 0px 0px 0px;height:6mm;">
								<div class="styIRS5405LNDesc" style="width:auto;height:1mm;">
									<input type="checkbox" class="styCkbox" alt="Sold to relative or gave away to non-spouse">
										<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styIRS5405LineItem" style="height:9mm;padding-top:2mm;">
							...
							<div class="styIRS5405CleanDiv" style="width:181mm;height:auto;padding:0px 0px 0px 0px;height:12mm;">
								<div class="styIRS5405LNDesc" style="width:auto;height:12mm;;">
									<input type="checkbox" class="styCkbox" alt="Converted to business use">
										<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styIRS5405LineItem" style="height:11mm;">
							...
							<div class="styIRS5405CleanDiv" style="width:181mm;height:auto;">
								<div class="styIRS5405LNDesc" style="width:auto;">
									<input type="checkbox" class="styCkbox" alt="Transferred to spouse or ex-spouse">
										<xsl:call-template name="PopulateCheckbox">
								...
								<div class="styIRS5405LNDesc" style="width:auto;height:8mm;">
									...
									<br/>
									<span style="border-color:black;border-width:0px 0px 1px 0px;border-style:solid;height:3.50mm;width:100%;padding-top:1px;">
										<xsl:call-template name="PopulateText">
						...
						<div class="styIRS5405LineItem">
							...
							<div class="styIRS5405CleanDiv" style="width:181mm;height:auto;padding:0px 0px 0px 0px;">
								<div class="styIRS5405LNDesc" style="width:auto;height:100%;">
									<input type="checkbox" class="styCkbox" alt="Destroyed or condemned sold for gain">
										<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styIRS5405LineItem">
							...
							<div class="styIRS5405CleanDiv" style="width:181mm;height:auto;padding:0px 0px 0px 0px;">
								<div class="styIRS5405LNDesc" style="width:auto;height:100%;">
									<input type="checkbox" class="styCkbox" alt="Destroyed or condemned sold no gain">
										<xsl:call-template name="PopulateCheckbox">
						...
						<div class="styIRS5405LineItem" style="height:8mm;">
							...
							<div class="styIRS5405CleanDiv" style="width:181mm;height:auto;padding:0px 0px 0px 0px;">
								<div class="styIRS5405LNDesc" style="width:auto;height:100%;">
									<input type="checkbox" class="styCkbox" alt="Credit taxpayer claimed deceased taxpayer">
										<xsl:call-template name="PopulateCheckbox">
								...
								<div class="styIRS5405LNDesc" style="width:auto;height:100%;">
									The taxpayer who claimed the credit died in 2024. No repayment of the credit is required of the deceased taxpayer. If you<br/>
									are filing a joint return for 2024 with the deceased taxpayer, see instructions. Otherwise, stop here.
								</div>
							</div>
						</div>
					</div>
					...
					<!-- Body -->
					<div class="styBB" style="width:187mm; height:38mm;">
						<!-- (4) ////////////////////////////////////////////////////-->
						<div class="styIRS5405LineItem" style="float:left;width:187mm;height:6mm;font-size:8pt;">
						<div class="styIRS5405LNLeftNumBox">4</div>
						<div class="styLNDesc" style="padding-left:3mm;">
							<span class="styIRS5405LineItem">
						...
						<div class="styLNRightNumBox" style="height:8mm;width:10mm;padding-top:4mm">4</div>
						<div class="styLNAmountBox" style="height:8mm;width:33mm;text-align:right;padding-top:4mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form5405Data/FirstTimeHmByrCrClaimedAmt"/>
							</xsl:call-template>
						</div>
						...
						<div class="styIRS5405LineItem" style="float:left;width:187mm;height:6mm;font-size:8pt;padding-bottom:8mm;">
						<div class="styIRS5405LNLeftNumBox" style="padding-top:3mm">5</div>
						<div class="styLNDesc" style="padding-left:3mm;">
							<span class="styIRS5405LineItem" style="padding-top:3mm">
								Enter the amount of the credit you repaid with your tax returns for the years 2010 through 2023
										<xsl:call-template name="SetFormLinkInline">
						...
						<div class="styLNRightNumBox" style="height:8mm;width:10mm;padding-top:4mm">5</div>
						<div class="styLNAmountBox" style="height:8mm;width:33mm;padding-top:4mm;text-align:right;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form5405Data/FirstTimeHmByrCrRepaidPYRetAmt"/>
							</xsl:call-template>
						</div>
						...
						<div class="styLNRightNumBox" style="height:8mm;width:10mm;padding-top:4mm">6</div>
						<div class="styLNAmountBox" style="height:8mm;width:33mm;text-align:right;padding-top:4mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form5405Data/FirstTimeHmByrNetCrClaimedAmt"/>
							</xsl:call-template>
						...
						<!-- Line 7 -->
						<div class="styIRS5405LineItem" style="float:left;width:187mm;height:6mm;font-size:8pt;">
						<div class="styIRS5405LNLeftNumBox" style="padding-top:3mm">7</div>
						<div class="styLNDesc" style="padding-left:3mm;">
							<span class="styIRS5405LineItem" style="padding-top:3mm">
						...
						<div class="styLNRightNumBox" style="height:8mm;width:10mm;padding-top:4mm">7</div>
						<div class="styLNAmountBox" style="height:8mm;width:33mm;text-align:right;padding-top:4mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form5405Data/GainOnSaleOfMainHomeAmt"/>
							</xsl:call-template>
						...
						<!-- Line 8 -->
						<div class="styIRS5405LineItem" style="float:left;width:187mm;height:6mm;font-size:8pt;">
						<div class="styIRS5405LNLeftNumBox" style="padding-top:3mm">8</div>
						<div class="styLNDesc" style="padding-left:3mm;">
							<span class="styIRS5405LineItem" style="padding-top:3mm">
						...
						<div class="styLNRightNumBox" style="height:8mm;width:10mm;padding-top:4mm">8</div>
						<div class="styLNAmountBox" style="height:8mm;width:33mm;text-align:right;padding-top:4mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form5405Data/FirstTimeHmByrRepaymentAmt"/>
							</xsl:call-template>
						...
						<div class="styIRS5405LineItem" style="padding-top:.5mm;height:8mm;">
							...
							<div class="styIRS5405CleanDiv" style="width:180mm;height:auto;padding:0px 0px 0px 0px;bac">
								<div class="styIRS5405LNDesc" style="width:auto;height:100%;padding:0px 0px 0px 0px;">
									<div class="styIRS5405LNDesc" style="width:auto;height:100%;font:8pt">
										<b>Next: </b>Enter the amount from line 8 on your 2024 Schedule 2 (Form 1040), line 10.
									</div>
								</div>
							</div>
						</div>
					...
					<div class="styTBB" style="width:187mm; height:auto;">
						<!-- Note -->
						<div class="styIRS5405LineItem" style="height:15mm;border-bottom:1px solid black;">
							<div class="styIRS5405LNLeftNumBox"/>
						...
						<!-- Line 9 -->
						<div class="styIRS5405LineItem" style="float:left;width:187mm;height:7mm;font-size:8pt;padding-bottom:8mm;">
						<div class="styIRS5405LNLeftNumBox" style="padding-top:3mm">9</div>
						<div class="styLNDesc" style="padding-left:3mm;">
							<span class="styIRS5405LineItem" style="padding-top:3mm">
						...
						<div class="styLNRightNumBox" style="height:8mm;width:10mm;padding-top:4mm">9</div>
						<div class="styLNAmountBox" style="height:8mm;width:33mm;text-align:right;padding-top:4mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form5405Data/SellingPriceOfHomeProcAwardAmt"/>
							</xsl:call-template>
						...
						<div class="styLNRightNumBox" style="height:8mm;width:10mm;padding-top:4mm">10</div>
						<div class="styLNAmountBox" style="height:8mm;width:33mm;text-align:right;padding-top:4mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form5405Data/SellingOfHomeExpensesAmt"/>
							</xsl:call-template>
						...
						<!-- Line 11 -->
						<div class="styIRS5405LineItem" style="float:left;width:187mm;height:6mm;font-size:8pt;">
						<div class="styIRS5405LNLeftNumBox" style="padding-top:3mm">11</div>
						<div class="styLNDesc" style="padding-left:3mm;">
							<span class="styIRS5405LineItem" style="padding-top:3mm">
						...
						<div class="styLNRightNumBox" style="height:8mm;width:10mm;padding-top:4mm">11</div>
						<div class="styLNAmountBox" style="height:8mm;width:33mm;text-align:right;padding-top:4mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form5405Data/MortgSbsdySaleOfHmRealizedAmt"/>
							</xsl:call-template>
						...
						<!-- Line 12 -->
						<div class="styIRS5405LineItem" style="float:left;width:187mm;height:8mm;font-size:8pt;">
						<div class="styIRS5405LNLeftNumBox" style="padding-top:3mm">12</div>
						<div class="styLNDesc" style="padding-left:3mm;">
							<span class="styIRS5405LineItem" style="padding-top:3mm">
						...
						<div class="styLNRightNumBox" style="height:8mm;width:10mm;padding-top:4mm">12</div>
						<div class="styLNAmountBox" style="height:8mm;width:33mm;text-align:right;padding-top:4mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form5405Data/AdjustedBasisOfHomeSoldAmt"/>
							</xsl:call-template>
						...
						<div class="styLNDesc" style="padding-left:3mm;">
							...
							repaid<br/> with your tax returns for the years 2010 through 2023 
										<xsl:call-template name="SetFormLinkInline">
						...
						<div class="styLNRightNumBox" style="height:8mm;width:10mm;padding-top:4mm">13</div>
						<div class="styLNAmountBox" style="height:8mm;width:33mm;text-align:right;padding-top:4mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form5405Data/FirstTimeHmByrNetCrRpdPYRetAmt"/>
							</xsl:call-template>
						...
						<!-- Line 14 -->
						<div class="styIRS5405LineItem" style="float:left;width:187mm;height:6mm;font-size:8pt;">
						<div class="styIRS5405LNLeftNumBox" style="padding-top:3mm">14</div>
						<div class="styLNDesc" style="padding-left:3mm;">
							<span class="styIRS5405LineItem" style="padding-top:3mm">
						...
						<div class="styLNRightNumBox" style="height:8mm;width:10mm;padding-top:4mm">14</div>
						<div class="styLNAmountBox" style="height:8mm;width:33mm;text-align:right;padding-top:4mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form5405Data/AdjustedBasisForRepymtCrAmt"/>
							</xsl:call-template>
					...
					<!--<p style="page-break-after: always"/>-->
						<!-- Line 15 -->
						<div class="styIRS5405LineItem" style="float:left;width:187mm;height:auto;font-size:8pt;">
						<div class="styIRS5405LNLeftNumBox" style="padding-top:3mm">15</div>
						<div class="styLNDesc" style="padding-left:3mm;">
							<span class="styIRS5405LineItem" style="padding-top:3mm">
						...
						<div class="styLNRightNumBox" style="height:8mm;width:10mm;padding-top:4mm">15</div>
						<div class="styLNAmountBox" style="height:8mm;width:33mm;text-align:right;padding-top:4mm">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$Form5405Data/GainOrLossFromWorksheetAmt"/>
							</xsl:call-template>
						...
						<div class="styIRS5405LineItem" style="height:25mm;">
							<div class="styIRS5405LNLeftNumBox"/>
							<div class="styIRS5405LNDesc" style="width:144mm;">
								...
								through condemnation or under threat of condemnation. Then complete Part II.
								<br/><br/>
					...
					<div class="pageEnd" style="width:187mm; padding-top:3px; border-top:1px solid black;">
						...
						<span style="float:right;padding-top:.5mm;">Form <span class="styBoldText" style="font-size:8pt;"> 5405  </span> (Rev. 11-2024)</span>
					</div>
