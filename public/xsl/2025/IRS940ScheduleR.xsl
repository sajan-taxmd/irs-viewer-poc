...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template match="/">
		...
		<html>
			...
			<!-- 6/9/2017 Form 940 Sch R changed from portrait orientation to landscape orientation. 940 Sch R Style file has changed as well -->
				...
				<form name="IRS940ScheduleR">
					...
					<div class="styBB" style="width:256mm;border-bottom-width:0px;padding-bottom:0mm;">
						<div style="width:190mm;float:left;">
							<div class="styAgency" style="padding-bottom:1mm;line-height:150%;">(Rev. December 2024)<br/>Department of the Treasury—Internal Revenue Service</div>
							<div class="styBB" style="width:185mm;height:24mm;border-top-width:1px;border-left-width:1px;border-right-width:1px;float:left;padding-left:2mm;padding-bottom:0mm;">
								...
								<div style="width:180mm;padding-bottom:1mm;padding-top:0.5mm;">
					...
					<div class="styLNDesc" style="padding-top:1mm;width:190mm;padding-bottom:4mm;">
								Read the instructions before you complete Schedule R. Type or print within the boxes. Complete a separate line for the amounts allocated to each of your
							...
							<tbody>
								...
								<xsl:if test="(count($FormData/ClientInfoGrp) &lt; 1) or ((count($FormData/ClientInfoGrp) &gt; 15) and ($Print = $Separated))">
									<tr>
										...
										<td class="IRS940ScheduleR_GenericCell">
											<br/>
										</td>
										<td class="IRS940ScheduleR_GenericCell">
											<br/>
										...
										<td class="IRS940ScheduleR_GenericCell" style="border-right-width:0px;">
											<br/>
										</td>
									</tr>
								</xsl:if>
								...
								<tr>
									<td class="IRS940ScheduleR_GenericCell" style="width:32.75mm;text-align:left;padding-left:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;border-left-width:0px;">
										...
										<div style="font-size:6pt;padding-top:0.5mm;padding-left:0.5mm;text-align:left;">
											<b>Subtotals for clients.<br/>
											</b> Add all amounts on<br/> lines 1 through 15	
											</div>
									</td>
					...
					<div class="pageEnd" style="width:256mm;border-top-width:1px;border-bottom-width:0px;">
						...
						<div style="width:90mm;float:left;text-align:center;padding-top:0.2mm">
							<i>www.irs.gov/Form940</i>
							<span style="width:20mm;"/>Cat. No. 53082A
					    </div>
						<div style="width:74mm;text-align:right;float:left;">
							<span style="font-weight:bold;">Schedule R (Form 940) (Rev. 12-2024)</span>
						</div>
					</div>
					<!--END Page Footer-->
