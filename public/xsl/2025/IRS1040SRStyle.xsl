...
<!-- Last Modified by Yee Chen on 08/20/2025 -->
...
<xsl:template name="IRS1040SRStyle">
  ...
  /* BEGIN PAGE SPECIFIC STYLES */  
	...
	.styIRS1040SRTableCell {   /* Table Cell for Letter */
    <!--width: 5mm;-->
    color: black;
    border-color:black;
    border-style: solid;
  ...
  .styIRS1040SRliTableCell {   /* Table Cell for Little Letter */
    width: 55mm;
    color: black;
    border-color:black;
    border-style: solid;
    ...
    .styIRS1040SRli2TableCell {   /* Table Cell for Little Letter */
    width: 55mm;
    color: black;
    border-color:black;
    border-style: solid;
