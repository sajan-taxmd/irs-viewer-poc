...
<!-- Last Modified by Jermaine Merchant 07/1/2025 -->
				...
				<form name="IRS8814">
					...
					<div class="styBB" style="width:187mm;">
						<span style="width:100%;">
							...
							<input class="styCkbox" aria-label="more than one form attached" type="checkbox" style="height: 5mm; width: 5mm;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8814LineItem" style="height:11mm">
							...
							<div class="styIRS8814LNDesc" style="width:144mm;height:100%;padding:5px 0px 0px 0px;">
								<div class="styIRS8814LNDesc" style="width:auto;height:100%;">
									Add lines 1a, 2a, and 3. If the total is $2,700 or less, skip lines 5 through 12 and go to line 13. If<br/>
									the total is $13,500 or more, <b>do not</b> file this form. Your child <b>must</b> file his or her own return to<br/>
						...
						<div class="styIRS8814LineItem" style="height:5mm">
							...
							<div class="styIRS8814LNDesc" style="width:144mm;height:100%;padding:5px 0px 0px 0px;">
								...
								<div class="styIRS8814LNDesc" style="width:auto;height:100%;text-align:right;padding:2.5px 0mm 0px 0px;float:right;">
									<span class="styDotLn" style="float:left;padding-left:2.1mm">..............................</span>
								</div>
							</div>
							<xsl:call-template name="CreateBox">
								<xsl:with-param name="StaticText">2,700.00</xsl:with-param>
					...
					<div style="width:187mm;" class="styBB">
						<span style="width:100%;height:auto;padding:7px 0px 7px 0px;">
							...
							<div class="styPartDesc" style="padding-left:3mm;">
								Tax on the First $2,700 of Child's Interest and Dividends
							</div>
						</span>
					</div>
					<!-- Body -->
					<div class="styBB" style="width:187mm;">
						...
						<div class="styIRS8814LineItem" style="height:5mm">
							...
							<div class="styIRS8814LNDesc" style="width:144mm;height:100%;padding:5px 0px 0px 0px;">
								...
								<div class="styIRS8814LNDesc" style="width:auto;height:100%;text-align:right;float:right;
								  padding:2px 3mm 0px 0px;">
									<!--Dotted Line-->
									<span class="styDotLn" >............................</span>
								</div>
							</div>
							<xsl:call-template name="CreateBox">
								<xsl:with-param name="StaticText">$1,350.00</xsl:with-param>
								<xsl:with-param name="AmountBoxStyle">text-align:right;</xsl:with-param>
						...
						<div class="styIRS8814LineItem" style="height:15mm">
							...
							<div class="styIRS8814LNDesc" style="width:144mm;height:100%;padding:5px 0px 0px 0px;">
								<div class="styIRS8814LNDesc" style="width:auto;height:100%;">
									<b>Tax.</b> Is the amount on line 14 less than $1,350?<br/>
									<div class="styIRS8814LNDesc" style="width:auto;height:auto;padding:0px 0px 0px 0px;">
										<span>
											...
											<input type="checkbox" aria-label="tax amount No" class="styCkbox">
										...
										<label>
											...
											<span class="styBoldText">No.</span> Enter $135 here and see the <b>Note</b> below.
										</label>
										<br/>
										<span>
											<xsl:call-template name="PopulateSpan">
											...
											<input type="checkbox" aria-label="tax amount Yes" class="styCkbox">
												<xsl:if test="$Form8814Data/ChildTaxBasisUnderSpcfdAmtInd">
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							...
							Form <span class="styBoldText" style="font-size:7pt;"> 8814 </span> (2025)
						</div>
					</div>
