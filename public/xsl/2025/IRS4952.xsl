...
<!-- Last Modified by Ashleigh Smith on 10/14/2025 -->
				...
				<form name="IRS4952" style="font-family:arial;">
					...
					<div style="width:187mm;">
							...
							<div class="styFNBox" style="width:31mm;height:22mm;border-right-width:1px;padding-top:.5mm;">
								...
								<br/>
								 <div class="styAgency" style="padding-top:3mm;padding:bottom:0mm;">
									Department of the Treasury<br/>Internal Revenue Service <span style="width:3mm;"/>
								 </div>
							</div>
							...
							<div style="width:187mm;">
								<span style="float:left;font-size:8.5pt;">
									...
									<div class="styLNDesc" style="width:141mm;height:7.5mm;padding-left:3mm;">
										Disallowed investment interest expense to be carried forward to 2026. Subtract line 6 from line 3.<br/>
						...
						<div style="width:187mm;padding-top:.3mm;font-size:7pt">
							...
							<div class="styGenericDiv" style="float:right;text-align:right">Form <span style="font-size:8pt;font-weight:bold;">4952</span> (2025)</div>
						</div>
					</div>
					<!-- <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< -->
