...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
      ...
      <br/>
							...
							<div class="sty990ScheduleKAgency" style="padding-top: 2mm">Department of the Treasury
             ...
             See separate instructions.--></span>
                ...
                <i>www.irs.gov/Form990</i></a> for instructions and the latest information. 
						...
						<div class="IRS990ScheduleK_FormYearBlock" style="height:auto;float:right">
							<!-- OMB No. -->
							<div class="IRS990ScheduleK_OMB" style="height:10mm;padding-top:4mm;">OMB No. 1545-0047</div>
							<!-- Tax Year -->
							<div class="IRS990ScheduleK_TaxYear" style="padding-top:0mm;padding-bottom:0;height:auto;">
								<div class="sty990ScheduleKPartName" style="font-size:7pt;font-family:verdana;width:45mm;padding-top:0mm;padding-bottom:0mm;height:11mm">Open to Public <br/>Inspection</div>
							</div>
						</div>
					</div>
					<!--   END FORM HEADER   -->
            ...
            <!--Dotted Line-->
               ...
               <div style="width:256mm;float:none;clear:both;border-top:solid 0px" class="pageEnd">
						...
						<div class="styGenericDiv" style="float:right;">
							<span class="styBoldText">Schedule K (Form 990) (Rev. 1-2025)</span>
						</div>
					</div>
					<!--     END FORM FOOTER   -->
				 <p style="page-break-before: always"/>
					<div class="styBB" style="width:256mm; float: none; clear:none;border-bottom-width:1px">
						<div style="float:left"> Schedule K (Form 990) (Rev. 1-2025)</div>
		...
		<!-- =========================================================================-->
		 <p style="page-break-before: always"/>
					...
					<div style="width:256mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
						<div style="width:90mm;" class="styGenericDiv">Schedule K (Form 990) (Rev. 1-2025)</div>
                ...
                <xsl:if test="count($FormData/Form990ScheduleKPartVI) &lt; 17">
                  <xsl:call-template name="IRS990ScheduleKPartVITableFillerRow"/>
					...
					<div class="sty990ScheduleKFormFooter" style="padding-top:1mm">
						...
						<div style="width:56mm;text-align:center;font-weight:bold;  float: right; clear: none;"> Schedule K (Form 990) (Rev. 1-2025)</div>
					</div>
					<!--     END FORM FOOTER   -->
					<!--     END FORM FOOTER   -->
					<div class="pageEnd"/>
