...
<!-- Last Modified by Ashleigh Smith on 01/06/2026 -->
	...
	<xsl:template match="/">
		...
		<html>
            ...
            OMB No. 1545-0192
							...
							<div class="styTY" style="height:7mm;font-size:22pt;">20<span class="styTYColor">25</span></div>
            ...
            Sequence No. <span class="styBoldText">178</span>
								...
								<!--1041 Return Header data populated-->
									<xsl:when test="$RtnHdrData/Filer/EIN">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$RtnHdrData/Filer/EstateOrTrustName/BusinessNameLine1Txt | $RtnHdrData/Filer/BusinessName/BusinessNameLine1Txt[1]"/>	
										</xsl:call-template>			
										<!--<br/>
									...
									<!--4970 schema data present and data populated-->
										<xsl:when test="normalize-space($FormData/PersonSubjectToTrustTaxNm) !=''">
											<xsl:call-template name="PopulateText">
						...
						<div class="styEINBox" style="width:50mm;height:auto,padding-bottom:1mm;padding-left:2mm;font-size:6.8pt;font-weight:bold;">
							...
							<span style="width:43mm;text-align:left;font-weight:normal;padding-top:2mm;padding-left:4mm">
								...
								<!--1041 Return Header data populated-->
									...
									<!--<xsl:otherwise>-->
									<!--4970 schema data present and data populated-->
									<xsl:when test="normalize-space($FormData/PersonSubjectToTrustTaxSSN) !=''">
					...
					<div class="styBB" style="width:187mm;">
						...
						<span style="float:left;">
							...
							<div style="float:left;">
								<div class="styLNAmountBox" style="text-align:center;width:28mm;font-weight:bold;height:auto;float:none">(a) 2024</div><br/>
							...
							<div style="float:left;">
								<div class="styLNAmountBox" style="text-align:center;width:28mm;font-weight:bold;height:auto;float:none">(b) 2023</div><br/>
								<div class="styLNAmountBox" style="height:6mm;width:28mm;border-bottom:none;float:none;padding-top:2.5mm;
								  padding-bottom:0;padding-right:1mm">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="float:left;">
								<div class="styLNAmountBox" style="text-align:center;width:28mm;font-weight:bold;height:auto;float:none">(c) 2022</div><br/>
								<div class="styLNAmountBox" style="height:6mm;width:28mm;border-bottom:none;float:none;padding-top:2.5mm;
								  padding-bottom:0;padding-right:1mm">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="float:left;">
								<div class="styLNAmountBox" style="text-align:center;width:28mm;font-weight:bold;height:auto;float:none">(d) 2021</div><br/>
								<div class="styLNAmountBox" style="height:6mm;width:28mm;border-bottom:none;float:none;padding-top:2.5mm;
								  padding-bottom:0;padding-right:1mm">
									<xsl:call-template name="PopulateAmount">
							...
							<div style="float:left;">
								<div class="styLNAmountBox" style="text-align:center;width:28mm;font-weight:bold;height:auto;float:none">(e) 2020</div><br/>
								<div class="styLNAmountBox" style="height:6mm;width:28mm;border-bottom:none;float:none;padding-top:2.5mm;
								  padding-bottom:0;padding-right:1mm">
									<xsl:call-template name="PopulateAmount">
					...
					<div class="styBB" style="width: 187mm"></div>
						...
						Form <b style="font-size:9pt">4970</b> (2025)
						</div>
					<div class="pageEnd"/>
