					...
					<div class="styTBB" style="width:187mm;height:22.5mm;">
						<div class="styFNBox" style="width:30mm;height:22.5mm;">
							<div style="padding-top:1mm;font-weight:bold;font:8pt">
								...
								<br/>
						<span style="font-size:6pt;font-weight:normal;">(Rev. January 2025)</span>
							</div>
			...
			Go to <!--www.irs.gov/form990.--><a href="http://www.irs.gov/form990" title="Link to IRS.gov">
                <i>www.irs.gov/Form990</i></a> for instructions and the latest information. 
						...
						<div class="styTYBox" style="width:30mm;height:22.5mm;">
							<div class="styOMB" style="height:11.25mm;padding-top:4mm">OMB No. 1545-0047</div>
							<div class="styPartName" style="height:11.25mm; width:30.5mm;padding-top:0.3mm">Open to Public Inspection</div>
						</div>
					</div>
...
Complete if the organization answered "Yes" on Form 990, Part IV, line 25a or 25b, or Form 990-EZ, Part V, line 40b.
        ...
        ........ </span>
					...
					<!-- Begin Part II -->
					<div class="styBB" style="width:187mm;border-top-width:0px;height:auto;">
						...
						<div class="styPartDesc" style="float:left;width:172mm;height:auto;">Loans to and/or From Interested Persons.<br/>
							<span style="font-size: 7pt;font-weight:normal;border-bottom-width:0px;;">
        Complete if the organization answered "Yes" on Form 990-EZ, Part V, line 38a, or Form 990, Part IV, line 26; or if the organization reported an amount on Form 990, Part X, line 5, 6, or 22
					...
					<div class="styTableContainerNBB" id="IPRctn" style="width: 187mm; height:auto;display:table;">
						...
						<table class="styTable" style="font-size:7pt;float:none;clear:both;height:auto;" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									<th class="styDepTblCell" scope="col" rowspan="2" style="height:auto;border-style: solid; border-color: black;width:40mm;font-weight:normal;text-align:center;vertical-align:top;border-top-width:0px;border-left-width:0px;">
										<span style="font-weight:bold">(a)</span> Name of interested person</th>
										
									<th class="styDepTblCell" scope="col" rowspan="2" style="height:auto;border-style: solid; border-color: black;width:35mm;font-weight:normal;text-align:center;vertical-align:top;border-top-width:0px;border-left-width:0px;">
										<span style="font-weight:bold">(b)</span> Relationship with organization</th>
										
									<th class="styDepTblCell" scope="col" rowspan="2" style="height:auto;border-style: solid; border-color: black;width:25mm;font-weight:normal;text-align:center;vertical-align:top;border-top-width:0px;border-left-width:0px;">
										<span style="font-weight:bold">(c)</span> Purpose of loan</th>
										
									<th class="styDepTblCell" colspan="2" scope="col" style="height:auto;border-style: solid; border-color: black;width:18mm;font-weight:normal;text-align:center;vertical-align:top;border-top-width:0px;border-left-width:0px;">
										<span style="font-weight:bold">(d)</span> Loan to or from the organization?</th>
										
									<th class="styDepTblCell" rowspan="2" scope="col" style="height:auto;border-style: solid; border-color: black;width:25mm;font-weight:normal;text-align:center;vertical-align:top;border-top-width:0px;border-left-width:0px;">
										<span style="font-weight:bold">(e)</span> Original principal amount </th>
										
									<th class="styDepTblCell" rowspan="2" scope="col" style="height:auto;border-style: solid; border-color: black;width:25mm;font-weight:normal;text-align:center;vertical-align:top;border-top-width:0px;border-left-width:0px;">
										<span style="font-weight:bold">(f)</span> Balance due</th>
										
									<th class="styDepTblCell" colspan="2" scope="col" style="height:auto;border-style: solid; border-color: black;width:16mm;font-weight:normal;text-align:center;vertical-align:top;border-top-width:0px;border-left-width:0px;">
									...
									<th class="styDepTblCell" colspan="2" scope="col" style="height:auto;border-style: solid; border-color: black;width:16mm;font-weight:normal;text-align:center;vertical-align:top;border-top-width:0px;border-right-width:0px;border-left-width:0px;">
			...
			<xsl:call-template name="SetInitialDynamicTableHeight">
					...
					<div class="styBB" style="height:auto;width:187mm;float:none;border-top:solid 0px;">
						<div class="styPartName" style="float:left;width:14mm;height:auto;border-top-width: 0px;">Part III</div>
						<div class="styPartDesc" style="width:172mm;height:auto;border-top:solid 0px;">Grants or Assistance Benefiting Interested Persons.<br/>
         ...
         Complete if the organization answered "Yes" on Form 990, Part IV, line 27.
					...
					<div class="styTableContainerNBB" id="OActn" style="width: 187mm; height:auto; display:table;">
						...
						<table class="styTable" style="font-size:7pt;float:none;clear:both;height:auto;" cellspacing="0">
							<thead class="styTableThead">
								<tr>
									<th class="styTableCellHeader" scope="col" style="height:auto;border-style: solid; border-color: black;width:40mm;font-weight:normal;border-top-width:0px;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(a)</span> Name of interested person</th>
									<th class="styTableCellHeader" scope="col" style="height:auto;border-style: solid; border-color: black;width:37.2mm;font-weight:normal; text-align:center;vertical-align:top;border-top-width:0px;">
										<span style="font-weight:bold">(b)</span> Relationship between interested person and the organization</th>
									<th class="styTableCellHeader" scope="col" style="height:auto;border-style: solid; border-color: black;width:37.2mm;font-weight:normal;text-align:center;vertical-align:top;border-top-width:0px;border-right-width:1px">
										<span style="font-weight:bold">(c)</span> Amount of assistance</th>
										<th class="styTableCellHeader" scope="col" style="height:auto;border-style: solid; border-color: black;width:37.2mm;font-weight:normal; text-align:center;vertical-align:top;border-top-width:0px;border-right-width:1px">
										<span style="font-weight:bold">(d)</span> Type of assistance</th>
										<th class="styTableCellHeader" scope="col" style="height:auto;border-style: solid; border-color: black;width:37.2mm;font-weight:normal; text-align:center;vertical-align:top;border-top-width:0px;border-right-width:0px">
				...
				<div class="styGenericDiv" style="width:110mm;font-weight:bold;font-size:6pt">For Paperwork Reduction Act Notice, see the Instructions for Form 990 or 990-EZ. </div>
						...
						<div class="styGenericDiv" style="float:right;">
							<span class="styBoldText" style="font-size:6pt">Schedule L (Form 990) (Rev. 1-2025)</span>
						</div>
					</div>
          <!-- header -->
          <div style="width:187mm;clear:both;padding-bottom:.5mm;float:none;clear:both;" class="styBB">
            <div style="width:90mm;" class="styGenericDiv">Schedule L (Form 990) (Rev. 1-2025)</div>
