			...
			<body class="styBodyClass">
				<form id="Form8993">
					...
					<div class="styStdDiv" style="height:7mm;">
						<div class="styLNLeftNumBoxSD" style="padding-left:4.2mm;height:auto;">g</div>
						<div class="styLNDesc" style="width:98mm;height:auto;">
							Income and gain from the sale or other disposition of section 367(d)(4) intangible property (see instructions)
							<span class="sty8993DotLn">............</span>
						</div>
						<div class="styLNRightNumBox" style="height:7mm;padding-top:3.5mm;">2g</div>
						<div class="styLNAmountBox" style="padding-right:0.5mm;height:7mm;padding-top:3.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/GainSaleDisposSect367d4PropAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:7mm;">&nbsp;</div>
						<div class="styLNAmountBoxNBB" style="background-color:lightgrey;border-left-width:0px;height:7mm;">&nbsp;</div>
					</div>
					<!-- Part 1 Line 2h -->
					<div class="styStdDiv" style="height:7mm;">
						<div class="styLNLeftNumBoxSD" style="padding-left:4.2mm;height:auto;">h</div>
						<div class="styLNDesc" style="width:98mm;height:auto;">
							Income and gain from the sale or other disposition of certain other property (see instructions)
							<span class="sty8993DotLn">..................</span>
						</div>
						<div class="styLNRightNumBox" style="height:7mm;padding-top:3.5mm;">2h</div>
						<div class="styLNAmountBox" style="padding-right:0.5mm;height:7mm;padding-top:3.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/GainSaleDisposOtherPropAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNRightNumBoxNBB" style="background-color:lightgrey;height:7mm;">&nbsp;</div>
						<div class="styLNAmountBoxNBB" style="background-color:lightgrey;border-left-width:0px;height:7mm;">&nbsp;</div>
					...
					<div class="styStdDiv">
						...
						<div class="styLNDesc">
							Total exclusions (add lines 2a through 2h)
							<span class="sty8993DotLn">.....................</span>
						</div>
					...
					<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
						...
						<span style="float:right;">Form <strong>8993</strong> (Rev. 12-2025)</span>
					</div>
