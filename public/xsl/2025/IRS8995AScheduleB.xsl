				...
				<form id="Form8995AScheduleB">
					...
					<div class="styStdDiv">
						<div class="styFNBox" style="width:30mm;height:22.5mm;">
							...
							<br />
							<div class="styAgency" style="padding-top: 1mm">(Rev. December 2022)</div> 
						...
						<div class="styFTBox" style="width:127mm;height:22.5mm;">
							<span class="styFMT" style="font-size:12pt;padding-top:1mm;padding-bottom:2mm;padding-bottom:6mm;">Aggregation of Business Operations</span>
							<br /><br />
						...
						<div class="styTYBox" style="width:30mm;height:22.5mm;">
							...
							<div style="margin-left:3mm;text-align:left;font-size:7pt;padding-top:10.5mm;">
					...
					<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
						...
						<span style="margin-left:10mm;">Cat. No. 72685V</span>
						<span style="float:right;font-weight:bold;">Schedule B (Form 8995-A) (Rev. 12-2022)</span>
					</div>
