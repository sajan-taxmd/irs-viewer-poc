		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form id="Form1065ScheduleK2" style="width:256mm;">
					...
					<div class="styStdDivLS" style="border-bottom:1px solid black;">
						...
						<div class="styLNDesc" style="width:122mm;height:10mm;">
							...
							<span>
								...
								<input type="checkbox" class="styCkbox" style="margin-left:20px;" alt="Qualified Derivatives Dealer No">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/QualifiedDerivativesDealerInd"/>
										<xsl:with-param name="BackupName">F1065SK2QualifiedDerivativesDealerInd</xsl:with-param>
									</xsl:call-template>
					...
					<!-- Line C -->
					<div class="styStdDivLS" style="border-bottom-width:1px solid black;">
						...
						<!-- Line D -->
						<div class="styStdDivLS" style="border-top:1px solid black;height:5mm;">
							<div class="styLNLeftLtrBox" style="width:6mm;padding-left:2mm;padding-top:1mm;">D</div>
							<div class="styLNDesc" style="">
								Check the applicable box.
								<span style="width:7mm;"/>
									<strong>(1)</strong>
								<span style="width:2mm;"/>
								<input type="checkbox" class="styCkboxNM" style="margin-right:2mm;" alt="Amended K2 Ind">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/AmendedK2Ind"/>
										<xsl:with-param name="BackupName">F1065SK2AmendedK2Ind</xsl:with-param>
									</xsl:call-template>
								</input>
									Amended K-2
								<span style="width:7mm;"/>
					...
					<div class="styStdDivLS pageEnd" style="border-top:2px solid black;font-weight:bold;">
						...
						<span style="float:right;">Schedule K-2 (Form 1065) 2025</span>
					</div>
					<!-- Page 2 -->
					<div class="styStdDivLS">
						Schedule K-2 (Form 1065) 2025
									...
									<xsl:for-each select="$FormData/SchK2K3ForeignTaxesGrp/FrgnTaxRedeterminationsGrp">
										<tr style="vertical-align:bottom;">
											...
											<td class="styTableCellTextInherit" style="">
												...
												<br />
												Contested tax
												<input type="checkbox" class="styCkboxNM" style="margin-right:2mm;" alt="Contested tax">
												<xsl:call-template name="PopulateCheckbox">
								...
								<xsl:if test="$sep3-4-3 or ($count343 &lt; 2)">
									<tr>
										...
										<td class="styTableCellTextInherit" style="">
											...
											Contested tax <input type="checkbox" class="styCkboxNM" style="margin-right:2mm;" alt="Contested tax"/>
										</td>
										<td class="styTableCellAmtInherit" style="">&nbsp;</td>
										<td class="styTableCellAmtInherit" style="">&nbsp;</td>
										<td class="styTableCellAmtInherit" style="">&nbsp;</td>
					...
					<div class="styStdDivLS" style="font-size:8pt;font-weight:bold;">
						<div class="styLNDesc" style="width:255mm;height:auto;border-bottom:1px solid black;border-top:2px solid black;">
							Section 2 &mdash; Information to Determine Foreign-Derived Deduction Eligible Income (FDDEI) on Form 8993 <span style="font-weight:normal;">(see instructions)</span>
						</div>
					</div>
					<div class="styStdDivLS">
						<div class="styLNLeftNumBoxSD" style="height:10.5mm;border-bottom:1px solid black;">&nbsp;</div>
						<div class="styLNAmountBox" style="width:120mm;height:10.5mm;font-weight:bold;text-align:center;padding-top:3.5mm;border-left:0;">Description</div>
					...
					<div class="styStdDivLS" style="border-bottom:1px solid black;">
						...
						<div class="styLNDesc" style="width:152mm;font-weight:bold;text-align:center;">Description</div>
						...
						<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
							<thead class="styTableThead">
								<tr style="border-top:1px solid black;">
									...
									<th class="styTableCellHeader" scope="col" style="width:35mm;font-weight:normal;">
										<strong>(k)</strong> Aggregate share <br/> of QBAI
									</th>
									<th class="styTableCellHeader" scope="col" style="width:36mm;font-weight:normal;">
						...
						<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
							<thead class="styTableThead">
								...
								<tr>
									...
									<th class="styTableCellHeader" scope="col" style="width:25mm;font-weight:normal;">
										<strong>(m)</strong> Check if PFIC is also a CFC within the meaning of section 957.
									</th>
								...
								<xsl:if test="not($sep7)">
									<xsl:for-each select="$FormData/SchK2K3InfoToComplete8621Grp">
										<tr style="vertical-align:bottom;">
											...
											<td class="styTableCellTextInherit" style="">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="ElectionCd"/>
												</xsl:call-template>
											</td>
											<xsl:variable name="pos" select="position()"/>
											<td class="styTableCellCtrInherit" style="">
					...
					<div class="styTableContainerLandscapeNBB" id="Page13Table1">
						...
						<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
							<thead class="styTableThead">
								...
								<tr>
									<th class="styTableCellHeader" scope="col" style="width:8mm;">&nbsp;</th>
									<th class="styTableCellHeader" scope="col" style="width:53mm;font-weight:normal;">
										<strong>(a)</strong> Name of PFIC
									</th>
									<th class="styTableCellHeader" scope="col" style="width:20mm;font-weight:normal;">
										<strong>(b)</strong> EIN or reference ID number
									...
									<th class="styTableCellHeader" scope="col" style="width:27mm;font-weight:normal;">
										<strong>(e)</strong> Fair market value (FMV) of PFIC shares at beginning of tax year
									</th>
									<th class="styTableCellHeader" scope="col" style="width:27mm;font-weight:normal;">
										<strong>(f)</strong> FMV of PFIC shares at end of tax year
									</th>
									<th class="styTableCellHeader" scope="col" style="width:20mm;font-weight:normal;">
										<strong>(g)</strong> Dates PFIC shares were acquired
									</th>
									<th class="styTableCellHeader" scope="col" style="width:27mm;font-weight:normal;">
										<strong>(h)</strong> Amount of cash and FMV of property distributed by PFIC during the current tax year (if applicable)
									</th>
									<th class="styTableCellHeader" scope="col" style="width:20mm;font-weight:normal;border-right-width:0px;">
					...
					<xsl:for-each select="$FormData/SchK2K3PrtshpFrgnCorpIncmGrp">
						...
						<!--<xsl:call-template name="S960Page1temp"></xsl:call-template>-->
						<xsl:call-template name="S960Page1">
							<xsl:with-param name="K2-1065" select="true()"/>
						</xsl:call-template>
						<div class="styStdDivLS pageEnd" style="border-top:1px solid black;font-weight:bold;">
							<span style="float:right;">Schedule K-2 (Form 1065) 2025</span>
						</div>
					...
					<div class="styStdDivLS" style="font-size:8pt;font-weight:bold;">
						<div class="styLNDesc" style="width:255mm;height:auto;border-bottom:1px solid black;">
							Section 1 &mdash; Applicable Taxpayer <span style="font-weight:normal;">(see instructions for more information and definition of terms)</span>
						</div>
					</div>
					<div class="styStdDivLS" style="border-bottom:1px solid black;">
					...
					<div class="styStdDivLS">
						...
						<div class="styLNAmountBox" style="padding-right:0.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SchK2PartnerInfoBEATGrp/CostShrTransPymtGrp/TotalAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox" style="padding-right:0.5mm;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SchK2PartnerInfoBEATGrp/CostShrTransPymtGrp/TotalBaseErosionPaymentAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNAmountBox">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/SchK2PartnerInfoBEATGrp/CostShrTransPymtGrp/TotBaseErosionTaxBenefitAmt"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Part 9, Line 8 -->
					...
					<div class="styStdIBDivLS">
						...
						<div class="styLNAmountBox" style="background-color:lightgrey;height:10mm;border-bottom:0px;">&nbsp;</div>
						<div class="styLNAmountBox" style="background-color:lightgrey;height:10mm;border-bottom:0px;">&nbsp;</div>
						<div class="styLNAmountBox" style="height:10mm;border-bottom:0px;"><br /><br />
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styStdDivLS">
						...
						<div class="styLNDesc" style="width:152mm;height:16mm;">
							Portion of base erosion tax benefits reported on lines 6 through 16, on which tax is imposed by section
							871 or 881, with respect to which tax has been withheld under section 1441 or 1442 at a reduced
							withholding rate pursuant to an income tax treaty or subject to a reduced rate of tax under Regulations
						...
						<div class="styLNAmountBox" style="background-color:lightgrey;height:16mm;">&nbsp;</div>
						<div class="styLNAmountBox" style="background-color:lightgrey;height:16mm;">&nbsp;</div>
						<div class="styLNAmountBox" style="height:16mm;"><br /><br /><br /><br />
							<xsl:call-template name="PopulateAmount">
						...
						<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
							...
							<tbody>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK2FrgnPrtnrSrceIncmDedGrp/OtherGainGrp[1]"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 16 -->
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK2FrgnPrtnrSrceIncmDedGrp/OtherGainGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 17 -->
								<tr>
								...
								<tr>
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK2FrgnPrtnrSrceIncmDedGrp/OtherIncomeNotIncludedGrp[1]"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 20 -->
								<tr style="vertical-align:bottom;">
									...
									<xsl:call-template name="LinePartnerDetermination">
										<xsl:with-param name="TargetNode" select="$FormData/SchK2FrgnPrtnrSrceIncmDedGrp/OtherIncomeNotIncludedGrp"/>
									</xsl:call-template>
								</tr>
								<!-- Part 10, Line 21 -->
								<tr style="vertical-align:bottom;border-top:2px solid black;">
					...
					<div class="styStdDivLS">
						...
						<div class="styLNDesc" style="width:240mm;height:auto;">
							Check the box if you are a publicly traded partnership as defined in section 7704(b) and you (a) are a covered partnership 
							as defined in Regulations section 1.871-15(m)(1) or (b) directly or indirectly hold an interest in a lower-tier partnerhip 
							...
							<thead class="styTableThead">
								<tr style="border-top:1px solid black;">
									<th class="styTableCellHeader" scope="col" style="width:49mm;font-weight:normal;">
										<strong>(a)</strong> Beginning of allocation period
									</th>
									<th class="styTableCellHeader" scope="col" style="width:49mm;font-weight:normal;">
										<strong>(b)</strong> End of allocation period
									</th>
									<th class="styTableCellHeader" scope="col" style="width:50mm;font-weight:normal;">
										<strong>(c)</strong> Dividends <br /> (enter four decimal places)
									</th>
									<th class="styTableCellHeader" scope="col" style="width:50mm;font-weight:normal;">
										<strong>(d)</strong> Dividend equivalents <br /> (enter four decimal places)
									</th>
									<th class="styTableCellHeader" scope="col" style="width:50mm;font-weight:normal;border-right-width:0px;">
										<strong>(e)</strong> Total <br /> (enter four decimal places)
									</th>
								</tr>
							</thead>
							<tbody>
					...
					<!-- Part 12 -->
					<xsl:for-each select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp">
						<xsl:call-template name="Section871CoveredPartnershiplocal"/>
					</xsl:for-each>
					<xsl:if test="count($FormData/SchK2K3Sect871mTaxLiabOfQDDGrp) &lt; 1">
						<xsl:call-template name="Section871CoveredPartnershiplocal"/>
					</xsl:if>
					<div class="styStdDivLS pageEnd" style="border-top:1px solid black;font-weight:bold;">
						<span style="float:right;">Schedule K-2 (Form 1065) 2025</span>
...
<!-- Additonal Data Title Bar and Button -->
	...
	<xsl:template name="Section871CoveredPartnershiplocal">
					<div class="styStdDivLS" style="border-top:1px solid black;border-bottom:1px solid black;">
						<div class="styPartName" style="width:15mm;">Part XII</div>
						<div class="styPartDesc" style="padding-left:3mm;width:230mm;">
							Section 871(m) Tax Liability of a Qualified Derivatives Dealer (QDD)
						</div>
					</div>
					<div class="styStdDivLS" style="border-bottom:1px solid black;">
						<div class="styNameBox" style="width:163mm;font-size:7pt;">
							Name of QDD <br />
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/QDDName/BusinessNameLine1Txt"/>
							</xsl:call-template>
							<xsl:if test="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/QDDName/BusinessNameLine2Txt">
								<br/>
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/QDDName/BusinessNameLine2Txt"/>
								</xsl:call-template>
							</xsl:if>
						</div>
						<div class="styNameBox" style="width:90mm;padding-left:1mm;padding-top:4mm;font-weight:normal;font-size:7pt;border-right:0;">
								Schedule
							<span style="width:35mm;text-align:center;border-bottom:1px solid black;font-size:6pt;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/QDDScheduleNum"/>
								</xsl:call-template>
							</span>
									of
							<span style="width:35mm;text-align:center;border-bottom:1px solid black;font-size:6pt;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotalQDDScheduleNum"/>
								</xsl:call-template>
							</span>
						</div>
					</div>
						...
						<div class="styStdDivLS">
							...
							<div class="styStdDivLS">
								...
								<strong>Beginning</strong>
									<span style="width:2mm"/>
									<span style="width:25mm;border-bottom:solid black 1px;text-align:center;">
										<xsl:call-template name="PopulateMonthDayYear">
											<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/BeginDt"/>
										</xsl:call-template>
									</span>
										<strong>, and ending</strong>
											...
											<span style="width:25mm;border-bottom:solid black 1px;text-align:center;">
												<xsl:call-template name="PopulateMonthDayYear">
													<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/EndDt"/>
												</xsl:call-template>
											</span>
							</div>
						</div>
					...
					<!-- Part 12 tables -->
					<!--<xsl:variable name="sep12" select="($Print = $Separated) and (count($FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotQDDTaxPerSect309CIncmGrp) &gt; 7)"/>-->
					<div class="styTableContainerLandscapeNBB" id="Page19Table2">
						<xsl:call-template name="SetInitialState"/>
						<table class="styTable" style="border-collapse:collapse;font-size:7pt;">
							<thead class="styTableThead">
								<tr style="border-top:1px solid black;">
									<th class="styTableCellHeader" scope="col" rowspan="3" style="width:8mm;border-right:none;">&nbsp;</th>
									<th class="styTableCellHeader" scope="col" rowspan="3" style="width:160mm;font-weight:normal;font-size:8pt;border-left:none;">
										<strong>Summary of QDD Tax Liability</strong>
									</th>
									<th class="styTableCellHeader" scope="col" rowspan="3" style="font-weight:normal;">
										<strong>(a)</strong> Gross amount
									</th>
									<th class="styTableCellHeader" scope="col" rowspan="3" style="font-weight:normal;">
										<strong>(b)</strong> Withholding tax rate
									</th>
									<th class="styTableCellHeader" scope="col" rowspan="3" style="font-weight:normal;font-size:6pt;border-right:none;">
										<strong>(c)</strong> Amount of tax liability (column (a) x column (b))
									</th>
								</tr>
							</thead>
							<tbody>
								<!--<xsl:for-each select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp">-->
									<tr>
										<td class="sty1065K2RowNumCellSD" style="font-weight:bold;border-bottom:1px solid black;border-right:none;padding-right:3px;">1</td>
										<td class="styTableCellTextInherit">
										...
										<td class="styTableCellAmtInherit">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/SchK2K3TotalSect871mAmountGrp/GrossAmt"/>
											</xsl:call-template>
										</td>
										<td class="styTableCellAmtInherit">
											<xsl:call-template name="PopulatePercent">
												<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/SchK2K3TotalSect871mAmountGrp/WithholdingTaxRt"/>
											</xsl:call-template>
										</td>
										<td class="styTableCellAmtInherit" style="border-right:0px;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/SchK2K3TotalSect871mAmountGrp/TaxLiabilityAmt"/>
											</xsl:call-template>
										</td>
									</tr>
									<tr>
										<td class="sty1065K2RowNumCellSD" style="font-weight:bold;border-bottom:1px solid black;border-right:none;padding-right:3px;">2</td>
										<td class="styTableCellTextInherit">
										...
										<td class="styTableCellAmtInherit">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotDivRcvdInEqtyDerivativesGrp/GrossAmt"/>
											</xsl:call-template>
										</td>
										<td class="styTableCellAmtInherit">
											<xsl:call-template name="PopulatePercent">
												<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotDivRcvdInEqtyDerivativesGrp/WithholdingTaxRt"/>
											</xsl:call-template>
										</td>
										<td class="styTableCellAmtInherit" style="border-right:0px;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotDivRcvdInEqtyDerivativesGrp/TaxLiabilityAmt"/>
											</xsl:call-template>
										</td>
									</tr>
									<tr>
										<td class="sty1065K2RowNumCellSD" style="font-weight:bold;border-bottom:1px solid black;border-right:none;padding-right:3px;">3</td>
										<td class="styTableCellTextInherit">
										...
										<td class="styTableCellAmtInherit">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotalQDDTaxPerSect309AGrp/GrossAmt"/>
											</xsl:call-template>
										</td>
										<td class="styTableCellAmtInherit">
											<xsl:call-template name="PopulatePercent">
												<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotalQDDTaxPerSect309AGrp/WithholdingTaxRt"/>
											</xsl:call-template>
										</td>
										<td class="styTableCellAmtInherit" style="border-right:0px;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotalQDDTaxPerSect309AGrp/TaxLiabilityAmt"/>
											</xsl:call-template>
										</td>
									</tr>
									<tr>
										<td class="sty1065K2RowNumCellSD" style="font-weight:bold;border-bottom:1px solid black;border-right:none;padding-right:3px;">4</td>
										<td class="styTableCellTextInherit" style="">
										...
										<td class="styTableCellAmtInherit" style="">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotalQDDTaxPerSect309BGrp/GrossAmt"/>
											</xsl:call-template>
										</td>
										<td class="styTableCellAmtInherit" style="">
											<xsl:call-template name="PopulatePercent">
												<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotalQDDTaxPerSect309BGrp/WithholdingTaxRt"/>
											</xsl:call-template>
										</td>
										<td class="styTableCellAmtInherit" style="border-right:0px;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotalQDDTaxPerSect309BGrp/TaxLiabilityAmt"/>
											</xsl:call-template>
										</td>
									</tr>
									<tr style="vertical-align:bottom;">
										<td class="sty1065K2RowNumCellSD" style="font-weight:bold;border-bottom:none;border-right:none;padding-right:3px;">5</td>
										<td class="styTableCellTextInherit" style="border-bottom:none;">
											Total QDD tax liability pursuant to section 3.09(C) of the QIA
										</td>
										<td class="styTableCellAmtInherit" style="background-color:lightgrey;border-bottom:none;"/>
										<td class="styTableCellAmtInherit" style="background-color:lightgrey;border-bottom:none;"/>
										<td class="styTableCellAmtInherit" style="background-color:lightgrey;border-bottom:none;border-right:none;"/>
									</tr>
									<!--<xsl:if test="not($sep12)">-->
									<!--<xsl:for-each select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotQDDTaxPerSect309CIncmGrp">-->
										<tr>
											<!--<td class="styTableCellCtrInherit" style="font-weight:bold;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="AlphaRowId"/>
											...
											<td class="sty1065K2RowNumCellSD" style="font-weight:bold;border-bottom:none;border-right:none;border-top:none;padding-left:15px;">a</td>												
											<td class="styTableCellTextInherit" style="border-bottom:none;">
												Income type:
												<span style="width:132mm;text-align:left;border-bottom:1px solid black;">
													<xsl:call-template name="PopulateText">
									...
									<!--</xsl:for-each>-->
										<!--<xsl:if test="$sep12 or (count($FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotQDDTaxPerSect309CIncmGrp) &lt; 7)">
											<xsl:call-template name="FillTable5ColsPart12">
												<xsl:with-param name="LineNumber" select="1 + count($FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotQDDTaxPerSect309CIncmGrp)"/>
												<xsl:with-param name="SepMessage" select="$sep12"/>
												<xsl:with-param name="MaxLine" select="7"/>
											</xsl:call-template>
										</xsl:if>-->
									<!--</xsl:if>-->
									<tr>
										<td class="sty1065K2RowNumCellSD" style="font-weight:bold;border-bottom:none;border-right:none;border-bottom:none;border-top:none;padding-right:3px;">6</td>
										<td class="styTableCellTextInherit" style="border-bottom:none;">
											Total of line 5 amounts
											<span class="sty1065K2DotLn">..............................</span>
										</td>
										<td class="styTableCellAmtInherit" style="border-bottom:none;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotalQDDTaxPerSect309CGrp/GrossAmt"/>
											</xsl:call-template>
										</td>
										<td class="styTableCellAmtInherit" style="border-bottom:none;background-color:lightgrey;"/>
										<td class="styTableCellAmtInherit" style="border-bottom:none;border-right:0px;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="$FormData/SchK2K3Sect871mTaxLiabOfQDDGrp/TotalQDDTaxPerSect309CGrp/TaxLiabilityAmt"/>
											</xsl:call-template>
										</td>
									</tr>	
								<!--</xsl:for-each>-->
	...
	<xsl:template name="FillTable5ColsPart12">
		<xsl:param name="LineNumber"/>
		<xsl:param name="SepMessage" select="false()"/>
		<xsl:param name="MaxLine" select="7"/>
		<tr style="vertical-align:bottom;">
			<td class="styTableCellCtrInherit" style="border-right-width:0px;border-bottom-width:0px;">&nbsp;</td>
			<td class="styTableCellTextInherit" style="border-bottom-width:0px;">
				Income type:
				<span style="width:132mm;text-align:left;border-bottom:1px solid black;">
