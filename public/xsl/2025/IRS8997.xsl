...
<!--Last modified by Ashleigh Smith on 04/11/2025-->
		...
		<html lang="EN-US">
			...
			<body class="styBodyClass">
				<form id="Form8997">
					...
					<!-- Header -->
					<div class="styStdDiv">
						<div class="styFNBox" style="width:30mm;height:24.5mm;">
						...
						<div class="styFTBox" style="width:127mm;height:22.5mm;">
							...
							<span style="font-weight:bold;">
								Attach to Form 1040, 1040-SR, 1040-NR, 1041, 1065, 1120,<br></br> 1120-F, 1120-REIT, 1120-RIC, 1120-S, or 990.
							</span><br/><br />
							<span style="font-weight:bold;">
								Go to
					...
					<!-- Table 1 Totals -->
					<div class="styStdDiv">
						<div class="styLNLeftNumBoxSD" style="height:7.5mm;"><br />1</div>
						<div class="styLNDesc" style="height:7.5mm;width:120.8mm;vertical-align:bottom;padding-left:0.5mm;"><br />
					...
					<div class="styStdDiv" style="font-size:8pt;font-weight:bold;padding:2px 0px;border-bottom:1px solid black;border-top:1px solid black;">
						Waiver of Treaty Benefits on Future Inclusion by a Foreign Eligible Taxpayer
					</div>
					<div class="styStdDiv" style="padding:2px 0px 2px 6px">
						<xsl:call-template name="PopulateSpan">
					...
					<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
						...
						<span style="float:right;">Form <strong>8997</strong> (2025)</span>
					</div>
					<!-- Page 2 -->
