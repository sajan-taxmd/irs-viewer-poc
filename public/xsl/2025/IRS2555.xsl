...
<!DOCTYPE stylesheet [
  <!ENTITY nbsp "&#160;">
]><!-- Last Modified by Emanesse Fleurancy on 08/20/2025 -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
      ...
      <body class="styBodyClass">
        <form name="Form2555">
          ...
          <div class="styTBB" style="width:187mm;height:19mm;">
            ...
            <div class="styFTBox" style="width:127mm;height:18mm;">
              ...
              <div class="styFBT" style="height:4mm;margin-top:1.5mm">
                 Attach to Form 1040 or 1040-SR.<br></br>
                 Go to <i>www.irs.gov/Form2555</i> for instructions and the latest information. 
              </div>
            </div>
            <div class="styTYBox" style="width:30mm;height:19mm;">
              <div class="styOMB" style="height:4mm;font-size:6.5pt;">OMB No. 1545-0074</div>
              <div class="styTY" style="height:7mm;font-size:22pt;padding-top:0mm;">20<span class="styTYColor">25</span></div>
          ...
          <div class="styBB" style="width:187mm;padding:0mm 0mm;">
            <div class="styPartName" style="font-family:sans-serif;"><b>Part I</b></div>
            <div class="styPartDesc">General Information</div>
          </div>
          <!-- END PART I TITLE -->
          <!-- Foreign Address Lines 1, 2-->
          <div class="styBB" style="width:187mm;height:auto;">
            <div class="styNameBox" style="width:139mm;height:auto;font-size:7pt;font-weight:normal;padding-left:3.5mm;">
            ...
            <div class="styEINBox" style="width:47mm;height:auto;padding-left:2mm;font-size:7pt;font-weight:normal;">
              <b style="margin-right:2mm;height:100%;float:left;">2</b> Your occupation<br/>
              <span style="width: 40mm;padding-left:4mm;text-align:left;word-break:break-all;">
                <xsl:call-template name="PopulateText">
          ...
          <div style="width:187mm;margin-top:1mm;">
            ...
            <div style="float:left;width:5mm;text-align:center;">
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="previously file form">
                <xsl:call-template name="PopulateCheckbox">
                  <xsl:with-param name="TargetNode" select="$FormData/NoFrgnEarnIncExclPrevFiledInd"/>
          ...
          <div class="styGenericDiv" style="height:4mm;width:187mm;padding-top:1mm;">
            ...
            <div style="float:left;width:22mm;margin-top:0mm;">
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="revoked exclusion Yes">
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="revoked exclusion No">
          ...
          <div class="styGenericDiv" style="width:187mm;height:8mm;padding-top:1mm;">
            ...
            <div style="float:left;width:22mm;margin-top:3mm">
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="second foreign household Yes">
                <xsl:call-template name="PopulateYesCheckbox">
                    <xsl:with-param name="TargetNode" select="$FormData/SeparateForeignResidenceInd"/>
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="second foreign household No">
                <xsl:call-template name="PopulateNoCheckbox">
                    <xsl:with-param name="TargetNode" select="$FormData/SeparateForeignResidenceInd"/>
                    <xsl:with-param name="BackupName">IRS2555SeparateForeignResidenceInd</xsl:with-param>
                </xsl:call-template>
          ...
          <div class="styBB" style="width:187mm;font-size:8pt;text-align:center;font-weight:bold;border-top:1px solid black;
            ...
            Next, complete either Part II or Part III. If an item doesn't apply, enter "N/A." If you don't give<br/>
          ...
          <div class="styBB" style="width:187mm;padding-top:2mm;padding-bottom: 6.5mm;">
            <div class="styPartName" style="font-family:sans-serif;"><b>Part II</b></div>
        ...
        <div style="height:auto">
          ...
          <div style="width:187mm;height:4mm;padding-top:1mm;">
            ...
            <div style="float:left;width:22mm;margin-top:0mm;">
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="family living with you abroad Yes">
                <xsl:call-template name="PopulateYesCheckbox">
					<xsl:with-param name="TargetNode" select="$FormData/FamilyLivedAbroadInd"/>
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="family living with you abroad No">
                <xsl:call-template name="PopulateNoCheckbox">
					<xsl:with-param name="TargetNode" select="$FormData/FamilyLivedAbroadInd"/>
					<xsl:with-param name="BackupName">IRS2555FamilyLivedAbroadInd</xsl:with-param>
				</xsl:call-template>
          ...
          <div style="width:187mm;padding-top:1mm;">
            ...
            <div style="float:left;width:22mm;margin-top:3mm">
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="claim bona fide residence Yes">
                <xsl:call-template name="PopulateYesCheckbox">
                    <xsl:with-param name="TargetNode" select="$FormData/SubmittedNonResidentStmtInd"/>
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="claim bona fide residence No">
                <xsl:call-template name="PopulateNoCheckbox">
                    <xsl:with-param name="TargetNode" select="$FormData/SubmittedNonResidentStmtInd"/>
                    <xsl:with-param name="BackupName">IRS2555SubmittedNonResidentStmtInd</xsl:with-param>
                </xsl:call-template>
          ...
          <div style="width:187mm;height:4mm;margin-top:1mm;">
            ...
            <div style="float:left;width:22mm;margin-top:0mm;">
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="pay income tax bona fide residence Yes">
                <xsl:call-template name="PopulateYesCheckbox">
                    <xsl:with-param name="TargetNode" select="$FormData/RequiredToPayIncomeTaxInd"/>
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="pay income tax bona fide residence No">
                <xsl:call-template name="PopulateNoCheckbox">
                    <xsl:with-param name="TargetNode" select="$FormData/RequiredToPayIncomeTaxInd"/>
                    <xsl:with-param name="BackupName">IRS2555RequiredToPayIncomeTaxInd</xsl:with-param>
                </xsl:call-template>
		...
		<div style="float:left;width:5mm;font-weight:bold;"/>
		<div style="float:left;width:176mm;padding-left:5mm">
			If you were present in the United States or its territories during the tax year, complete columns <b>(a)-(d)</b> below. <b>Don't</b>
			include the income from column <b>(d)</b> in Part IV, but report it on Form 1040 or 1040-SR.
		</div>
		<xsl:choose>
			<xsl:when test="count($FormData/PresenceInTheUSGroup) &lt; 1      or ((count($FormData/PresenceInTheUSGroup) &gt;7 ) and ($Print=$Separated))">
		<!-- Left/Right Tables -->
		...
		<!-- Left Table -->
		<div class="styGenericDiv" width="93mm;margin-top:1mm">
			<table style="width:93mm;font-size:7pt;border-collapse:collapse;border-left:1px solid black;
	...
	<!-- Right Table -->
		<div class="styGenericDiv" width="93mm;margin-top:1mm;">
			<table style="width:93mm;font-size:7pt;border-collapse:collapse;
			  text-align:center;margin-top:3mm">
				<xsl:for-each select="$FormData/PresenceInTheUSGroup">
					<xsl:if test="position()=1">
						<thead style="vertical-align:top;">
         ...
         <div style="height:3mm;width:187mm"/>
          ...
          <div style="width:187mm;padding-top:1mm;">
            ...
            <div style="float:left;width:22mm;margin-top:0.5mm">
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="visa limit Yes">
                <xsl:call-template name="PopulateYesCheckbox">
                    <xsl:with-param name="TargetNode" select="$FormData/VisaLimitStayOrEmploymentInd"/>
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="visa limit No">
                <xsl:call-template name="PopulateNoCheckbox">
                    <xsl:with-param name="TargetNode" select="$FormData/VisaLimitStayOrEmploymentInd"/>
                    <xsl:with-param name="BackupName">IRS2555VisaLimitStayOrEmploymentInd</xsl:with-param>
                </xsl:call-template>
          ...
          <div class="styGenericDiv" style="width:187mm;padding-top:1mm;">
            ...
            <div style="float:left;width:22mm;margin-top:.5mm">
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="maintain home in US Yes">
                <xsl:call-template name="PopulateYesCheckbox">
                    <xsl:with-param name="TargetNode" select="$FormData/MaintainedHouseInUSInd"/>
              ...
              <input type="checkbox" style="height:3.5mm;" aria-label="maintain home in US No">
                <xsl:call-template name="PopulateNoCheckbox">
                    <xsl:with-param name="TargetNode" select="$FormData/MaintainedHouseInUSInd"/>
                    <xsl:with-param name="BackupName">IRS2555MaintainedHouseInUSInd</xsl:with-param>
                </xsl:call-template>
        ...
        <!-- Page Break and Footer-->
          <div class="PageEnd" style="width:187mm;padding-top:1mm;border-top:1px solid black">
				<div style="float:left;">
					<span class="styBoldText">For Paperwork Reduction Act Notice, see the Instructions for Form 1040.</span>
					<span style="width:10mm;"/>                        
					  Cat. No. 11900P
				</div>
				<div style="float:right;">
					<span style="width:30px;"/>  
					  Form <span class="styBoldText" style="font-size:8pt;">2555</span> (2025)
				</div>
          </div>
          ...
          <!--<div class="pageEnd">-->
				<div class="styTBB" style="width:187mm;padding-top:.5mm;">
					<div style="float:left;">Form 2555 (2025)</div>
        ...
        <!--<div style="width:187mm;padding-top:0mm;border-top:1px solid black"></div>-->
          ...
          <div class="styBB" style="width:187mm;padding-top:2mm;padding-bottom: 3.5mm;">
            <div class="styPartName" style="font-family:sans-serif;"><b>Part III</b></div>
          ...
          <div class="styBB" style="width:187mm;padding:1mm 0mm;">
            <div class="styPartName" style="font-family:sans-serif;"><b>Part IV</b></div>
          ...
          <div class="styBB" style="width:187mm;">
            <b>Note:</b> Enter on lines 19 through 23 all income, including noncash income, you earned and actually or
             constructively received during your 2025 tax year for services you performed in a foreign country. If any of the
            ...
            <p style="font-weight:bold;padding-left:10mm;font-style:normal;margin-top:2mm;padding-bottom:0.8mm">
              If you are a cash basis taxpayer, report on Form 1040 or 1040-SR all income you received in 2025, no matter when you
              performed the service.
            </p>
          </div>
          <div style="width:187mm;height:8mm;font-size:9pt;text-align:center;font-weight:bold;border-bottom:1px solid black;">
            <div style="width:136mm;float:left;line-height:8mm;">2025 Foreign Earned Income</div>
          ...
          <div style="width:187mm;height:8mm;border-bottom:2px solid black;">
            ...
            <div style="float:left;width:5mm;font-weight:bold;"/>
            <div class="styLNDesc" style="width:131mm;padding-left:5mm">
              Subtract line 25 from line 24. Enter the result here and on line 27 on page 3. This is your <b>2025
          ...
          <div class="PageEnd" style="width:187mm;padding-top:1mm;border-top:1px solid black">
				...
				<!--<div style="float:right;">
					<span style="width:30px;"/>  
					  Form <span class="styBoldText" style="font-size:8pt;">2555</span> (2024)
				</div>-->
          </div>
          ...
          <!-- BEGIN PART V TITLE -->
          <div class="styBB" style="width:187mm;padding:1mm 0mm;">
            <div class="styPartName" style="font-family:sans-serif;"><b>Part V</b></div>
            <div class="styPartDesc">All Taxpayers</div>
          </div>
          <!-- END PART V TITLE -->
          <!-- Line 27 -->
          ...
          <div style="width:187mm;border-bottom:1px solid black;padding-left:10mm;">
            ...
            <div style="float:left;width:101mm;margin-top:0mm;">
				<xsl:call-template name="PopulateSpan">
					<xsl:with-param name="TargetNode" select="$FormData/ClaimingHousingExclOrDedInd"/>
				</xsl:call-template>
				<input type="checkbox" style="height:3.5mm;" aria-label="house deduction Yes">
				  <xsl:call-template name="PopulateYesCheckbox">
					<xsl:with-param name="TargetNode" select="$FormData/ClaimingHousingExclOrDedInd"/>
				...
				<span>&nbsp;Complete Part VI.</span><br/>
				<input type="checkbox" style="height:3.5mm;" aria-label="house deduction No">
				  <xsl:call-template name="PopulateNoCheckbox">
					<xsl:with-param name="TargetNode" select="$FormData/ClaimingHousingExclOrDedInd"/>
					<xsl:with-param name="BackupName">IRS2555ClaimingHousingExclOrDedInd</xsl:with-param>
				  </xsl:call-template>
				...
				<span>&nbsp;Go to Part VII.</span>
            </div>
          </div>
          <!-- BEGIN PART VI TITLE -->
          <div class="styBB" style="width:187mm;padding:1mm 0mm;">
            <div class="styPartName" style="font-family:sans-serif;"><b>Part VI</b></div>
          ...
          <div style="width:187mm;height:8mm">
            ...
            <div style="float:left;width:5mm;font-weight:bold;"/>
            <div class="styLNDesc" style="width:81mm;padding-left:5mm;">
              Number of days in your qualifying period that fall within your 2025 tax
          ...
          <div class="styBB" style="width:187mm;padding:1mm 0mm;border-top:1px solid black;">
            <div class="styPartName" style="font-family:sans-serif;"><b>Part VII</b></div>
          ...
          <div style="width:187mm;height:15mm">
            ...
            <div style="float:left;position:relative;">
              <div class="styLNDesc" style="font-size:7pt;width:81mm;height:3mm;padding-right:4mm;padding-left:5mm">
                ...
                <span style="width:12px;"/> period that fall within your 2025 tax year (see the <br/>
          ...
          <div style="width:187mm;height:12mm">
            ...
            <div style="float:left;position:relative;">
              ...
              <img alt="Bullet Round" src="{$ImagePath}/2441_Bullet_Round.gif"/> <span style="width:8px;"/>
                If line 38 and the number of days in your 2025 tax year (usually 365) are the same, enter <br/>
                <span style="width:12px;"/> "1.000." <br/>
                <img alt="Bullet Round" src="{$ImagePath}/2441_Bullet_Round.gif"/> <span style="width:8px;"/>
                Otherwise, divide line 38 by the number of days in your 2025 tax year and enter the result as <br/>
          ...
          <div style="width:187mm;height:4mm">
            ...
            <div style="float:left;width:5mm;font-weight:bold;"/>
            <div class="styLNDesc" style="width:131mm;padding-left:5mm;">
              Multiply line 37 by line 39<span style="width:1mm"/>
              <span style="letter-spacing:3mm;font-weight:bold;width:90mm;">........................</span>
            </div>
            <div style="float:left;">
              <div style="height:4.5mm;width:8mm;font-weight:bold;text-align:center;border-bottom:1px solid black;
          ...
          <div style="width:187mm;height:4.5mm">
            ...
            <div style="float:left;width:5mm;font-weight:bold;"/>
            <div class="styLNDesc" style="width:131mm;padding-left:5mm">
              Subtract line 36 from line 27<span style="width:1mm"/>
              <span style="letter-spacing:3mm;font-weight:bold;width:87mm;">.......................</span>
            </div>
            <div style="float:left;">
              <div style="height:4.5mm;width:8mm;font-weight:bold;text-align:center;border-bottom:1px solid black;
          ...
          <div style="width:187mm;height:4mm">
            ...
            <div style="float:left;width:5mm;font-weight:bold;"/>
            <div class="styLNDesc" style="width:131mm;padding-left:5mm;font-size:6.5pt">
              <b>Foreign earned income exclusion.</b> Enter the <b>smaller</b> of line 40 or line 41. Also, complete Part VIII<span style="width:2mm"/>
          ...
          <div class="styBB" style="width:187mm;padding:1mm 0mm;border-top:1px solid black;">
            <div class="styPartName" style="font-family:sans-serif;"><b>Part VIII</b></div>
          ...
          <div style="width:187mm;height:4mm">
            ...
            <div style="float:left;width:5mm;font-weight:bold;"/>
            <div class="styLNDesc" style="width:131mm;padding-left:5mm">
              Add lines 36 and 42<span style="width:3.5mm"/>
              <span style="letter-spacing:3mm;font-weight:bold;width:97mm;">.........................</span>
            </div>
            <div style="float:left;">
              <div style="height:4.5mm;width:8mm;font-weight:bold;text-align:center;border-bottom:1px solid black;
          ...
          <div style="width:187mm;height:8mm;">
            ...
            <div class="styLNDesc" style="width:131mm;padding-left:5mm">
              ...
              <span style="letter-spacing:3mm;font-weight:bold;width:28mm;">........</span>
            </div>
            <div style="float:left;">
              <div style="height:8mm;width:8mm;text-align:center;font-weight:bold;border-left:1px solid black;
            ...
            <div style="float:left;">
              <div class="styLNAmountBox" style="height:8mm;width:42mm;position:relative;padding-top:3mm">
                <xsl:call-template name="SetFormLinkInline">
          ...
          <div style="width:187mm;height:10mm;">
            ...
            <div style="float:left;width:5mm;font-weight:bold;"/>
            <div class="styLNDesc" style="width:131mm;padding-left:5mm">
              Subtract line 44 from line 43. Enter the result here and on Schedule 1 (Form 1040), line 8d.
              Complete the Foreign Earned Income Tax Worksheet in the Instructions for Form 1040 if you enter an amount on this line<span style="width:4.5mm"/>
              <span style="letter-spacing:3mm;font-weight:bold;width:74mm;">........................</span>
            </div>
            <div style="float:left;">
              <div style="height:10mm;width:8mm;text-align:center;font-weight:bold;border-left:1px solid black;padding-top:7mm">45</div>
            </div>
            <div style="float:left;">
              <div class="styLNAmountBox" style="height:10mm;width:42mm;border-bottom:none;padding-top:5mm;">
                <xsl:call-template name="LinkToLeftoverDataTableInline">
          ...
          <div class="styBB" style="width:187mm;height:8.5mm;padding:1mm 0mm;border-top:1px solid black;">
            <div class="styPartName" style="font-family:sans-serif;pad"><b>Part IX</b></div>
          ...
          <div style="width:136mm;height:10mm;float:left;padding-left:10mm;">
            <b>Note: </b>
            If line 47 is <b>more than</b> line 48 and you couldn't deduct all of your 2024 housing deduction
            because of the 2024 limit, use the Housing Deduction Carryover Worksheet in the instructions to figure 
          ...
          <div class="styBB" style="width:187mm;height:10mm;padding-top:0mm">
            ...
            <div style="float:left;width:5mm;font-weight:bold;"/>
            <div class="styLNDesc" style="width:131mm;padding-left:5mm">
              <b>Housing deduction.</b> Add lines 48 and 49. Enter the total here and on Schedule 1 (Form 1040), line 24j. Complete the Foreign Earned Income Tax Worksheet in the Instructions for Form 1040 if you enter an amount on this line
              <span style="letter-spacing:3mm;font-weight:bold;">.......................</span>
              <!--<img src="{$ImagePath}/2555_Bullet.gif" width="9" height="9" alt="Bullet" style="margin:0mm 1mm;"/>-->
            </div>
            <div style="float:left;">
              <div style="height:10mm;width:8mm;text-align:center;font-weight:bold;border-left:1px solid black;
                padding-top:6.5mm">50</div>
            </div>
            <div style="float:left;">
              <div class="styLNAmountBox" style="height:10mm;width:42mm;border-bottom:none;padding-top:6.5mm">
                <xsl:call-template name="PopulateAmount">
