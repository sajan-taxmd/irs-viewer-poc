				...
				<form name="IRS1120F ScheduleS">
					...
					<div style="width:187mm;">
						<div class="styLNDesc" style="padding-left:7mm;width:178mm;">
							<input type="checkbox" aria-label="DomesticLaw" class="styCkbox" name="Checkbox">
					...
					<div style="width:187mm;">
						<div class="styLNDesc" style="padding-left:7mm;width:178mm;">
							<input type="checkbox" aria-label="ExchangeOfNotes" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;">
						<div class="styLNDesc" style="padding-left:7mm;width:178mm;">
							<input type="checkbox" aria-label="IncomeTaxConvention" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;height:8mm;">
							...
							<input type="checkbox" aria-label="EstimateUsed" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="padding-left:7mm;width:179mm;">
							<input type="checkbox" aria-label="PubliclyTradedTest" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;">
						<!--<div class="styLNLeftNumBoxSD"/>-->
						<div class="styLNDesc" style="padding-left:7mm;width:179mm;">
							<input type="checkbox" aria-label="CFCStockOwnershipTest" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;">
						<div class="styLNDesc" style="padding-left:7mm;width:179mm;height:5mm;">
							<input type="checkbox" aria-label="CFCQualifiedShrStockOwnershipTest" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;">
						...
						<div style="width:8mm;float:right;padding-top:2.5mm;">
							<input type="checkbox" aria-label="AnyShrFrgnStkIssdInBearerForm" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<!--Dotted Line-->
						...
						<div style="width:8mm;float:right;padding-top:3mm;">
							<input type="checkbox" aria-label="NoBearerSharesReliedOn" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
					...
					<div style="width:187mm;">
						...
						<div style="width:8mm;float:right;padding-top:4mm;">
							<input type="checkbox" aria-label="BearerSharesMaintainedReliedOn" class="styCkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
								...
								<div class="styGenericDiv" style="width:27mm;;font-size:9pt;">
									<span>
										...
										<label>
								     	...
								     	<input type="checkbox" aria-label="ShareholdersVoteIndYes" class="styCkbox" name="Checkbox">
									...
									<input type="checkbox" aria-label="ShareholdersVoteIndNo" class="styCkbox" name="Checkbox">
						...
						<div class="styGenericDiv" style="width:27mm;;font-size:9pt;">
									<span>
								    	...
								    	<xsl:with-param name="TargetNode" select="$Form1120FScheduleSData/CFCDirectlyHeldUSPersonsInd"/>
								     	...
								     	<input type="checkbox" aria-label="CFCDirectlyHeldUSPersonsIndYes" class="styCkbox" name="Checkbox">
							         		<xsl:call-template name="PopulateYesCheckbox">
								      		<xsl:with-param name="TargetNode" select="$Form1120FScheduleSData/CFCDirectlyHeldUSPersonsInd"/>
								     		<xsl:with-param name="BackupName">IRS1120FSchSCFCDirectlyHeldUSPersonsIndYes</xsl:with-param>
							        		</xsl:call-template>
									...
									<input type="checkbox" aria-label="CFCDirectlyHeldUSPersonsIndNo" class="styCkbox" name="Checkbox">
											<xsl:call-template name="PopulateNoCheckbox">
												<xsl:with-param name="TargetNode" select="$Form1120FScheduleSData/CFCDirectlyHeldUSPersonsInd"/>
												<xsl:with-param name="BackupName">IRS1120FSchSCFCDirectlyHeldUSPersonsIndNo</xsl:with-param>
											</xsl:call-template>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:179mm;height:8mm;">
							...
							<!--Dotted Line-->
							<input type="checkbox" aria-label="MoreThan50PctValueOutstdShares" class="styCkbox" style="height:8mm;padding-top:8mm;" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
