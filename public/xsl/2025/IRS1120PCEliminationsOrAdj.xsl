	...
	<xsl:template match="/">
		...
		<html lang="EN-US">
			...
			Form <span class="styFormNumber" style="font-size:18pt">1120-PC</span>
					...
					<!--Return Header End -->
					<div style="width:187mm;float:left;clear:left;height:120px;">
						<div style="width:33.3mm;height:3mm;float:left;clear:left">
							<div class="styComType" style="width:33.3mm;border-bottom-width: 0px;padding-top:1mm;border-right-width: 1px;">
							...
							<div class="styComType" style="width:33.3mm;border-bottom:0px;border-right-width: 1px;">
								<div class="styBoldText" style="height:8mm;width:4mm;float:left;clear:none;padding-top:1mm;">1</div>
								<div class="styGenericDiv" style="height:8mm;width:24mm;padding-top:1mm;">
									<label>
										<xsl:call-template name="PopulateLabel">
											<xsl:with-param name="TargetNode" select="  $RtnDoc/IRS1120PC/ConsolidatedReturnInd"/>
											<xsl:with-param name="BackupName">IRS1120PC Consolidated Return</xsl:with-param>
								...
								<div class="styGenericDiv" style="height:5mm;padding-top:1mm;">
											<input type="checkbox" aria-label="Consolidated return (attach Form 851) " class="styCkbox">
							...
							<div class="styComType" style="width:33.3mm;border-bottom:0px;border-right-width: 1px;padding-left:5mm;">
									<xsl:if test="$RtnDoc/IRS1120PC/ParentReturnInd">
										<xsl:call-template name="LinkToLeftoverDataTableInline">
										<xsl:with-param name="Desc">Section A, Line A1 - Parent Return Indicator</xsl:with-param>
											<xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120PC/ParentReturnInd"/>
										</xsl:call-template>									
									</xsl:if>
									<xsl:if test="$RtnDoc/IRS1120PC/SubsidiaryReturnInd">
							<xsl:call-template name="LinkToLeftoverDataTableInline">
				<xsl:with-param name="Desc">Section A, Line A1 - Subsidiary Return Indicator</xsl:with-param>
				<xsl:with-param name="TargetNode" select="$RtnDoc/IRS1120PC/SubsidiaryReturnInd"/>
								</xsl:call-template>									
									</xsl:if>
							</div>
							<br/>
			...
			<br/>
			<!-- Header Line A 3 -->
			<div class="styComType" style="width:33.3mm;border-bottom:1px solid black;border-right-width: 1px;height:9.9mm;">
			...
			<div class="styLblNameAddr" style="width:105mm;height:auto;border-top-width: 0px; border-bottom-width: 1px; border-left-width: 0px; border-right-width: 1px;">
				<div class="styNameAddr" style="width:104.9mm;height:8.4mm;border-left-width:0px;padding-left:2mm;">Name<br/>
			  ...
			  <!-- Return Header -->
				<div class="styNameAddr" style="width:78.0mm;height:11.0mm;border-left-width:0px;padding-left:2mm;">
				...
				<div class="styNameAddr" style="width:26.7mm;border-bottom-width:1px;height:11.0mm;padding-left:2mm;border-left-width:1px;">
					Room or suite no.<br/>
					<span class="stySmallText" style="padding-left:2mm;">
				...
				<div class="styNameAddr" style="width:26mm;border-bottom-width:0px;border-left-width:0px;padding-left:2mm;height:14mm;"> City or town <br/>
                <!-- USA city -->
				...
				<div class="styNameAddr" style="width:26mm;border-bottom-width:0px;border-left-width:1px;padding-left:2mm;height:14mm;">
					State or Province
					<br/>
                <!-- USA State -->
			...
			<div class="styEINDateAssets" style="width:48mm;height:10.8mm;">
			...
			<div class="styEINDateAssets" style="width:48mm;height:14.3mm;border-bottom-width:1px;">
		...
		<!-- Header E  -->
		<div style="width:146mm; height:auto;vertical-align:top;padding-top:6px">
								<span class="styBoldText" style="float:left;clear:none;padding-right:2mm;padding-top:0.5mm;">    
								E </span>
								<span style="padding-left:0mm;vertical-align:top;padding-top:1px;">Check if: </span>
								<!-- Final Return -->
								...
								<input type="checkbox" alt="Final Return" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1120PCData/NameChangeInd"/>
								...
								<label>
									...
									<span style="vertical-align:top;padding-top:1px;">Address change
									</span>
								</label>
								<!-- Address Change End -->
								<!-- Amended Return -->
								<span class="styBoldText" style="padding-left:1.0mm;vertical-align:top;padding-right:1mm;padding-top:1px;">(4)</span>
								<input type="checkbox" alt="Amended Return" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form1120PCData/AmendedReturnInd"/>
									<xsl:with-param name="BackupName">IRS1120PCAmendedReturn</xsl:with-param>
									</xsl:call-template>
								</input>
								<label>
									<xsl:call-template name="PopulateLabel">
					...
					<xsl:with-param name="TargetNode" select="$Form1120PCData/AmendedReturnInd"/>
								...
								<!-- Amended Return End -->
								<!-- Superseded Return -->
								<span class="styBoldText" style="padding-left:17mm;vertical-align:top;padding-right:1mm;">(5)</span>
								<input type="checkbox" alt="Superseded Return" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form1120PCData/SupersededReturnInd"/>
									<xsl:with-param name="BackupName">IRS1120PCSupersededReturn</xsl:with-param>
									</xsl:call-template>
								</input>
								<label>
									<xsl:call-template name="PopulateLabel">
		  ...
		  <!--END of Tax Computation and Payments Section-->
			...
			<div style="float:right;clear:none;">
			  <div class="styLNAmountBox" style="width:32mm;height:4.5mm;text-align:right;">
				<xsl:call-template name="PopulateAmount">
				  <xsl:with-param name="TargetNode" select="$Form1120PCData/IRS1120PCScheduleA/TaxExemptInterestAmortzAmt"/>
				</xsl:call-template>
			  </div>
			  <div class="styLNAmountBox" style="width:32mm;height:4.5mm;text-align:right;">
				<xsl:call-template name="PopulateAmount">
	  ...
	  <div class="styGenericDiv">
		...
		<div class="styLNDesc" style="width:167mm;height:4.5mm;">
		  ...
		  <span style="width:40mm;background-color:none;">
			...
			<xsl:choose>
			<xsl:when test="$Form1120PCScheduleI/ParentCorporationEIN">
			  <xsl:call-template name="PopulateEIN">
				<xsl:with-param name="TargetNode" select="$Form1120PCScheduleI/ParentCorporationEIN"/>
			  </xsl:call-template>
			      </xsl:when>
					<xsl:otherwise> 
			  <xsl:if test="$Form1120PCScheduleI/MissingEINReasonCd!=' '">
				<span style="font-weight:normal;">
				  <xsl:call-template name="PopulateText">
...
<!--								<span class="styUnderlineAmount" style="float:right;width:20mm; "/>	-->			
      ...
      Form <span class="styBoldText" style="font-size:8pt;">1120-PC</span> (2025)
					...
					<table class="styLeftOverTbl">
						...
						<xsl:if test="$RtnDoc/IRS1120PC/ParentReturnInd">
							<xsl:call-template name="PopulateLeftoverRow">
								<xsl:with-param name="Desc">Section A, Line A1 - Is Parent Return</xsl:with-param>
								<xsl:with-param name="TargetNode" select="  $RtnDoc/IRS1120PC/ParentReturnInd"/>
								<xsl:with-param name="DescWidth" select="100"/>
							</xsl:call-template>
						</xsl:if>
						<xsl:if test="$RtnDoc/IRS1120PC/SubsidiaryReturnInd">
							<xsl:call-template name="PopulateLeftoverRow">
								<xsl:with-param name="Desc">Section A, Line A1 - Is Subsidiary Return</xsl:with-param>
								<xsl:with-param name="TargetNode" select="  $RtnDoc/IRS1120PC/SubsidiaryReturnInd"/>
								<xsl:with-param name="DescWidth" select="100"/>
							</xsl:call-template>
						</xsl:if>
