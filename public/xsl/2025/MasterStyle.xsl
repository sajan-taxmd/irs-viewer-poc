        ...
        <style type="text/css">
          ...
          <xsl:for-each select="/AppData/PrintDocuments/Document">
            <xsl:choose>
              ...
              <xsl:when test="@documentName='IRS1040NRScheduleP'">
              ...
              <xsl:when test="@documentName='IRS1040SS'">
              ...
              <xsl:when test="@documentName='IRS1116ScheduleB'">
                <xsl:call-template name="IRS1116ScheduleBStyle"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS1116ScheduleC'">
              ...
              <xsl:when test="@documentName='IRS1118ScheduleL'">
              ...
              <xsl:when test="@documentName='IRS1120H'">
              ...
              <xsl:when test="@documentName='IRS172'">
              ...
              <xsl:when test="@documentName='IRS4626ScheduleA'">
              ...
              <xsl:when test="@documentName='IRS8985'">
                <xsl:call-template name="IRS8985Style"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS8986'">
              ...
              <xsl:when test="@documentName='IRS940'">
              ...
              <xsl:when test="@documentName='IRS941X'">
              ...
              <xsl:when test="@documentName='IRS943'">
                <xsl:call-template name="IRS943Style"/>
              </xsl:when>
              <xsl:when test="@documentName='IRS943X'">
              ...
              <xsl:when test="@documentName='IRS945X'">
