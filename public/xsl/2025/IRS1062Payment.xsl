...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:param name="DependencyData" select="$RtnDoc/IRS1062Payment"/>
...
<!--		  </xsl:if>-->
      ...
      <body class="styBodyClass">
        ...
        <div class="styTopSectionLine">          
          <div class="styTopSectionLineLbl" style="float:left;">
            <div class="styBold">Year Installment is Due: </div>
          </div>
          <div class="styExplanationLine" style="float:left;">          
            <xsl:call-template name="PopulateText">
              <xsl:with-param name="TargetNode" select="$DependencyData/YearInstallmentDueCd"/>
            </xsl:call-template>
          </div>                  
        </div>  
      </body>
