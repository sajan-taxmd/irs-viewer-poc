...
<!--F8840 Last modified by Yee Chen - 06/17/2025-->
				...
				<form id="Form8840">
					...
					<div class="styStdDiv" style="border-bottom:2px solid black;display:inline-block;">
						...
						<div class="styTYBox" style="width:28mm;height:20mm;border-left-width:2px;">
							...
							<div class="styTaxYear" style="width:100%;">20<span style="display:inline;" class="styTYColor">25</span>
							</div>
							<div style="width:100%;">
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							During 2025, did you apply for, or take other affirmative steps to apply for, lawful permanent resident status in <br/>
					...
					<div class="styStdDiv" style="margin-top:3mm;">
						...
						<div class="sty8840DescA" style="width:179mm;">
							<span style="width:56mm;">Where was your tax home during 2025?</span>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							Enter the name of the foreign country to which you had a closer connection than to the United States during 2025. <br/>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							After changing your tax home from its location on January 1, 2025, where was your tax home for the remainder of 2025?<br/>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							...
							10 during all of the 2025 or <strong>(b)</strong> both of the countries listed on lines 9 and 10 for the period during which you <br/>
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							Have you filed or will you file tax returns for 2025 in the countries listed on lines 9 and 10? <span style="letter-spacing:3.3mm;font-weight:bold;padding-left:8px;">.........</span>
							<span style="float:right;">
								<xsl:call-template name="PopulateSpan">
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<div style="float:right;">
							...
							Form <span style="font-weight:bold;font-size:8pt;">8840</span> (2025)
						</div>
					</div>
					<!-- Page 2 -->
					<div class="styStdDiv">
					...
					<div class="styStdDiv" style="border-bottom:1px solid black;border-top:2px solid black;">
						...
						<div class="styPartDesc">Significant Contacts With Foreign Country or Countries in 2025</div>
					</div>
					<!-- Line 14 -->
					<div class="styStdDiv" style="margin-top:3mm;">
					...
					<div class="styStdDiv">
						...
						<div class="sty8840DescA" style="width:179mm;">
							If you had more than one permanent home available to you at all times during 2025, list the location of each and <br/>
