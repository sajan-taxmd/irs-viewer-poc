...
<!-- Last Modified by Emanesse Fleurancy on 06/17/2025 - 8853-->
        ...
        <form name="IRS8853">
          ...
          <div class="styBB" style="width:187mm;height:19mm;border-bottom-width:2px;">
            ...
            <div class="styTYBox" style="width:31mm;height:19mm;border-left-width:1.5px;">
              ...
              <div class="styTaxYear" style="margin-bottom:-1mm;">20<span class="styTYColor">25</span></div>
            ...
            <div class="styIRS8853LineItem" style="height:4mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:105mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8853LNDesc" style="width:auto;height:4mm;">
                  Total employer contributions to your Archer MSA(s) for 2025
                </div>
            ...
            <div class="styIRS8853LineItem" style="height:7mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8853LNDesc" style="width:auto;height:100%;">
                  Archer MSA contributions you made for 2025, including those made in 2026 by the unextended due date of your return that were for 2025. Don't include rollovers. See instructions.
                  <!--Dotted Line-->                  
          ...
          <div class=" " style="width:187mm;">
            ...
            <div class="styIRS8853LineItem" style="height:4mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8853LNDesc" style="width:auto;height:100%;">
                  Total distributions you and your spouse received in 2025 from all Archer MSAs (see instructions)
                  <!--Dotted Line-->
    			 <span class="styDotLn" style="float:none;clear:none;padding:.5mm 0mm 0mm 1.5mm;">....</span>
                </div>
              </div>
            ...
            <div class="styIRS8853LineItem" style="height:8.5mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8853LNDesc" style="width:auto;height:100%;">
                  ...
                  <input class="styCkbox" type="checkbox" aria-label="exception to the additional 20% tax" style="width:3mm;">
          ...
          <div style="width:187mm;border-top:1px solid black;" class="styBB">
            ...
            <div style="padding-left:3mm;width:170mm;font-size:8.5pt;">
              ...
              distributions in 2025 from a Medicare Advantage MSA, complete a separate Section B for each spouse. See
              instructions. 
            </div>
          </div>
          <!-- Body -->
            ...
            <div class="styIRS8853LineItem" style="height:4mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8853LNDesc" style="width:auto;height:4mm;padding-top:1mm;">
                  Total distributions you received in 2025 from all Medicare Advantage MSAs (see instructions)
               </div> 
            ...
            <div class="styIRS8853LineItem" style="height:8mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8853LNDesc" style="width:auto;height:100%;">
                  ...
                  <input class="styCkbox" type="checkbox" aria-label="Exceptions to the Additional 50% Tax" style="width:3mm;">
                    <xsl:call-template name="PopulateCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form8853Data/ArcherMSAAndMedcrAdvntgMSAGrp/MedicareMSADistriMeetTaxExcInd"/>
                      <xsl:with-param name="BackupName">Form8853DataMedicareMSADistriMeetTaxExcInd</xsl:with-param>
                    </xsl:call-template>
            ...
            <div class="styIRS8853LineItem" style="height:11mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8853LNDesc" style="width:auto;height:100%;">
                  ...
                  at the end of 2024. Also include this amount in the total on Schedule 2 (Form 1040), line 17f.
                  <!--Dotted Line-->
        			 <span class="styDotLn" style="float:none;clear:none;padding:.5mm 0mm 0mm 1mm;">.....</span>
                </div>
              </div>
          ...
          <div class="pageEnd" style="width:187mm;">
            ...
            <div style="float:right;">
              <span style="width:50px;"/>  
                Form 
              <span class="styBoldText" style="font-size:8.5pt;">8853</span> (2025)
            </div>
          </div>
          ...
          <div class="styTBB" style="width:187mm;">
            ...
            <div class="styIRS8853LineItem" style="height:4mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:181mm;height:100%;padding:0px 0px 0px 0px;">
                ...
                <div class="styIRS8853LNDesc" style="width:auto;float:none;clear:none;padding:.25mm 0mm 0mm 1mm">
                  ...
                  <input class="styCkbox" type="checkbox" aria-label="More than one Section C attached" style="width:3mm;">
                    <xsl:call-template name="PopulateCheckbox">
                      <xsl:with-param name="TargetNode" select="$Form8853Data/SectCLTCInsuranceCntrctGrp/Form8853LTCMultipleCopiesInd"/>
                      <xsl:with-param name="BackupName">Form8853DataForm8853LTCMultipleCopiesInd</xsl:with-param>
                    </xsl:call-template>
            ...
            <div class="styIRS8853LineItem" style="height:10.5mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:140mm;">
                In 2025, did anyone other than you receive payments on a per diem or other periodic basis under a<br/>
              ...
              <div class="styIRS8853LNDesc" style="width:40mm;padding-top:5.5mm;">
                ...
                <span>
                  ...
                  <input type="checkbox" class="styCkbox" aria-label="qualified LTC insurance contract Yes">
                ...
                <span>
                  ...
                  <input type="checkbox" class="styCkbox" aria-label="qualified LTC insurance contract No">
                    <xsl:if test="$Form8853Data/SectCLTCInsuranceCntrctGrp/LTCInsuranceOtherPaymentInd">
            ...
            <div class="styIRS8853LineItem" style="height:11.5mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:40mm;padding:0mm 0mm 1mm 3mm;">
                ...
                <span>
                  ...
                  <input type="checkbox" class="styCkbox" aria-label="terminally ill Yes">
                ...
                <span>
                  ...
                  <input type="checkbox" class="styCkbox" aria-label="terminally ill No">
                    <xsl:if test="$Form8853Data/SectCLTCInsuranceCntrctGrp/LTCInsuredTerminallyIllInd">
                      <xsl:call-template name="PopulateNoCheckbox">
                        <xsl:with-param name="TargetNode" select="$Form8853Data/SectCLTCInsuranceCntrctGrp/LTCInsuredTerminallyIllInd"/>
                        <xsl:with-param name="BackupName">IRS8853LTCInsuredTerminallyIllInd</xsl:with-param>
				...
				<div class="styIRS8853LNDesc" style="width:181mm;padding:0mm 0mm 1mm 3mm;float:right;clear:none;">              
					 <b>Note:</b> If &#8220;Yes&#8221; and the <b>only</b> payments you received in 2025 were accelerated death benefits that were paid to you<br/> because the insured was terminally ill, skip lines 17 through 25 and enter -0- on line 26.              
				</div>   
            </div>
            <!-- (Line 17) ////////////////////////////////////////////////////-->
            <div class="styIRS8853LineItem" style="height:10.5mm;">
            ...
            <div class="styIRS8853LineItem" style="height:13mm;">
              ...
              <div class="styIRS8853LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
                <div class="styIRS8853LNDesc" style="width:auto;height:100%;">
                  <b>Taxable payments.</b> Subtract line 25 from line 20. If zero or less, enter -0-. Also include this amount in the total on Schedule 1 (Form 1040), line 8e, or,
                   for taxpayers filing Form 1040-NR, on Schedule NEC (Form 1040-NR), line 12. For taxpayers filing Form 1040-NR, on  Schedule NEC (Form 1040-NR), line 12, enter "LTC" and the amount
                  <!--Dotted Line-->
          ...
          <div class="pageEnd" style="width:187mm;padding-top:1mm;">
            <div style="float:right;">
              ...
              Form <span class="styBoldText" style="font-size:8.5pt;"> 8853 </span> (2025)
            </div>
          </div>
          <!-- END Page Break and Footer-->
