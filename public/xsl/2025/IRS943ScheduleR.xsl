				...
				<form name="IRS943ScheduleR">
					...
					<div class="styTBB" style="width:256mm;border-bottom-width:0px;float:none;clear:both;">
						...
						<div style="width:190mm;float:left;">
							<div class="styAgency" style="line-height:150%;font-size:8pt;">(Rev. December 2025)
								...
								<span class="styAgency" style="line-height:150%;padding-left:47mm;font-size:8pt;">OMB No. 1545-0029</span>
							</div>
							<div class="styBB" style="width:185mm;height:22mm;border-top-width:1px;border-left-width:1px;border-right-width:1px;float:left;padding-left:2mm;padding-bottom:0mm;">
								...
								<div style="width:180mm;padding-bottom:1mm;padding-top:0mm;">
									...
									<span style="float:left">
										<input type="checkbox" class="styCkbox" aria-label="Section 3504 Agent Indicator">
									...
									<span style="float:left">
										<input type="checkbox" class="styCkbox" aria-label="Certified Professional Employer Organization (CPEO)">
											<xsl:call-template name="PopulateCheckbox">
									...
									<span style="float:left;clear:none;width:25mm;border-top-width:1px;padding-top:1mm;height:3mm;text-align:left;"/>
									<span style="float:left">
										<input type="checkbox" class="styCkbox" aria-label="Other Third Party">
											<xsl:call-template name="PopulateCheckbox">
						...
						<div style="float:right;padding-bottom:0mm;">
							<div style="font-size:12pt;font-family:Courier New;font-weight:bold;padding-left:1mm;writing-mode:tb-rl">430424</div>
							<div class="styBB" style="width:54mm;height:28mm;border: black solid 2px;padding-left:2mm;padding-top:2mm;">
								...
								<div class="styBB" style="padding-top:1mm;width:48mm;border-bottom-width:0px;">
									<span style="width:50mm;padding-bottom:1mm;float:none;clear:both;text-align:center;">
										(Same as Form 943):
									</span>
									<span class="styLNCtrNumBox" style="width:20mm;border-top-width:1px;height:4mm;margin-left:15mm;background-color:white;">								
									...
									<span style="width:53mm;padding-bottom:1mm;float:none;clear:both;">
										...
										<span style="float:left;">
											<input type="checkbox" class="styCkbox" aria-label="Form 943">
												<xsl:call-template name="PopulateEnumeratedCheckbox">
													<xsl:with-param name="TargetNode" select="$RtnHdrData/ReturnTypeCd"/>
													<xsl:with-param name="DisplayedCheckboxValue" select="943"/>
													<xsl:with-param name="BackupName">IRS943Ind</xsl:with-param>
												</xsl:call-template>
											</input>
											<label>
												Form 943
										...
										<span style="float:left; padding-left:3mm;">
											<input type="checkbox" class="styCkbox" aria-label="Form 943-X">
												<xsl:call-template name="PopulateEnumeratedCheckbox">
													<xsl:with-param name="TargetNode" select="$RtnHdrData/ReturnTypeCd"/>
													<!--02/29/24 AC: using concat to get around compiler error triggered by '941X'-->
													<xsl:with-param name="DisplayedCheckboxValue" select="concat('943X','')"/>
													<xsl:with-param name="BackupName">IRS943XInd</xsl:with-param>
												</xsl:call-template>
											</input>
											<label>
												Form 943-X
						...
						<table cellspacing="0" style="font-size:6pt;margin-left:0mm;">
							<thead class="styTableThead">
								<tr>
									...
									<!-- Column e -->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
										<div style="width:27mm;">(e) Form 943-X, line 7</div>
									</th>
									<!-- Column f -->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
										<div style="width:27mm;">(f) Form 943-X, line 8</div>
									</th>
									<!-- Column g-->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
						...
						<table cellspacing="0" style="font-size:6pt;margin-left:0mm;">
							<thead class="styTableThead">
								<tr>
									<!-- Column j -->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col" style="border-left-width:0px;">
										<div style="width:33mm;padding-left:4mm;">(j) Form 943, line 12</div>
									</th>
									<!-- Column k -->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
										<div style="width:30.5mm;">(k) Form 943-X, line 14</div>
									</th>
									<!-- Column l -->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
										<div style="width:30.5mm;">(l) Form 943-X, line 15b</div>
									</th>
									<!-- Column m -->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
										<div style="width:31mm;">(m) Form 943, line 13</div>
									</th>
									<!-- Column n -->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
										<!--<div style="width:31mm;">(n) Form 943-X, line 15c and 24c, column 1, total</div>-->
										<div style="width:31mm;vertical-align:none;text-align:left">(n) Form 943-X, lines 15c <span style="padding-left:1mm;">and 24c, column 1, total</span></div>
									</th>
									<!-- Column o -->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
										<div style="width:29mm;">(o) Form 943, line 14</div>
									</th>
									<!-- Column p-->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
										<div style="width:30.5mm;">(p) Form 943-X, line 23</div>
									</th>
									<!-- Column q-->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col" style="border-right-width:0px;">
										<div style="width:31mm;vertical-align:none">(q) Form 943-X, line 24b</div>
									</th>
								</tr>
							</thead>
							<tbody>
								...
								<xsl:for-each select="$NumberOfClientInfGrp">
									<tr>
										...
										<td class="IRS943ScheduleR_GenericCell" >
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="PayerAllocationInfoGrp/NrfdblCrQlfySLFMLWagesAftrAmt"/>
											</xsl:call-template>
										</td>
										<td class="IRS943ScheduleR_GenericCell" >
											<xsl:call-template name="PopulateAmount">
										...
										<td class="IRS943ScheduleR_GenericCell" style="border-right-width:0px">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="PayerAllocationInfoGrp/RfdblCrQlfySLFMLWagesAftrAmt"/>
											</xsl:call-template>
										</td>
									</tr>
								</xsl:for-each>
								...
								<tr>
									...
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/SubtlPayerAllocationInfoGrp/NrfdblCrQlfySLFMLWagesAftrAmt"/>
										</xsl:call-template>
									</td>									
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
									...
									<td class="IRS943ScheduleR_GenericCell" style="border-right-width:0px">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/SubtlPayerAllocationInfoGrp/RfdblCrQlfySLFMLWagesAftrAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/AgriculturalEmployeeInfoGrp/NrfdblCrQlfySLFMLWagesAftrAmt"/>
										</xsl:call-template>
									</td>									
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
									...
									<td class="IRS943ScheduleR_GenericCell" style="border-right-width:0px">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/AgriculturalEmployeeInfoGrp/RfdblCrQlfySLFMLWagesAftrAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="IRS943ScheduleR_GenericCell" style="border-bottom-width:0px;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalPayerAllocationInfoGrp/NrfdblCrQlfySLFMLWagesAftrAmt"/>
										</xsl:call-template>
									</td>
									<td class="IRS943ScheduleR_GenericCell" style="border-bottom-width:0px;">
										<xsl:call-template name="PopulateAmount">
									...
									<td class="IRS943ScheduleR_GenericCell" style="border-right-width:0px;border-bottom-width:0px;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalPayerAllocationInfoGrp/RfdblCrQlfySLFMLWagesAftrAmt"/>
										</xsl:call-template>
									</td>
								</tr>
						...
						<table cellspacing="0" style="font-size:6pt;margin-left:0mm;">
							<thead class="styTableThead">
								<tr>
									<!-- Column r -->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col" style="border-left-width:0px;">
										<div style="width:33mm;padding-left:4mm;">(r) Form 943-X, line 26</div>
									</th>
									<!-- Column s -->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
										<div style="width:30.5mm;">(s) Form 943-X, line 27</div>
									</th>
									<!-- Column t -->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
										<div style="width:30.5mm;">(t) Form 943-X, line 31</div>
									</th>
									<!-- Column u -->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
										<div style="width:31mm;">(u) Form 943-X, line 32</div>
									</th>
									<!-- Column v -->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
										<div style="width:31mm;">(v) Form 943-X, line 33</div>
									</th>
									<!-- Column w -->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
										<div style="width:29mm;">(w) Form 943-X, line 34</div>
									</th>
									<!-- Column x-->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col">
										<div style="width:30.5mm;">(x) Form 943-X, line 35</div>
									</th>
									<!-- Column y-->
									<th class="IRS943ScheduleR_GenericCellHeader" scope="col" style="border-right-width:0px;">
										<div style="width:31mm;">(y) Form 943-X, line 36</div>
										<!--<div style="width:31mm;vertical-align:none;text-align:left">(y) Form 943-X, lines 15c <span style="padding-left:5mm;">and 24c, column 1, total</span></div>-->
									</th>
								</tr>
							</thead>
							<tbody>
								...
								<xsl:for-each select="$NumberOfClientInfGrp">
									<tr>
										...
										<td class="IRS943ScheduleR_GenericCell" >
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="PayerAllocationInfoGrp/QlfySLWgsAftrAmt"/>
											</xsl:call-template>
										</td>										
										<td class="IRS943ScheduleR_GenericCell" >
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="PayerAllocationInfoGrp/QHPExpnssQlfySLWgsAftrAmt"/>
											</xsl:call-template>
										</td>
																		
										<td class="IRS943ScheduleR_GenericCell" >
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="PayerAllocationInfoGrp/CrtnBrgnAgrmtQlfySLWgsAftrAmt"/>
											</xsl:call-template>
										</td>
																				
										<td class="IRS943ScheduleR_GenericCell">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="PayerAllocationInfoGrp/QlfyFMLWgsAftrAmt"/>
											</xsl:call-template>
										</td>
										<td class="IRS943ScheduleR_GenericCell" >
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="PayerAllocationInfoGrp/QHPExpnssQlfyFMLWgsAftrAmt"/>
											</xsl:call-template>
										</td>
										<td class="IRS943ScheduleR_GenericCell" style="border-right-width:0px;">
											<xsl:call-template name="PopulateAmount">
												<xsl:with-param name="TargetNode" select="PayerAllocationInfoGrp/CrtnBrgnAgrmtQlfyFMLWgsAftrAmt"/>
											</xsl:call-template>
										</td>
									</tr>
								</xsl:for-each>
								...
								<tr>
									...
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/SubtlPayerAllocationInfoGrp/QlfySLWgsAftrAmt"/>
										</xsl:call-template>
									</td>					
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/SubtlPayerAllocationInfoGrp/QHPExpnssQlfySLWgsAftrAmt"/>
										</xsl:call-template>
									</td>
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/SubtlPayerAllocationInfoGrp/CrtnBrgnAgrmtQlfySLWgsAftrAmt"/>
										</xsl:call-template>
									</td>
									<td class="IRS943ScheduleR_GenericCell">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/SubtlPayerAllocationInfoGrp/QlfyFMLWgsAftrAmt"/>
										</xsl:call-template>
									</td>
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/SubtlPayerAllocationInfoGrp/QHPExpnssQlfyFMLWgsAftrAmt"/>
										</xsl:call-template>
									</td>
									<td class="IRS943ScheduleR_GenericCell" style="border-right-width:0px;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/SubtlPayerAllocationInfoGrp/CrtnBrgnAgrmtQlfyFMLWgsAftrAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/AgriculturalEmployeeInfoGrp/QlfySLWgsAftrAmt"/>
										</xsl:call-template>
									</td>						
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/AgriculturalEmployeeInfoGrp/QHPExpnssQlfySLWgsAftrAmt"/>
										</xsl:call-template>
									</td>					
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/AgriculturalEmployeeInfoGrp/CrtnBrgnAgrmtQlfySLWgsAftrAmt"/>
										</xsl:call-template>
									</td>
									<td class="IRS943ScheduleR_GenericCell">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/AgriculturalEmployeeInfoGrp/QlfyFMLWgsAftrAmt"/>
										</xsl:call-template>
									</td>
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/AgriculturalEmployeeInfoGrp/QHPExpnssQlfyFMLWgsAftrAmt"/>
										</xsl:call-template>
									</td>
									<td class="IRS943ScheduleR_GenericCell" style="border-right-width:0px;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/AgriculturalEmployeeInfoGrp/CrtnBrgnAgrmtQlfyFMLWgsAftrAmt"/>
										</xsl:call-template>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalPayerAllocationInfoGrp/QlfySLWgsAftrAmt"/>
										</xsl:call-template>
									</td>						
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalPayerAllocationInfoGrp/QHPExpnssQlfySLWgsAftrAmt"/>
										</xsl:call-template>
									</td>					
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalPayerAllocationInfoGrp/CrtnBrgnAgrmtQlfySLWgsAftrAmt"/>
										</xsl:call-template>
									</td>
									<td class="IRS943ScheduleR_GenericCell">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$FormData/TotalPayerAllocationInfoGrp/QlfyFMLWgsAftrAmt"/>
										</xsl:call-template>
									</td>
									<td class="IRS943ScheduleR_GenericCell" >
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalPayerAllocationInfoGrp/QHPExpnssQlfyFMLWgsAftrAmt"/>
										</xsl:call-template>
									</td>
									<td class="IRS943ScheduleR_GenericCell" style="border-right-width:0px;">
										<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$FormData/TotalPayerAllocationInfoGrp/CrtnBrgnAgrmtQlfyFMLWgsAftrAmt"/>
										</xsl:call-template>
									</td>
								</tr>
					...
					<div class="pageEnd" style="width:256mm;border-top-width:1px;border-bottom-width:0px;padding-top:.5mm;">
						...
						<div style="width:84mm;float:left;text-align:center;padding-top:0.2mm;">
							<i>www.irs.gov/Form943</i><span style="width:20mm;"/>Cat. No. 69329E
					  </div>
						<div style="width:74mm;text-align:right;float:left;">
							<span style="font-weight:bold;">Schedule R (Form 943) (Rev. 12-2025)</span>
						</div>
					</div>
					<!--END Page Footer-->
