						...
						<div class="styIRSW2GLeftTopFrame" style="width:187mm;height:110mm;border-right-width:0px">
								...
								<div class="styIRSW2GRowItem" style="width:74.4mm;height:40mm;float:left;">
									<div class="styIRSW2GRowItem">
										<div class="styIRSW2GRowItem" style="width:37mm;float:left;">
											...
											<div class="styIRSW2GDataMRTxtFields" style="width:37mm;text-align:right;padding-right:6px;">
											...
											<div class="styIRSW2GRowItem" style="width:37mm;float:left;">
												...
												<div class="styIRSW2GDataMRTxtFields" style="padding:0; word-wrap: break-word;">
													<!--<span style="width:7px;"/>-->
													<xsl:call-template name="PopulateText">
														<xsl:with-param name="TargetNode" select="$FormW2GData/GamblingWinWagerTypeDesc"/>
													</xsl:call-template>
												</div>
												<div class="styIRSW2GRowItem" style="width:37mm;float:left;">
													<div class="styIRSW2GDataMRTitle" style="padding-left:8px;">
													...
													<div class="styIRSW2GRowItem" style="width:37mm;float:left;">
														...
														<div class="styIRSW2GDataMRTxtFields" style="text-align:right;padding-right:3mm;">
															<div style="text-align:left;float:left;">$</div>
															<xsl:call-template name="PopulateAmount">
							...
							<div class="styIRSW2GRowItem" style="width:77.4mm;float:left;border:0px solid black;border-top-width:1px;">
								<div style="width:39.2mm;float:left;border:0px solid black;border-top-width:0px;border-right-width:1px;height:11mm">
									<span style="width:3px;"/>
									<span style="font-size:6pt;font-family:Arial;">PAYER'S TIN</span>
									<br/>
									<br/>
								...
								<span style="width:3px;"/>
								<span style="font-size:6pt;font-family:Arial;">PAYER's telephone no.</span>
								<br/>
								<br/>
							...
							<div class="styIRSW2GRowItem" style="width:37mm;float:left;">
								<div class="styIRSW2GDataMRTitle" style="padding-left:8px;">
									<b>9</b>
									<span style="width:3px;"/>
									<span style="font-size:6pt;font-family:Arial Narrow;">WINNER'S TIN</span>
								</div>
                      ...
                      <xsl:with-param name="TargetNode" select="$FormW2GData/RecipientSSN"/>
								...
								<div class="styIRSW2GRowItem" style="width:37mm;float:left;">
									<div class="styIRSW2GDataMRTitle">
										<b>11</b>
										<span style="width:3px;"/>
										<span style="font-size:6pt;font-family:Arial;">First identification no.</span>
									</div>
                        ...
                        See Additional Data Table-->
                             ...
                             ($Print = $Separated))">
											...
											<div class="styIRSW2GRowItem" style="width:37mm;float:left;">
												...
												<div class="styIRSW2GDataMRTxtFields" style="text-align:right;padding-right:6px;height:8.2mm;">
													<xsl:choose>
														<xsl:when test="count($FormW2GData/W2GStateLocalTaxGrp) &gt; 1 and ($Print != $Separated)">
															<span style="width:2mm"/>
														</xsl:when>
												...
												<div class="styIRSW2GRowItem" style="width:37mm;float:left;height:10.2mm;">
													...
													<div class="styIRSW2GDataMRTxtFields" style="text-align:right;padding-right:6px;height:11.5mm;border-bottom-width:0px;">
														<xsl:choose>
															<xsl:when test="count($FormW2GData/W2GStateLocalTaxGrp) &gt; 1 and ($Print != $Separated)">
																<span style="width:2mm"/>
															</xsl:when>
                  ...
                  <div class="styIRSW2GDataMRTxtFields" style="text-align:right;padding-right:3px;height:15.7mm;border-bottom-width:0px;">
                   <div style="text-align:left;float:left;">$</div>
							...
							<div class="styIRSW2GRowItem" style="width:37mm;float:left;">
								...
								<div class="styIRSW2GRowItem" style="width:37mm;float:left;">
									<div class="styIRSW2GDataMRTitle" style="width:37.7mm;border-right-width:1px;">
										<b>12</b>
										<span style="width:3px;"/>
										<span style="font-size:6pt;font-family:Arial;">Second identification no.</span>
									</div>
                     ...
                     any part of these payments.
                      ...
                      Form <span class="styBoldText" style="font-size:8pt;">W-2G</span> (Rev. 12-2023)
                  </div>
