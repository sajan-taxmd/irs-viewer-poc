				...
				<form id="Form8995AScheduleC">
					...
					<div class="styStdDiv">
						...
						<div class="styFTBox" style="width:127mm;height:22.5mm;">
							...
							<img src="{$ImagePath}/T_Bullet.gif" alt="T bullet Image"/> Attach to Form 8995-A.
							</span><br />
							<span style="font-weight:bold;">
								<img src="{$ImagePath}/T_Bullet.gif" alt="T bullet Image"/> Go to
					...
					<!--		<div class="styTY">20<span class="styTYColor">23</span>
							...
							<div style="margin-left:3mm;text-align:left;font-size:7pt;padding-top:10mm;">
...
(a), for all trades, businesses, or aggregations
					...
					<div class="styStdDiv" style="border-top:1px solid black;">
						...
						<span style="margin-left:10mm;">Cat. No. 71661B</span>
						<span style="float:right;font-weight:bold;">Schedule C (Form 8995-A) (Rev. 12-2022)</span>
					</div>
