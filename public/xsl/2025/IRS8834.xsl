...
<!-- 11/14/2023 - Changes made for defect 1275084 - Jeremy Nichols -->
<!-- 12/13/2023 - Made changes per EWM TESTINC0008464 - Jeremy Nichols -->
<!-- 02/13/2024 - IRWorks TESTINC0009253 - Jeremy Nichols -->
<!-- 08/21/2024 - Changes made for UWR 993273 - Jeremy Nichols -->
<!-- 10/01/2024 - Changes made pdf review 10.8 Drop 4 - Jeremy Nichols -->
<!-- 04/11/2025 - Changes made for UWR 998292 - Jeremy Nichols -->
  ...
  <xsl:template match="/">
    <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
      ...
      Name(s) shown on return<br/>
       ...
       <img src="{$ImagePath}/8844_Bullet_Round.gif" title="bullet" alt="bullet"/>    Individuals. Enter the sum of the amounts from Form 1040, 1040-SR, or 1040-NR, line 16, and Schedule 2 (Form 1040), line 1z.<br/>
        <img src="{$ImagePath}/8844_Bullet_Round.gif" title="bullet" alt="bullet"/>    Corporations. Enter the amount from Form 1120, Schedule J, line 2 (excluding the base erosion minimum tax entered on line 1f); or the
applicable line of your return.<br/>
        <img src="{$ImagePath}/8844_Bullet_Round.gif" title="bullet" alt="bullet"/>    Estates and trusts. Enter the sum of the amounts from Form 1041,
Schedule G, lines 1a 1b and 1d, plus any Form 8978 amount included on line
1e; or the amount from the applicable line of your return.                   
        </div>
      ...
      <div style="width:187mm;">
        ...
        <div class="styLNRightNumBoxNBB" style="width:8.3mm;background-color:lightgrey;height:4.5mm;border-right-width:1px;"/>
      </div>
  ...
  <div class="styLNRightNumBoxNBB" style="width:8.25mm;height:4.5mm;border-right-width:1px;padding-top:0mm;background-color:lightgrey;"/>
      ...
      <div style="width:187mm;">
        ...
        <div class="styLNDesc" style="height:10mm;">
          ...
          <span style="letter-spacing:4mm; font-weight:bold;display:inline;">  
            .................
          </span>
     ...
     <div style="width:187mm; border-style: solid; border-color: black; border-left-width: 0px; border-right-width: 0px; border-top-width: 0px; border-bottom-width: 0px">
            ...
            <div class="styGenericDiv" style="float:right;">Form <span class="styBoldText">8834</span> (Rev. 10-2024)</div>
          </div><br/><br/>
