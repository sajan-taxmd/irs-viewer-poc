				...
				<form name="Form8962">
					...
					<div class="styBB" style="width:187mm;">						
						...
						<div class="styTYBox" style="width:32mm;border-left:none;">
							...
							<div class="styTaxYear" style="line-height:30px;">20<span class="styTYColor" style="display:inline;">25</span></div>
					...
					<div class="styBB" style="width:187mm;border-bottom-width:1px;">
						...
						<div class="styLNRightNumBox" style="height:6mm;padding-top:3mm;border-bottom:0px solid black;">8a</div>
						<div class="styLNAmountBox" style="font-size:6pt;height:6mm;width:29mm;padding-top:3mm;border-right:1px solid black;border-bottom:0px solid black;">
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AnnualContributionAmt"/>
							</xsl:call-template>
						</div>
						<div class="styLNLeftNumBoxSD" style="font-size:6.5pt;padding-left:1.5mm;width:6mm;">8b</div>
						<div class="styLNDesc" style="padding-top:.5mm;width:52.5mm;font-family:Arial;">
							Monthly contribution amount. Divide line 8a by 12. Round to nearest whole dollar amount						
						</div>
						<div class="styLNRightNumBox" style="height:6mm;padding-top:3mm;border-bottom:0px solid black;">8b</div>
						<div class="styLNAmountBox" style="font-size:6pt;height:6mm;width:29mm;padding-top:3mm;border-bottom:0px solid black;">
							<xsl:call-template name="PopulateAmount">
					...
					<!-- BEGIN LINE 9 -->
					<div class="styBB" style="width:187mm;height:11mm;border-bottom-width:0px;">
						<div class="styLNLeftNumBoxSD">9</div>
						<div class="styLNDesc" style="width:179mm;height:5mm;font-size:6.5pt;padding-top:1mm;">
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styAnnMonTblTitlesC1" style="padding-top:1mm;"><b>(e)</b> Annual PTC allowed
					...
					<div class="styBB" style="width:187mm;">
						...
						<div class="styAnnMonTblTitlesC2" style="padding-top:5mm;"><b>(d)</b> Monthly maximum premium assistance
							 <span style="font-size:6pt;">(subtract (c) from (b); if zero or less, enter -0-)</span></div>
						<div class="styAnnMonTblTitlesC2" style="padding-top:5mm;"><b>(e)</b> Monthly PTC allowed
							 <span style="font-size:6pt;">(smaller of (a) or (d))</span></div>
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;">
						...
						<div class="styLNDesc" style="width:142mm;font-size:6.5pt;">
							Total PTC. Enter the amount from line 11, column (e) or add lines 12 through 23, column (e) and enter the total here
							<span style="float:right;font-weight:bold;padding-right:2mm;">
							<span style="width:11px;"/>.
							</span>
						</div>
					...
					<!-- END LINE 24 -->
					<!-- BEGIN LINE 25 -->
					<div class="styBB" style="width:187mm;height:7mm;border-bottom-width:0px;">
						<div class="styLNLeftNumBox">25</div>
						<div class="styLNDesc" style="width:142mm;">
							Advance payment of PTC. Enter the amount from line 11, column (f), or add lines 12 through 23, column (f) and enter the total here
							<span style="float:right;font-weight:bold;padding-right:3mm;">
							<span style="width:11px;"/>.
							<span style="width:11px;"/>.
							<span style="width:11px;"/>.
						...
						<div class="styLNRightNumBox" style="height:7mm;padding-top:3.5mm;">25</div>
						<div class="styLNAmountBox" style="width:29mm;height:7mm;padding-top:3.5mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styBB" style="width:187mm;">
						...
						Net PTC. If line 24 is greater than line 25, subtract line 25 from line 24. Enter the difference here and on Schedule 3 (Form 1040), line 9. 
						...
						<div class="styLNRightNumBox" style="height:7mm;padding-top:3.5mm;border-bottom:0px solid black;">26</div>
						<div class="styLNAmountBox" style="height:7mm;padding-top:3.5mm;width:29mm;border-bottom:0px solid black;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;">
						...
						<div class="styLNAmountBox" style="height:4mm;width:29mm;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;float:none;">
						...
						<div class="styLNRightNumBox" style="border-bottom:0px solid black;">29</div>
						<div class="styLNAmountBox" style="width:29mm;border-bottom:0px solid black;">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="pageEnd" style="width:187mm; font-size:7pt;border-top:1px solid black; padding-top:0.5mm;text-align:right;">
						...
						<div style="float:right;">
							...
							Form <span class="styBoldText" style="font-size:8pt;">8962</span> (2025)
						</div>						
					</div>
					<p style="page-break-before: always"/>
					<div class="styBB" style="width:187mm;">
						<span style="float:left;clear:none;">Form 8962 (2025)</span>
...
To complete line(s) 35 and/or 36 and compute the amounts for lines 12-23, see the instructions for this Part V.</div>
					...
					<table class="styLeftOverTbl">
						<xsl:call-template name="PopulateCommonLeftover">
							...
							<xsl:if test="$FormData/QSEHRAInd = 'true' or number($FormData/QSEHRAInd)">
								<tr>
