...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:param name="DependencyData" select="$RtnDoc/Section2632cElectionStatement"/>
	...
	<xsl:template match="/">
		...
		<html>
			...
			<body class="styBodyClass">
				...
				<table id="ElectionTb" class="styDepTbl">
					...
					<tbody>
						<xsl:for-each select="$DependencyData/Section2632cElectionGrp">
							<tr>
