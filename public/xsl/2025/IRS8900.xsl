					...
					<div style="width:187mm">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;">Enter 40% (0.40) of line 1</span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">..........................</div>
							</div>
						</div>
						<div style="float:right;clear:none">
							...
							<div class="styLNAmountBox">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$FormData/SpcfdPctRlrdTrackMaintExpndAmt"/>
								</xsl:call-template>
							</div>
						</div>
					</div>
                  ...
                  assigned to other eligible taxpayers for purposes of this credit. See
					...
					<div style="width:187mm">
						<div style="float:left;clear:none;">
							...
							<div class="styLNDesc" style="width:139mm;height:6mm;padding-top:2mm;">
								<span style="float:left;">Qualified railroad track maintenance credit from partnerships and S corporations (see instructions)
								</span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">..</div>
							</div>
