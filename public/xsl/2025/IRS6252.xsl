...
<!-- Updated by Doyle Roach 05/27/2025 UWR  # 1000342 -->
	...
	<xsl:template match="/">
              ...
              <br/>
                ...
                <i>www.irs.gov/Form6252 </i>
						...
						<div class="styTYBox" style="width:28mm;height:21.5mm;">
							...
							<div class="styTaxYear" style="height:9mm;font-size:22pt;">20<span class="styTYColor">25</span>
						</div>
              ...
              <br/>
                  ...
                  <!--<img src="{$ImagePath}/6252_Bullet.gif" alt="Medium Right Arrow Image"/>-->
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:148mm;padding-top:2mm;">
								Can the total selling price be determined by the close of the tax year in which such sale or other <br/>disposition occurs? 
								<!--<span style="float:left;"></span>-->
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;.5mm;">..............................</div>
							</div>
							<div class="styLNDesc" style="width:15mm;text-align:center; padding-top:4mm;">
								<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$Form6252Data/TotSellPrcTYSaleOrOthDisposInd"/>
									</xsl:call-template>
		...
		<xsl:with-param name="BackupName"> Yes Prop Sold Rltd Party Marketable Sec</xsl:with-param>		
								...
								<label>
									<xsl:call-template name="PopulateLabelYes">
										<xsl:with-param name="TargetNode" select="$Form6252Data/TotSellPrcTYSaleOrOthDisposInd"/>
										<xsl:with-param name="BackupName"> Yes Tot Sell Prc TY Sale or Other Dispos</xsl:with-param>	
									</xsl:call-template>Yes            
								</label>
							</div>
							<div class="styLNDesc" style="width:15mm;height:auto;text-align:right;padding-top:4mm;padding-bottom:1mm;float:right;clear:none;">
								<span>
									<xsl:call-template name="PopulateSpan">
										<xsl:with-param name="TargetNode" select="$Form6252Data/TotSellPrcTYSaleOrOthDisposInd"/>
									</xsl:call-template>
									<input type="Checkbox" class="styCkbox">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form6252Data/TotSellPrcTYSaleOrOthDisposInd"/>
											<xsl:with-param name="BackupName"> No Tot Sell Prc TY Sale or Other Dispos</xsl:with-param>	
										</xsl:call-template>
									</input>
								</span>
								<span style="width:8px"/>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;">
							<div style="float:left;clear:none;">
								...
								<div class="styLNDesc" style="width:139mm;">
									<span style="float:left;">
										<span class="styBoldText">Installment sale income.</span> Multiply line 22 by line 19. This amount cannot be <b>zero or less.</b>   <br/>See instructions
<div class="styDotLn" style="float:right;padding-left:2.4mm;">.............................</div>										
										</span>
									<!--Dotted Line-->
									<!--<div class="styDotLn" style="float:right;padding-right:1mm;">.............</div>-->
								</div>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:187mm;">
							...
							<div class="styLNDesc" style="width:139mm;">
								<span style="float:left;backg">Total payments received by the end of your 2025 tax year (see instructions) </span>
								<!--Dotted Line-->
								<div class="styDotLn" style="float:right;padding-right:1mm;">..........</div>
							</div>
              ...
              Form <span class="styBoldText">6252</span> (2025)
            </div>
					</div>
