...
<!-- Last Modified by Ashleigh Smith on 05/15/2025 -->
...
<xsl:with-param name="RootElement" select="local-name($FormData)"/></xsl:call-template>
</title>
<!-- No Browser Caching -->
...
<!--Header-->
					...
					<div style="width:187mm;" class="styBB">
					  ...
					  <div style="width:187mm;clear:all;">        
							...
							<div style="float:right;">
							  ...
							  <div class="styLNAmountBox" style="height:4.5mm;">
								  <xsl:choose>
									<xsl:when test="$FormData/BusinessUseHoursCnt">
									   <xsl:call-template name="PopulateAmount">
										  <xsl:with-param name="TargetNode" select="$FormData/BusinessUseHoursCnt"/>
										</xsl:call-template>
									</xsl:when>
				...
				<!-- End Line 10 -->
				   ...
				   <div class="styGenericDiv" style="width:187mm;clear:all;">
				    ...
				    <!-- Line 13 -->
				    	<div class="styGenericDiv" style="width: 187mm;clear:all;">
						 ...
						 <div class="styLNDesc" style="width:93.1mm;">
								 <span style="float:left;">Multiply line 12, column (b), by line 7</span>
								 <span  class="styDotLn" style="float:right;padding-right:1mm;">..........</span>
						  </div>
						  <span class="styLNRightNumBox" style="border-bottom-width:1px;border-top-width:0px;border-right-width:0px;border-left-width:1px;height:4.8mm;">13</span>
						  <div class="styLNAmountBox" style="font-weight:normal;width:36mm;border-left-width1px; border-top-width:0px;border-right-width:0px;height:4.8mm;">
									 <xsl:call-template name="PopulateAmount">
				    ...
				    <!-- Line 15 --> 
						...
						<div style="width:136mm;float:left;padding-top:0.5mm;padding-bottom:.5mm;">
						   <span style="float:left;">Subtract line 14 from line 8. If zero or less, enter -0-</span>
						   <span  class="styDotLn" style="float:right;padding-right:1mm;">................</span>
						</div>
						<div style="float:right;">
				   ...
				   <div style="width:187mm;clear:all;">        
				    ...
				    <div style="width:187mm;border-bottom-width:0px;">        
							...
							<span class="styDotLn" style="float:left;padding-right:1mm;">
								   <xsl:call-template name="SetFormLinkInline">
										 <xsl:with-param name="TargetNode" select="$FormData/AllowableHomeDepreciationAmt"/>
									</xsl:call-template>
							</span>
				    ...
				    <div class="styBB" style="width:187mm;border-top-width: 1px;">
						  ...
						  <div class="styPartDesc" style="padding-left:3mm;height:auto;">
						   Carryover of Unallowed Expenses to 2026
						  </div>
				    </div>
				<div style="width:187mm;" class="styBB">
				<!-- Line 43 -->
				...
				<div style="width:187mm;clear:both;">
					  ...
					  <div style="float:right;" class="styGenericDiv">Form <span class="styBoldText">8829</span> (2025)</div>
				</div>
