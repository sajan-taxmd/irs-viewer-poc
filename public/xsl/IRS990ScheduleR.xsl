		...
		<html>
			...
			<body class="styBodyClass">
					...
					<div class="styTBB" style="width:256mm;height:auto;">
						<div class="styFNBox" style="width:40mm;height:auto;">
							<div style="padding-top:1mm;">
								...
								<br/>
								<span style="font-size:8pt;">(Rev. January 2025)</span>
                ...
                <i>www.irs.gov/Form990</i></a> for instructions and the latest information. 
						...
						<div class="styTYBox" style="width:35mm;height:11.5mm;">
							<div class="styOMB" style="height:11.5mm;padding-top:4mm;">OMB No. 1545-0047</div>
							<!--<div class="styTY">20<span class="styTYColor">23</span>
							</div>-->
							<div class="styPartName" style="height:11.5mm; width:35mm;border-left-width: 1px;border-style: solid; border-color: black;">Open to Public Inspection</div>
						</div>
					</div>
				...
				<!--	<xsl:call-template name="SetInitialDynamicTableHeight">
					...
					<div style="width:256mm;float:none;clear:both;padding-top:.2mm;border-top:1px;" class="pageEnd">
						...
						<div class="styGenericDiv" style="float:right;padding-right:4mm">
							<span class="styBoldText">Schedule R (Form 990) (Rev. 1-2025)</span>
						</div>
					</div>
					<!-- *********BEGIN NEW PAGE 2********** -->
					<!-- header -->
					<div style="width:256mm;clear:both;padding-bottom:.5mm;float:none;clear:both;height:auto;" class="styBB">
						<div style="width:90mm;height:auto;" class="styGenericDiv">Schedule R (Form 990) (Rev. 1-2025)</div>
...
<!--<span style="float:right;clear:none">
      ...
      <span style="width:220mm;"/>
  				<span style="font-weight:bold;font-size:6pt;float:right;">Schedule R (Form 990) (Rev. 1-2025)</span>
					</div>
