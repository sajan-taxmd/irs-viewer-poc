...
<!-- 01/10/2024 - Changes made for IRWorks TESTINC0009229 - Jeremy Nichols -->
<!-- 02/07/2024 - defect 1253205 - Jeremy Nichols -->
<!-- 05/20/2024 - UWR 977554 - Jeremy Nichols -->
<!-- 06/21/2024 - defect 1480679 - Jeremy Nichols -->
...
-->
				<table width="186mm" border="0" cellpadding="0" cellspacing="0" style="font-family: Verdana; font-size: 7pt;" role="presentation">
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm;border-left:1px solid black;" role="presentation">
          ...
          OMB No. 1545-1668</span>
					...
					<tr>
						<td style="width: 92.75mm;border-left:1px solid black;" valign="top">
							<table border="0" cellspacing="0" cellpadding="0" style="border-right:1px;" role="presentation">
								<!-- Inner table - Header, Part I, Part II -->
								<tr role="presentation">
									<td style="width: 40mm;" role="presentation">
										<!-- Width necessary to prevent table from shrinking -->
										<!-- Set year -->
										<span class="styFormNumber" style="font-size: 12pt; float: left; clear: none;">Schedule K-1<br/>(Form 8865)
											<xsl:call-template name="SetFormLinkInline">
									...
									<td style="width: 52.75mm;font-size: 7pt;" role="presentation">		
										<div class="styTY" style="float: right; clear: none; padding-right: 2mm;">20<span class="styTYColor">25</span>
											<span style="font: normal normal 7pt Verdana; padding-left: 1mm;">
												<span style="width: 5mm;"/>
											</span>
										</div>
										<span style="width:52mm;text-align:right;padding-right:1mm;">For calendar year 2025, or tax<br/></span>
								...
								<tr role="presentation">
									<td colspan="2" style="width:92.5mm;" role="presentation">
										<br/>
							...
							<table border="0" cellspacing="0" cellpadding="0" style="border-right:1px;">
								...
								<tr>
									<td class="IRS8865ScheduleK1_tdLeft" style="height: 8mm;border-left:0;">
										...
										<span style="width: 80mm;display:inline;">Reference ID number (see instructions)</span>
								...
								<tr>
									<td class="IRS8865ScheduleK1_tdLeft" style="height: 8mm;border-left:0;">
										<!-- Line C -->
										<span style="font-weight: bold;display:inline;padding-right:0.5mm;">C </span>
								...
								<tr>
									<td class="IRS8865ScheduleK1_tdLeft" style="height: 12mm;border-left:0;">
										...
										<table cellpadding="0" cellspacing="0" style="margin-left: 5mm;" role="presentation">
											<tbody>
												<tr role="presentation">
													<td class="IRS8865ScheduleK1_lineETH" style="width: 20mm;"  role="presentation"/>
													<td class="IRS8865ScheduleK1_lineETH"  role="presentation">Beginning</td>
													<td class="IRS8865ScheduleK1_lineETH"  role="presentation">Ending</td>
												</tr>
												<tr  role="presentation">
													<td class="IRS8865ScheduleK1_lineETD" style="text-align: left; width: 20mm;"  role="presentation">Profit</td>
													<td class="IRS8865ScheduleK1_lineETD" style="border-right: 1px solid black;"  role="presentation">
														<xsl:call-template name="PopulatePercent">
															<xsl:with-param name="TargetNode" select="$FormData/PartnersInterestInProfitsBOYRt"/>
														</xsl:call-template>
													</td>
													<td class="IRS8865ScheduleK1_lineETD"  role="presentation">
														<xsl:call-template name="PopulatePercent">
												...
												<tr  role="presentation">
													<td class="IRS8865ScheduleK1_lineETD" style="text-align: left; width: 20mm;"  role="presentation">Loss</td>
													<td class="IRS8865ScheduleK1_lineETD" style="border-right: 1px solid black;"  role="presentation">
														<xsl:call-template name="PopulatePercent">
												...
												<tr  role="presentation">
													<td class="IRS8865ScheduleK1_lineETD" style="text-align: left; width: 20mm;"  role="presentation">Capital</td>
													<td class="IRS8865ScheduleK1_lineETD" style="border-right: 1px solid black;"  role="presentation">
														<xsl:call-template name="PopulatePercent">
												...
												<tr  role="presentation">
													<td class="IRS8865ScheduleK1_lineETD" style="text-align: left; width: 20mm;"  role="presentation">Deductions</td>
													<td class="IRS8865ScheduleK1_lineETD" style="border-right: 1px solid black;"  role="presentation">
														<xsl:call-template name="PopulatePercent">
										...
										<table style="font-family: Verdana; font-size: 7pt; margin-left: 4.5mm;">
											<tbody>
												<tr>
													...
													<td style="border-bottom: 0px solid black;font-size:6pt;text-align:center;width:39mm;" colspan="2">
												...
												<tr>
													...
													<td>$</td>
													<td style="border-bottom: 1px solid black;font-size:6pt;text-align:right;width:37mm;">
														<xsl:call-template name="PopulateAmount">
												...
												<tr>
													...
													<td style="padding-top:3.5mm;">$</td>
													<td style="border-bottom: 1px solid black;padding-top:4mm;font-size:6pt;text-align:right;">
														<xsl:call-template name="PopulateAmount">
															<xsl:with-param name="TargetNode" select="$FormData/OtherIncreaseDecreaseAmt"/>
														</xsl:call-template>
													</td>
								...
								<tr>
									<td valign="top">
										<table width="50mm" border="0" cellpadding="0" cellspacing="0" style="border-right: 0px solid black;" role="presentation">
											...
											<!-- Line 1 -->
											<tr role="presentation">
												<td style="width:5mm;font-weight:bold;text-align:center;border-right:1px solid black;border-top:1px solid black;" role="presentation">
													1
												</td>
												<td colspan="2" style="width:45mm;font-size:6pt;text-align:left;padding-left:0.5mm;border-top:1px solid black;" role="presentation">
													Ordinary business income (loss)
												</td>
											</tr>
											<tr role="presentation">
												<td style="height:6mm;width:5mm;border-right:1px solid black;border-bottom:1px solid black;" role="presentation">
													<span style="width:5mm;"/>
												</td>
												<td colspan="2" style="width:45mm;font-size:7pt;text-align:right;padding-right:0.5mm;padding-left:0.5mm;border-bottom:1px solid black;" role="presentation">
													<xsl:call-template name="SetFormLinkInline">
											...
											<!-- Line 2 -->
											<tr role="presentation">
												<td style="width:5mm;font-weight:bold;text-align:center;border-right:1px solid black;" role="presentation">
													2
												</td>
												<td colspan="2" style="width:45mm;font-size:6pt;text-align:left;padding-left:0.5mm;" role="presentation">
									...
									<td style="width:100mm;border-left:1px solid black;" valign="top">
										<table width="50mm" border="0" cellpadding="0" cellspacing="0" style="border-left: 0;" role="presentation">
											...
											<tr  role="presentation">
												...
												<td colspan="2" style="width:45mm;font-size:6pt;text-align:left;padding-top:0.25mm;padding-bottom:0.25mm;padding-left:0.5mm;border-top:1px solid black;"  role="presentation">
											...
											<tr>
												...
												<td colspan="2" style="width:45mm;font-size:6pt;text-align:left;padding-left:0.5mm;border-top:1px solid black;">
													Tax-exempt income and <br/>nondeductible expenses
												</td>
											</tr>
											<xsl:call-template name="Part3AddlDataLine">
					...
					<tr>
						<td width="186mm" colspan="2" style="width: 186mm; font-family: Verdana; font-size: 6pt; font-weight: bold; border-top: 1px solid black;">
							...
							<span style="width: 1mm;"/>
							<span style="width: 39mm;">Schedule K-1 (Form 8865) 2025</span>
						</td>
					</tr>
				</table>
