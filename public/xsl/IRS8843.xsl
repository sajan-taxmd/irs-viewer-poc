				...
				<form id="Form8840">
					...
					<div class="styStdDiv" style="border-bottom:2px solid black;display:inline-block;">
						...
						<div class="styFTBox" style="width:131mm;height:23mm;">
							...
							<br/>
							<!--<span>
								For the year January 1 &#8212; December 31, 2025, or other tax year<br/>beginning 
						...
						<div class="styTYBox" style="width:28mm;height:23mm;">
							...
							<div class="styTaxYear" style="width:100%;">20<span class="styTYColor" style="display:inline;">25</span>
							</div>
							<div style="width:100%;">
								<span class="stySequence" style="padding-left:1.5mm;padding-top:3mm">Attachment<br/>Sequence No.</span>
					...
					<div class="styStdDiv" style="height:6mm;  border-bottom:1px solid black; ">
						...
						For calender year 2025, or tax year beginning 
					...
					<!--<div class="styStdDiv">
						<div class="styNameBox" style="width:187mm;height:6mm">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							<span style="width:138.5mm;float:left;">
								Enter the number of days in 2025 you claim you can exclude for purposes of the substantial presence test:
							</span>
						...
						<div class="styStdDiv">
							...
							<div class="sty8843DescA" style="width:179mm;">
								...
								<span style="width:48.5mm;float:left;">
									you participated in during 2025:
								</span>
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							Were you exempt as a teacher, trainee, or student for any part of 2 of the preceeding 6 calendar years (2019 through 2024)? 
							...
							<span style="float:right;">
								...
								<input type="checkbox" class="styCkboxNM" style="" alt="TeacherTraineeStdnt2of6PrCYIndYes">
								...
								<input type="checkbox" class="styCkboxNM" style="" alt="TeacherTraineeStdnt2of6PrCYIndNo">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							...
							<span style="float:right;">
								...
								<input type="checkbox" class="styCkboxNM" style="" alt="TeacherTraineeStdntGrtr5CYIndYes">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/TeacherTraineeStdntGrtr5CYInd"/>
								...
								<input type="checkbox" class="styCkboxNM" style="" alt="TeacherTraineeStdntGrtr5CYIndNo">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/TeacherTraineeStdntGrtr5CYInd"/>
										<xsl:with-param name="BackupName">IRS8843TeacherTraineeStdntGrtr5CYInd</xsl:with-param>
									</xsl:call-template>
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							During 2025, did you apply for, or take other affirmative steps to apply for, lawful permanent resident status <br/>
							...
							<span style="float:right;">
								...
								<input type="checkbox" class="styCkboxNM" style="" alt="AppLawfulPermanentResidentIndYes">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/AppLawfulPermanentResidentInd"/>
								...
								<input type="checkbox" class="styCkboxNM" style="" alt="AppLawfulPermanentResidentIndNo">
									<xsl:call-template name="PopulateNoCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/AppLawfulPermanentResidentInd"/>
										<xsl:with-param name="BackupName">IRS8843AppLawfulPermanentResidentInd</xsl:with-param>
									</xsl:call-template>
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<div style="float:right;">
							...
							Form <span style="font-weight:bold;font-size:8pt;">8843</span> (2025)
						</div>
					</div>
					<!-- Page 2 -->
					<div class="styStdDiv">
					...
					<div class="styStdDiv">
						...
						<div class="sty8843DescA" style="width:179mm;">
							Enter the name of the charitable sports event(s) in the United States in which you competed during 2025 and the dates of <br/>
