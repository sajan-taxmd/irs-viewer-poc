	...
	<xsl:template match="/">
		...
		<html lang="EN-US">
			<head>
				...
				<style type="text/css">
					<!-- Comment out both xsl:if stmts below when testing inline/separated print -->
				...
				<form id="Form8288A">
					...
					<div class="styStdDiv" style="margin-top:2mm;border-style:solid;border-color:black;border-width:1px 0px 1px 1px;overflow:visible;">
						...
						<div style="float:left;width:87mm;border-right:1px solid black;">
							...
							<div style="width:100%;height:36.5mm;border-bottom:1px solid black;padding-left:1px;">
							...
							<div style="width:100%;height:12mm;padding-left:2px;border-right:0px solid black;border-bottom:1px solid black;">
							...
							<!-- Separate Mailing box -->
									<div style="width:100%;height:14.9mm;padding-left:2px;">
						...
						<div style="float:left;width:99.7mm;">
							...
							<div style="width:36.2mm;border-right:1px solid black;float:left;">
								...
								<div style="width:100%;height:15mm;border-bottom:1px solid black;">
									...
									<span style="width:100%;text-align:center;">
										...
										<!-- Defect 1253334 Correction Box 1, End Date via Break -->
										<br />
									</span>
								</div>
								<!-- Box 2 -->
							...
							<div style="width:100%;border:none;">
								<div style="width:72mm;float:left;border-right:1px solid black;">
									...
									<!-- Box 5 -->
									<div style="width:100%;border-bottom:1px solid black;">
									<div style="width:50.5%;height:25mm;border-right:1px solid black;border-bottom:1px solid black;word-break:break-all;">
									...
									<div style="width:48.2%;height:25mm;border-right:0px solid black;border-bottom:0px solid black;word-break:break-all;">
										...
										<!-- Defect 1253334 Correction Box 6, Part 1 of 8 -->
										<span style="width:5mm;"/>a 
										<label>
											<xsl:call-template name="PopulateLabel">
											...
											<!-- Defect 1253334 Correction Box 6, Part 2 of 8 -->
											<span style="width:0mm;"/>Individual
										</label> 
										...
										<br />
										<!-- Defect 1253334 Correction Box 6, Part 3 of 8 -->
										<span style="width:5mm;"/>b
										<label>
											<xsl:call-template name="PopulateLabel">
											...
											<!-- Defect 1253334 Correction Box 6, Part 4 of 8 -->
											<span style="width:0mm;"/>Corporation
										</label>
										...
										<!-- Defect 1253334 Correction Box 6, Part 5 of 8 -->
										<span style="width:5mm;"/>c
										<label>
											<xsl:call-template name="PopulateLabel">
											...
											<!-- Defect 1253334 Correction Box 6, Part 6 of 8 -->
											<span style="width:0mm;"/>Partnership
										</label> 
										...
										<br />
										<!-- Defect 1253334 Correction Box 6, Part 7 of 8 -->
										<span style="width:5mm;"/>d
                                        <label>
											<xsl:call-template name="PopulateLabel">
												<xsl:with-param name="TargetNode" select="$FormData/ForeignPersonSubjectToWthldGrp/OtherWithholdingTypeCd"/>
												<xsl:with-param name="BackupName">IRS8288A/PartnershipInd</xsl:with-param>
											</xsl:call-template>
											<!-- Defect 1253334 Correction Box 6, Part 8 of 8 -->
											<span style="width:0mm;"/>Other
									    </label> 
									...
									<!-- Box 8 -->
									<div style="width:100%;height:22.1mm;padding-left:2px;">
