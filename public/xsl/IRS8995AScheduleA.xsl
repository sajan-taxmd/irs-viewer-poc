	...
	<xsl:template match="/">
		...
		<html lang="EN-US">
			<head>
				...
				<meta name="Description" content="IRS Form 8995-A Schedule A"/>
				...
				<form id="Form8995AScheduleA">
					...
					<div class="sty8995ASALineDiv">
						...
						<div class="styFTBox" style="width:127mm;height:22.5mm;">
							...
							<br/>
							<span style="font-weight:bold;">
								Go to <a href="http://www.irs.gov/Form8995A"><i>www.irs.gov/Form8995A</i></a>
					...
					<div class="sty8995ASALineDiv" style="border-top:1px solid black;padding-top:0.5mm;padding-bottom:0.5mm;font-style:italic;">
						...
						income is more than $197,300 but not $247,300 ($394,600 and $494,600 if married filing jointly). If your taxable income isn’t more than $197,300
						($394,600 if married filing jointly) and you’re not a patron of an agricultural or horticultural cooperative, don’t file this form; instead, file Form 8995, 
						...
						If your taxable income is more than $247,300 ($494,600 if married filing jointly), your specified service trade or business doesn’t qualify for the deduction.
					...
					<div class="styStdDiv pageEnd" style="border-top:2px solid black;">
						...
						<span style="float:right;font-weight:bold;">Schedule A (Form 8995-A) 2025</span>
					</div>
