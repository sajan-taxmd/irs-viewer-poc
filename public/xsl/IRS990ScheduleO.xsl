	...
	<xsl:template match="/">
			...
			<body class="styBodyClass">
				...
				<div class="IRS990ScheduleO_LineContainer" style="width: 187mm; height: auto; ">
					...
					<div class="IRS990ScheduleO_FormNumBlock" style="width: 30.5mm; height: 20.5mm; padding-top: 5px; border-bottom-width: 0px; float:left;">
						...
						<br/>
						<span style="font-size:6pt;">(Rev. January 2025)</span>
                ...
                <i>www.irs.gov/Form990</i></a> for instructions and the latest information. 
					...
					<div class="IRS990ScheduleO_FormYearBlock" style="height:10.1mm; width: 29.5mm;border-left-width: 1px;">
						<div class="IRS990ScheduleO_OMB" style="height:10.1mm; width: 29.5mm;padding-top:4mm;">OMB No. 1545-0047</div>
						<!--<div class="styTY" style="height:auto; width: 29.5mm; text-align:center;">
						</div>-->
						<div style="height:10.2mm; width: 29.5mm; background-color: black; color: white; font-size: 7.5pt;font-weight: bold;text-align:center;">Open to Public<br/>Inspection</div>
					</div>
     ...
     Name of the organization<br/>
      ...
      Cat. No. 51056K
						...
						<div style="width:47mm;text-align:right;float:left;font-family:'arial narrow';font-weight:bold;">Schedule O (Form 990) (Rev. 1-2025)</div>
					</div>
				</div>
