	...
	<xsl:template match="/">
		...
		<html lang="EN-US">
                     ...
                     <div style="height:8mm;">
						...
						<div class="styFTBox" style="width:127mm;height:18.2mm; ">
							...
							Attach to Form 1040 or 1040-SR.<br/>
							 Go to <span style="font-style:italic">www.irs.gov/ScheduleB</span> for instructions and the latest information.
							</div>
						</div>
          ...
          20<span class="styTYColor">25</span>
							...
							<div style="margin-left:2mm; text-align:left;font-size:6pt;">
...
">
					 ...
					 <div  style="width:187mm;">
							...
							<div style="width:25.5mm;height:60mm;float:left;">
                ...
                and Trusts</div>
								...
								<div style="padding-top:1mm;width:25.5mm;"><b>Caution:</b> If required, failure to<br/> file FinCEN Form<br/> 114 may result in<br/> substantial penalties.<br/> 
								Additionally, you<br/>
                                may be required<br/>
								to file Form 8938,<br/>
								Statement of<br/>
								Specified Foreign<br/>
								Financial Assets.<br/>
								See instructions.
                </div>
							</div>
                ...
                You must complete this part if you <span class="styBoldText"> (a) </span> had over $1,500 of taxable interest or ordinary dividends;  <b>(b) </b>had a foreign account; or <b>(c)</b> received a distribution from, or were a grantor of, or a transferor to, a foreign trust.              
							...
							<div class="styGenericDiv" style="padding-top:0mm;width:158mm;border-bottom-width:0px;">
								...
								<div class="styLNDesc" style="width:135mm;height:10mm;">
									<span style="float:left;clear:none;">
										At any time during 2025, did you have a financial interest in or signature authority over a financial account (such as a bank account, securities account, or brokerage account) located in a foreign country?  See instructions
									   <xsl:call-template name="LinkToLeftoverDataTableInline">
							  ...
							  <span class="styBoldText">
								...
								<div class="styBB" style="float:left;clear:none;height:5mm;width:8.5mm;border-left-width:1px;border-bottom-width:1px;">
										<span>
											<xsl:call-template name="PopulateSpan">
												<xsl:with-param name="TargetNode" select="$FormData/ForeignAccountsQuestionInd"/>
											</xsl:call-template>
											<input type="checkbox" alt="ForeignAccountsQuestionIndicator Yes" class="styCkbox">
												<xsl:call-template name="PopulateYesCheckbox">
													<xsl:with-param name="TargetNode" select="$FormData/ForeignAccountsQuestionInd"/>
													<xsl:with-param name="BackupName">IRS1040ScheduleBDataForeignAccountsQuestionInd
												</xsl:with-param>
												</xsl:call-template>
											</input>
										</span>
									...
									<div class="styBB" style="float:left;clear:none;height:5mm;width:8.5mm;border-left-width:1px;border-bottom-width:1px;">
										<span>
											...
											<input type="checkbox" alt="ForeignAccountsQuestionIndicator No" class="styCkbox">
							...
							<div class="styGenericDiv" style="padding-top:0mm;width:158mm;border-bottom-width:0px;height:10mm;">
								...
								<!-- grey areas -->
								<div class="styBB" style="height:5.1mm;width:17mm;float:left;clear:none;border-bottom-width:0px;">
							...
							<div class="styBB" style="float:left;clear:none;height:5mm;width:8.5mm;border-left-width:1px;border-bottom-width:1px;">
										<span>
											...
											<input type="checkbox" alt="FinCENForm114Indicator Yes" class="styCkbox">
												<xsl:call-template name="PopulateYesCheckbox">
													<xsl:with-param name="TargetNode" select="$FormData/FinCENForm114Ind"/>
													<xsl:with-param name="BackupName">IRS1040ScheduleBDataFinCENForm114Ind
												</xsl:with-param>
												</xsl:call-template>
											</input>
										</span>
									...
									<!-- No Checkbox -->
									<!--<div class="styLNRightNumBox" style="height:5mm;float:left; padding-top:0mm;">-->
									<div class="styBB" style="float:left;clear:none;height:5mm;width:8.5mm;border-left-width:1px;border-bottom-width:.5px;">
										<span>
											<xsl:call-template name="PopulateSpan">
												<xsl:with-param name="TargetNode" select="$FormData/FinCENForm114Ind"/>
											</xsl:call-template>
											<input type="checkbox" alt="FinCENForm114Indicator No" class="styCkbox">
												<xsl:call-template name="PopulateNoCheckbox">
													<xsl:with-param name="TargetNode" select="$FormData/FinCENForm114Ind"/>
													<xsl:with-param name="BackupName">IRS1040ScheduleBDataFinCENForm114Ind
													</xsl:with-param>
							...
							<div class="styGenericDiv" style="width:158mm;border-bottom-width:0px;">
								...
								<xsl:if test="count($FormData/ForeignCountryCd) &lt;= 5 ">
									<!-- grey areas -->
									<div class="styGenericDiv" style="height:32mm;width:8.5mm;background-color:lightgrey;border-left:1px solid black;border-bottom-width:0px;"/>
									<div class="styGenericDiv" style="height:32mm;width:8.5mm;background-color:lightgrey;border-left:1px solid black;border-bottom-width:0px;"/>
								</xsl:if>
								<!-- end grey areas -->
								<xsl:if test="count($FormData/ForeignCountryCd) &gt; 5 ">
							...
							<div class="styBB" style="padding-top:0mm;width:187mm;float:left;clear:none;border-bottom-width: 0px;padding-bottom:0mm;">
								...
								<!--<div class="styBB" style="width:17mm;float:left;clear:none;border-bottom-width:0">-->
								<div class="styBB" style="float:left;clear:none;height:5mm;width:8.5mm;border-left-width:1px;border-bottom-width:0px;">
								<!--<div class="styLNRightNumBox" style="height:5mm;float:left;padding-top:0mm;">-->
										<span>
											<xsl:call-template name="PopulateSpan">
												<xsl:with-param name="TargetNode" select="$FormData/ForeignTrustQuestionInd"/>
											</xsl:call-template>
											<input type="checkbox" alt="ForeignTrustQuestionIndicator Yes" class="styCkbox">
												<xsl:call-template name="PopulateYesCheckbox">
													<xsl:with-param name="TargetNode" select="$FormData/ForeignTrustQuestionInd"/>
													<xsl:with-param name="BackupName">IRS1040ScheduleBDataForeignTrustQuestionInd
												</xsl:with-param>
												</xsl:call-template>
											</input>
										</span>
									...
									<div class="styBB" style="float:left;clear:none;height:5mm;width:8.5mm;border-left-width:1px;border-bottom-width:0px;">
										<span>
											...
											<input type="checkbox" alt="ForeignTrustQuestionIndicator No" class="styCkbox">
												<xsl:call-template name="PopulateNoCheckbox">
													<xsl:with-param name="TargetNode" select="$FormData/ForeignTrustQuestionInd"/>
													<xsl:with-param name="BackupName">IRS1040ScheduleBDataForeignTrustQuestionInd
													</xsl:with-param>
