				...
				<form name="IRS8606" style="font-family:arial;">
					...
					<div class="styBB" style="width:187mm;">
						<div class="styNameBox" style="width:137mm;height:8mm;font-weight:normal;font-size:7pt;">
							Name. If married, file a separate form for each spouse required to file 2025 Form 8606. See instructions.<br/>
							...
							<div class="styIRS8606LineItem" style="width:75%;float:left;height:27.2mm;">
								<div class="styIRS8606LineItem" style="width:100%;border-bottom-width:1px;border-color:black;height:30%;">
									...
									<div class="styIRS8606LineItem" style="width:15mm;height:100%;float:right;border-left-width:1px;border-color:black;padding-left:5px;">
										...
										<xsl:if test="$RtnHdrData/Filer/USAddress">
										<xsl:call-template name="PopulateReturnHeaderFiler">
											<xsl:with-param name="TargetNode">AptNo</xsl:with-param>
											<xsl:with-param name="BackupName">$RtnHdrDataFilerAptNo</xsl:with-param>
										</xsl:call-template>
								...
								<div class="styBB" style="width:140mm;height:11mm;">
								      <div class="styLNAmountBoxNBB"  style="width:104mm;height:11mm; border-right-width:0px;border-left-width:0px;padding-right:0mm;">
								...
								<span style="text-align:left;width:15mm">
							<xsl:if test="$RtnHdrData/Filer/USAddress">
										<xsl:call-template name="PopulateReturnHeaderFiler">
											<xsl:with-param name="TargetNode">CityNm</xsl:with-param>
											<xsl:with-param name="BackupName">$RtnHdrDataFilerCityNm</xsl:with-param>
										</xsl:call-template>
										</xsl:if>							
							</span>
							<span style="text-align:center;width:4mm">
							<xsl:if test="$RtnHdrData/Filer/USAddress">
										<xsl:call-template name="PopulateReturnHeaderFiler">
											<xsl:with-param name="TargetNode">StateAbbreviationCd</xsl:with-param>
											<xsl:with-param name="BackupName">$RtnHdrDataFilerStateAbbreviationCd</xsl:with-param>
										</xsl:call-template>
										</xsl:if>
							</span>			
							<span style="text-align:right;width:10mm">			
							<xsl:if test="$RtnHdrData/Filer/USAddress">
										<xsl:call-template name="PopulateReturnHeaderFiler">
											<xsl:with-param name="TargetNode">ZIPCd</xsl:with-param>
											<xsl:with-param name="BackupName">$RtnHdrDataFilerZIPCd</xsl:with-param>
										</xsl:call-template>
										</xsl:if>			
							 </span>		
					...
					<div style="width:187mm;height:auto;" class="styBB">
						<!-- Content -->
							<span class="styNormalText">
								<b>Note:</b> Except where stated otherwise, “traditional IRA” includes traditional SEP IRAs and traditional SIMPLE IRAs. “Roth IRA” includes
Roth SEP IRAs and Roth SIMPLE IRAs.
					...
					<div style="width:187mm;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;padding-bottom:3px;height:auto;">
							Nondeductible Contributions to Traditional IRAs and Distributions From Traditional IRAs<br/></div>							
	...
	<table class="styNormalText" style="font-size:7pt; vertical-align:top;">
		<tbody>
			<tr>
				...
				<td style="vertical-align:top;">You made nondeductible contributions to a traditional IRA for 2025. Nondeductible contributions to a traditional IRA do
not include employer contributions made to a SEP IRA pursuant to a SEP arrangement or to a SIMPLE IRA pursuant to a SIMPLE IRA plan.</td>
			</tr>
			<tr>
				<td style="vertical-align:top;"><img src="{$ImagePath}/8606_Bullet_Round.gif" alt="RoundBullet"/></td>
				<td style="vertical-align:top;">You took distributions from a traditional IRA in 2025 <b>and</b> you made nondeductible contributions to a 
			        traditional IRA in 2025 or an earlier year. For this purpose, "distributions" <b>does not</b> include rollovers (but does include certain 2025 retirement plan distribution repayments treated as rollovers (see instructions)). Also, it <b>does not</b> include qualified charitable distributions, one-time distributions to fund an HSA, conversions, recharacterizations, or returns of certain contributions. 
				</td>
			</tr>
				<tr>
				<td style="vertical-align:top;" ><img src="{$ImagePath}/8606_Bullet_Round.gif" alt="RoundBullet"/></td>
				<td style="vertical-align:top;" >You converted part, but not all, of your traditional IRAs to Roth IRAs in 2025  
	             <b>and</b> you made nondeductible contributions to a traditional IRA in 2025 or an earlier year.
				</td>
			</tr>
		</tbody>
	</table>	
					...
					<div class="styTBB" style="width:187mm;">
						...
						<div class="styIRS8606LineItem" style="height:auto;">
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;">
									Enter your nondeductible contributions to traditional IRAs for 2025, including those made for 2025 from January 1, 2026,
									<span style="float:left;">through April 15, 2026. See instructions</span>
									<!--Dotted Line-->
						...
						<div class="styIRS8606LineItem" style="height:auto;">
							...
							<div class="styIRS8606LNDesc" style="padding:0px 0px 0px 0px;width:55mm;height:16mm;border-width:2px 2px 2px 2px;border-color:black;">
								<span class="styBoldText" style="width:100%;height:100%;padding-left:4mm;padding-top:1.5mm;">
									In 2025, did you take a distribution<br/> from
									a traditional IRA,
									or make a<br/> Roth IRA conversion?
								</span>
							</div>
						...
						<div class="styIRS8606LineItem" style="height:auto;" >
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:2px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;">
									Enter those contributions included on line 1 that were made from January 1, 2026, through April 15, 2026
								</div>
						...
						<div class="styIRS8606LineItem"  style="height:8mm;">
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding-left:3mm;">
								Enter the value of <b>all</b> your traditional IRAs as of December 31, 2025, 
								plus any outstanding rollovers. Subtract certain 2025 retirement plan distribution repayments treated as rollovers, if any. See instructions
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:1mm;">............</span>
							<!--	<span class="styDotLn" style="float:right;padding-right:1mm;">...............................</span>-->
							...
							<xsl:call-template name="CreateBox">
								...
								<xsl:with-param name="AmountBoxStyle">border-width:0px 0px 1px 1px; padding-top:3mm</xsl:with-param>
								<xsl:with-param name="NumberBoxStyle">border-width:0px 0px 1px 1px; padding-top:3mm</xsl:with-param>								
							</xsl:call-template>
						</div>
						<!-- (7) ////////////////////////////////////////////////////-->
						<div class="styIRS8606LineItem" style="padding-bottom:0mm; height:14mm;">
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;font-size:7pt;">
									...
									Enter your distributions from traditional IRAs in 2025.
									<b>Do not</b> include rollovers (but do include certain 2025 retirement plan distribution repayments treated as rollovers (see instructions)). Also, <b>do not</b> include qualified charitable distributions; a one-time
				...
				<!--					<span style="float:left;">instructions)</span>-->
						...
						<div class="styIRS8606LineItem"  style="height:7mm;">
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;">
									Enter the net amount you converted from traditional IRAs to Roth IRAs  
									in 2025.  Also, enter this amount on line 16
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;">....</span>
								</div>
							</div>
						...
						<div class="styIRS8606LineItem"   style="height:auto;">
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:1mm 0 0 3mm;">
								<span style="float:left;">
									Subtract line 13 from line 3. This is <b>your total basis in traditional IRAs for 2025 and earlier years</b>
								</span>
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:1mm;">.......</span>
							</div>
							...
							<div class="styLNDesc" style="float:left;width:142mm;padding-left:2mm;height:5mm;">
							      Enter the amount on line 15a attributable to qualified disaster distributions, if any, from 2025 Form(s) 8915-F. See instructions. Also, enter this amount on 2025 Form(s) 8915-F, line 18, as applicable. See instructions
						          <span class="styDotLn" style="float:right;padding-right:1mm;">...........</span>
						     </div>
							...
							<div class="styLNDesc" style="width:142mm;padding-left:2mm;height:2.5mm;text-align:left">
							   <b>Taxable amount. </b>Subtract line 15b from line 15a. Reduce that amount by certain 2025 retirement plan distribution repayments (other than those reported on Form 8915-F) that are treated as rollovers. See instructions. If more than zero, also include this 
						         amount on 2025 Form 1040, 1040-SR, <b>or</b> 1040-NR, line 4b
						          <span class="styDotLn" style="float:right;padding-right:1mm;">...................</span>
						     </div>
							<div class="styLNRightNumBox" style="border-bottom-width:1px;font-size:7pt;height:10.5mm;padding-top:6mm;">15c</div>
							<div class="styLNAmountBox" style="width:29mm;border-bottom-width:1px;height:10.5mm;padding-top:6mm;font-size:6.5pt">
				                    <xsl:call-template name="PopulateAmount">
					...
					<div style="width:187mm;padding-top:1mm;clear:all;page-break-after:always;display:block;">
						...
						<div style="float:right;">
							<span style="width:50px;"/>  
								Form 
							<span class="styBoldText" style="font-size:8pt;">8606</span> (2025)
						</div>
					</div>
					...
					<div class="styTBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">
							Form 8606 (2025)<span style="width:148mm;"/>
						</div>
						<div style="float:right;">
					...
					<div style="width:187mm;height:auto;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;padding-bottom:3px;height:auto;">
							2025 Conversions From Traditional IRAs to Roth IRAs<br/>
							<span class="styNormalText">
						...
						<div class="styIRS8606LineItem" style="height:auto;">
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;font-size:7pt;">
									...
									converted from traditional IRAs to Roth IRAs in 2025
									<!--Dotted Line-->
									<span class="styDotLn" style="float:right;padding-right:1mm;">...............................</span>
								</div>
							</div>
						...
						<div class="styIRS8606LineItem" style="border-bottom-width:0px;height:auto;">
							...
							<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:0px 0px 0px 0px;">
								<div class="styIRS8606LNDesc" style="width:auto;height:100%;">
									...
									2025 Form 1040, 1040-SR, or 1040-NR, line 4b
					...
					<div style="width:187mm;border-top-width:0.3mm;height:auto;" class="styBB">
						...
						<div class="styPartDesc" style="padding-left:3mm;height:auto;">
							...
							<span class="styNormalText">
								Complete this part only if you took a distribution from a Roth IRA in 2025. For this purpose, a distribution <b>does not</b>
								include a rollover (but does include certain 2025 retirement plan distribution repayments treated as rollovers (see instructions)). Also, it <b>does not</b> include a qualified charitable distribution,  one-time distribution to fund an HSA, recharacterization, or return of certain contributions. See instructions.
							</span>
						</div>
					</div>
					<!-- Body -->
					<div class="styTBB" style="width:187mm;height:65mm;">
					<!-- (19) ////////////////////////////////////////////////////-->
					<div class="styIRS8606LineItem" style="height:auto;">
						<div class="styIRS8606LNLeftNumBox" style="padding-left:2.2mm;">19</div>
						<div class="styIRS8606LNDesc" style="width:144mm;height:100%;padding:1mm 0 0 3mm;">
								Enter your total nonqualified distributions from Roth IRAs in 2025, including any
								qualified first-time homebuyer distributions, and any 2025 retirement plan distributions whose repayments are treated as rollovers. See instructions
								<!--Dotted Line-->
								<span class="styDotLn" style="float:right;padding-right:1mm;">........</span>
								<!--Dotted Line-->
							<!--	<span class="styDotLn" style="float:right;padding-right:1mm;">.....</span>-->
					...
					<!--(25a- 25c)  ////////////////////////////////////////////////////-->
					     <div style="width:187mm">
							...
							Enter the amount on line 25a attributable to qualified disaster distributions, if any, from 2025 Form(s) 8915-F. See instructions.
							Also, enter this amount on 2025 Form(s) 8915-F, line 19, as applicable. See instructions
						          <span class="styDotLn" style="float:right;padding-right:1mm;">...........</span>
						     </div>
							...
							<div class="styLNDesc" style="width:142mm;padding-left:2mm;height:6mm;float:left;padding-top:.3mm">
						<b>Taxable amount.</b> Subtract line 25b from line 25a. Reduce that amount by certain 2025 retirement plan distribution repayments (other than those reported on Form 8915-F) that are treated as rollovers. See instructions. If more than zero, also include this 
                                  amount on 2025 Form 1040, 1040-SR, <b>or</b> 1040-NR, line 4b.
						          <span class="styDotLn" style="float:right;padding-right:1mm;">...................</span>
						     </div>
							<div class="styLNRightNumBox" style="border-bottom-width:0px;font-size:7pt;height:12mm;padding-top:6mm;">25c</div>
							<div class="styLNAmountBox" style="width:29mm;border-bottom-width:0px;height:12mm;padding-top:6mm;font-size:6.5pt">
				                <xsl:call-template name="PopulateAmount">
					...
					<div style="border-bottom: 2px solid black;width:187mm;font-size:6pt;">
						<div class="styGenericDiv" style="width:20mm;padding-top:4mm;float:left;clear:none;height:31.5mm;border-right:1px solid black">
							...
							<div  style="width:164mm;float:left;clear:none;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;">
								<div class="styLNDesc" style="height:8mm;width:108mm;border-right:1 solid black;">
								...
								<div class="styIRS8606leftBox" style="height:8mm;width:32mm;padding-left:1mm;border-left-width:1px;">Firm's EIN
						...
						<!--				</div>
								...
								<div class="styIRS8606leftBox" style="width:52mm;padding-left:1mm;border-left-width:1px;height:15mm;"> Phone no. <br/>
								          <!--<xsl:choose>
		                                           <xsl:when test="($RtnHdrData/ReturnTypeCd='1040') or ($RtnHdrData/ReturnTypeCd='1040NR') ">
