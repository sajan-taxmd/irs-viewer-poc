				...
				<table width="186mm" border="0" cellpadding="0" cellspacing="0" style="font-family: Verdana;        font-size: 7pt;">
							...
							<table border="0" cellspacing="0" cellpadding="0" style="border-right: 1px solid black;">
								...
								<tr>
									<td style="font-size: 7pt;">
										...
										<span style="float: right; clear: none; padding-right: 1mm;">For calendar year 2025, or tax year</span>
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 8.5mm;padding-bottom:0mm">
										...
										<span style="width: 7mm;"/>See instructions.)<br/>
										<span style="width: 5mm;"/>
									...
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 10mm;border-top-width:0;">
										...
										<div style="float:left;clear:none;">
											...
											<label>
												...
												<span style="width: 80mm;">If the partner is a disregarded entity (DE), enter the partner's:</span>
											</label>
											<br/>
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 23mm;border-top-width:0;">
										...
										<span style="padding-top:1mm;font-size:6.5pt;padding-left:5mm;">Check if decrease is due to:<br/>
										<span style="width:1px;"/>
                          ...
                          <span style="width:8px;"/>.
								...
								<tr>
									<td class="IRS1065ScheduleK1_tdLeft" style="height: 13mm;border-bottom-width: 1px solid black;">
										...
										<span style="width: 3.5mm;"/>Did the partner contribute property with a built-in gain (loss)?
														  ...
														  border-top:1px solid black;width:41.40mm;font-size:7pt;">
															...
															<xsl:for-each select="$FormData/IRS1065K1CreditsAndCrRcptrGrp/SchK1CreditsAndCrRcptrGrp">
															   ...
															   width:41.40mm;font-size:7pt;" valign="bottom">
																		...
																		<xsl:otherwise>
																			<tr>
																				<td class="IRS1065ScheduleK1_codeBox" style="height:7.81mm;border-top:1px solid black;font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateText">
																						<xsl:with-param name="TargetNode" select="SchK1CreditsAndCrRcptrCd"/>
																					</xsl:call-template>
																				</td>
																				<td class="IRS1065ScheduleK1_amountBox" style="height:7.81mm;border-top:1px solid black;width:41.40mm;font-size:7pt;" valign="bottom">
																					<xsl:call-template name="PopulateAmount">
																						<xsl:with-param name="TargetNode" select="Amt"/>
																					</xsl:call-template>
																					<br/>
												...
												<td colspan="3" class="IRS1065ScheduleK1_tdRight" style="border-bottom:0px solid lightgrey;">
													<table cellpadding="0" cellspacing="0" style="width:46.5mm;">
														<tbody>
															...
															<!-- Display a blank line if there are no data elements -->
															<xsl:if test="count($FormData/IRS1065K1OtherInformationGrp/PartnersOtherInformationGrp) = 0 ">
																<tr>
																...
																<!-- Add 3 blank rows -->
																<tr>
																	<td class="IRS1065ScheduleK1_codeBox" style="height:7.6mm;border-top:1px solid black;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																	<td class="IRS1065ScheduleK1_amountBox" style="height:7.6mm;border-top:1px solid black;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																	</td>
																</tr>
																<tr>
															...
															<xsl:if test="($Print != $Separated) or (count($FormData/IRS1065K1OtherInformationGrp/PartnersOtherInformationGrp) &lt;=4)">
																<xsl:for-each select="$FormData/IRS1065K1OtherInformationGrp/PartnersOtherInformationGrp">
																	<tr>
																		<td class="IRS1065ScheduleK1_codeBox" style="height:7.6mm;border-top:1px solid black;font-size:7pt;" valign="bottom">																				
																			<xsl:if test="$FormData/IRS1065K1OtherInformationGrp/PartnersOtherInformationGrp/SchK1OtherInformationGrp">																				
																				<xsl:call-template name="PopulateText">
																					<xsl:with-param name="TargetNode" select="SchK1OtherInformationGrp/SchK1OtherInformationCd"/>
																				</xsl:call-template>
																			</xsl:if>
																			<xsl:if test="$FormData/IRS1065K1OtherInformationGrp/PartnersOtherInformationGrp/SchK1OtherInformationSTMTCd">
																				<xsl:call-template name="PopulateText">
																					<xsl:with-param name="TargetNode" select="SchK1OtherInformationSTMTCd"/>
																				</xsl:call-template>
																			</xsl:if>
																			<xsl:if test="$FormData/IRS1065K1OtherInformationGrp/PartnersOtherInformationGrp/SchK1OtherInformationVGrp">
																				<xsl:call-template name="PopulateText">
																					<xsl:with-param name="TargetNode" select="SchK1OtherInformationVGrp/SchK1OtherInformationVCd"/>
																				</xsl:call-template>
																			</xsl:if>																			
																		</td>
																		<td class="IRS1065ScheduleK1_amountBox" style="height:7.6mm;border-top:1px solid black;width:41.40mm;font-size:7pt;" valign="bottom">
																			<xsl:if test="$FormData/IRS1065K1OtherInformationGrp/PartnersOtherInformationGrp/SchK1OtherInformationGrp">
																				<xsl:call-template name="PopulateAmount">
																					<xsl:with-param name="TargetNode" select="SchK1OtherInformationGrp/Amt"/>
																				</xsl:call-template>
																			</xsl:if>
																			<xsl:if test="$FormData/IRS1065K1OtherInformationGrp/PartnersOtherInformationGrp/SchK1OtherInformationVGrp">
																				<xsl:call-template name="PopulateText">
																					<xsl:with-param name="TargetNode" select="SchK1OtherInformationVGrp/Amt"/>
																				</xsl:call-template>
																			</xsl:if>
															...
															<xsl:if test="count($FormData/IRS1065K1OtherInformationGrp/PartnersOtherInformationGrp) = 1">
																<tr>
														  ...
														  border-top:1px solid black;width:41.40mm;font-size:7pt;">
															...
															<xsl:if test="count($FormData/IRS1065K1OtherInformationGrp/PartnersOtherInformationGrp) = 2">
																<tr>
																	<td class="IRS1065ScheduleK1_codeBox" style="height:7.6mm;
														  border-top:1px solid black;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
														  ...
														  border-top:1px solid black;width:41.40mm;font-size:7pt;">
															...
															<xsl:if test="count($FormData/IRS1065K1OtherInformationGrp/PartnersOtherInformationGrp) = 3">
																<tr>
																	<td class="IRS1065ScheduleK1_codeBox" style="height:7.6mm;
														  border-top:1px solid black;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
														  ...
														  border-top:1px solid black;width:41.40mm;font-size:7pt;">
															...
															<xsl:if test="(($Print = $Separated) and (count($FormData/IRS1065K1OtherInformationGrp/PartnersOtherInformationGrp) &gt;4))">
																<tr>
														  ...
														  border-top:0px solid black;width:41.40mm;font-size:7pt;">
																		<span style="vertical-align:baseline;height:100%;"/>
																		<xsl:call-template name="PopulateAdditionalDataTableMessage">
																			<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1OtherInformationGrp/PartnersOtherInformationGrp"/>
																		</xsl:call-template>
																	</td>
																	<tr>
																		<td class="IRS1065ScheduleK1_codeBox" style="height:7.6mm;
					...
					<tr>
					    ...
					    font-size: 6pt;font-weight: bold; border-top: 1px solid black;">
							<span style="width: 90mm;">For Paperwork Reduction Act Notice, see the
						   Instructions for Form 1065.
						</span>
							<span style="font-weight: normal;width: 33mm;">www.irs.gov/Form1065</span>
							<span style="font-weight: normal; width: 24mm;">Cat. No. 11394R</span>
							<span style="width: 40mm;">Schedule K-1 (Form 1065) 2025</span>
						</td>
					</tr>
				</table>
							...
							<table class="styDepTbl" style="width:50mm;font-size:7pt;">
								<thead class="styTableThead">
									...
									<tr class="styDepTblHdr">
										...
										<th class="styDepTblCell" scope="col" valign="middle">Other information
											<span style="float:right;padding-left:2px;">
												<xsl:call-template name="SetFormLinkInline">
													<xsl:with-param name="TargetNode" select="$FormData/IRS1065K1OtherInformationGrp"/>
												</xsl:call-template>
