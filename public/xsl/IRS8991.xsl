				...
				<form id="Form8991">
					...
					<div class="styStdDiv">
						<div class="styFNBox" style="width:31mm;height:19mm;border-right-width:2px;">
							...
							<div class="" style="padding-top:.5mm;font-size:7pt;">(Rev. December 2024)</div>
							...
							<span>
								...
								<label>
									<xsl:call-template name="PopulateLabelNo">
										<xsl:with-param name="TargetNode" select="$FormData/BaseErosionThresholdPctInd"/>
										<xsl:with-param name="BackupName">F8991BaseErosionThresholdPctInd</xsl:with-param>
									</xsl:call-template>No. STOP after completing Part I, Part V, and Schedule A (and, if necessary, Schedule B) and attach this form to your tax return.
								</label>
							</span>
						</div>
					...
					<div class="styStdDiv pageEnd" style="border-top:1px solid black;">
						...
						<span style="float:right;">Form <strong>8991</strong> (Rev. 12-2024)</span>
					</div>
					<!-- Page 2 -->
					...
					<div class="styStdDiv" style="border-top:1px solid black;border-bottom:1px solid black;">
						...
						<div class="styPartDesc">Additional Questions (see instructions)</div>
					</div>
					<div class="styStdDiv">
						<div class="styLNLeftNumBoxSD">6</div>
						<!--<div class="styLNLeftNumBoxSD" style="width:7mm;">&nbsp;</div>-->
						<div class="styLNDesc" style="width:176mm;height:8mm;">
							...
							<span style="display:inline;font-weight:bold;float:right;">
								<xsl:call-template name="PopulateSpan">
					...
					<div class="styStdDiv">
						...
						<div class="styLNDesc" style="width:176mm;height:8mm;">
							...
							<span style="display:inline;font-weight:bold;float:right;">
								<xsl:call-template name="PopulateSpan">
									<xsl:with-param name="TargetNode" select="$FormData/CapitalizeOrExpenseCostsInd"/>
								</xsl:call-template>
								<input type="checkbox" class="styCkboxNM" style="margin-left:6px;margin-right:4px;" alt="Use Financial Statement Election Yes">
									<xsl:call-template name="PopulateYesCheckbox">
										<xsl:with-param name="TargetNode" select="$FormData/CapitalizeOrExpenseCostsInd"/>
										<xsl:with-param name="BackupName">F8991CapitalizeOrExpenseCostsInd</xsl:with-param>
									</xsl:call-template>
								</input>
								<label>
									<xsl:call-template name="PopulateLabelYes">
...
<xsl:variable name="shouldSepV" select="($Print = $Separated) and (count($FormData/CapOrExpnsCostsInventoryGrp) &gt; 3)"/>
					<div class="styStdDiv" style="">
						<xsl:call-template name="SetInitialState"/>
						<table style="display:table;width:187mm;border-collapse:collapse;">
							<thead class="styTableThead">
								<tr>
									<th class="styTableCellHeader" scope="col" style="width:7mm;font-weight:normal;border-right-width:1px;border-bottom-width:0px;"> </th>
									<th class="styTableCellHeader" scope="col" style="width:45mm;font-weight:normal;vertical-align:top;border-top:1px solid black;">
									...
									<th class="styTableCellHeader" scope="col" style="width:45mm;font-weight:normal;vertical-align:top;border-top:1px solid black;border-right-width:0px;">
										<span style="font-weight:bold;">(iv)</span>
									</th>
								</tr>
							</thead>
							<tbody>
									<th class="styTableCellHeader" scope="col" style="width:7mm;font-weight:bold;border-bottom-width: 0px;"><span></span></th>
									<th class="styTableCellHeader" scope="col" style="width:45mm;font-weight:bold;text-align:center;"><span>Amount Capitalized or Included in COGS</span></th>						
									<th class="styTableCellHeader" scope="col" style="width:45mm;font-weight:bold;text-align:center;"><span>Description of item</span></th>
									<th class="styTableCellHeader" scope="col" style="width:45mm;font-weight:bold;text-align:center;"><span>Line Item Reported on in Prior Year</span></th>	
									<th class="styTableCellHeader" scope="col" style="width:45mm;font-weight:bold;text-align:center;border-right-width: 0px;"><span>Tax Year Form 3115 Was Filed</span></th>	
								<xsl:if test="not($shouldSepV)">
									<xsl:for-each select="$FormData/CapOrExpnsCostsInventoryGrp">
										<tr style="vertical-align:top;">
											<td class="styTableCellCtrInherit" style="font-weight:bold;width:7mm;border-right-width:1px;border-bottom-width:0px;">
												<xsl:choose>
											...
											<td class="styTableCellAmtInherit" style="width:45mm;font-weight:normal;vertical-align:top;border-top:1px solid black;">
												<xsl:call-template name="PopulateAmount">
													<xsl:with-param name="TargetNode" select="CapitalizedOrExpensedAmt"/>
												</xsl:call-template>
											</td>
											<td class="styTableCellCtrInherit" style="width:45mm;font-weight:normal;vertical-align:top;border-top:1px solid black;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="ItemShortDesc"/>
												</xsl:call-template>
											</td>
											<td class="styTableCellTextInherit" style="width:45mm;font-weight:normal;vertical-align:top;border-top:1px solid black;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="WhereReportedFormAndLineTxt"/>
												</xsl:call-template>
											</td>
											<td class="styTableCellTextInherit" style="width:45mm;font-weight:normal;vertical-align:top;border-top:1px solid black;border-right-width:0px;">
												<xsl:call-template name="PopulateText">
													<xsl:with-param name="TargetNode" select="Form3115FiledTaxYr"/>
												</xsl:call-template>
											</td>
										</tr>
									</xsl:for-each>
							...
							<xsl:if test="count($FormData/CapOrExpnsCostsInventoryGrp) &lt; 1 or ((count($FormData/CapOrExpnsCostsInventoryGrp) &gt; 3) and ($Print = $Separated))">
								<xsl:call-template name="FillPVCols">
									<xsl:with-param name="index">A</xsl:with-param>
									<xsl:with-param name="SepMessage" select="$shouldSepV"/>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="count($FormData/CapOrExpnsCostsInventoryGrp) &lt; 2 or ((count($FormData/CapOrExpnsCostsInventoryGrp) &gt; 3) and ($Print = $Separated))">
								<xsl:call-template name="FillPVCols">
									<xsl:with-param name="index">B</xsl:with-param>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="count($FormData/CapOrExpnsCostsInventoryGrp) &lt; 3 or ((count($FormData/CapOrExpnsCostsInventoryGrp) &gt; 3) and ($Print = $Separated))">
								<xsl:call-template name="FillPVCols">
					...
					<div class="styStdDivLS">
						...
						<div class="styLNDesc" style="height:7mm;width:81mm;">
							Payments related to cost sharing transactions covered by Regulation section 1.482-7(j)(3)(i)
							<span class="sty8991DotLn">.........</span>
						</div>
						<div class="sty8991ScheduleBoxAmt" style="height:7mm;">
							<br/>
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AggregateBaseErosionPymtGrp/CostShrTransPymtAmt"/>
							</xsl:call-template>
						</div>
						<div class="sty8991ScheduleBoxAmt" style="height:7mm;">
							<br/>
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/AggregateBaseErosionTaxBnftGrp/CostShrTransPymtAllwDedAmt"/>
							</xsl:call-template>
						</div>
						<div class="sty8991ScheduleBoxAmt" style="height:7mm;">
							<br/>
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/BaseErosionPymtGrp/CostShrTransPymtAmt"/>
							</xsl:call-template>
						</div>
						<div class="sty8991ScheduleBoxAmt" style="height:7mm;">
							<br/>
							<xsl:call-template name="PopulateAmount">
								<xsl:with-param name="TargetNode" select="$FormData/BaseErosionTaxBnftGrp/CostShrTransPymtAllwDedAmt"/>
							</xsl:call-template>
						</div>
						<div class="sty8991ScheduleBoxInd" style="height:7mm;">
							<br/>
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/Any25PercentageOwnerGrp/CostShrTransPymtInd"/>
							</xsl:call-template>
						</div>
						<div class="sty8991ScheduleBoxInd" style="height:7mm;">
							<br/>
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/BaseErosionPrsnGrp/CostShrTransPymtInd"/>
							</xsl:call-template>
						</div>
						<div class="sty8991ScheduleBoxInd" style="height:7mm;">
							<br/>
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$FormData/BaseErosionOtherPrsnGrp/CostShrTransPymtInd"/>
							</xsl:call-template>
						</div>
					</div>
					<!-- Line 3 -->
					...
					<div class="styStdDivLS">
						...
						<div class="styLNDesc" style="width:81mm;">
							Combine lines 2 through line 11
							<span class="sty8991DotLn">..........</span>
						</div>
						<div class="sty8991ScheduleBoxAmt">
							<xsl:call-template name="PopulateAmount">
					...
					<div class="styStdDivLS">
						...
						<div class="styLNDesc" style="height:19mm;width:81mm;">
							Base erosion tax benefits related to payments reported on lines 2 through 11, on which tax is imposed by section 871,  881, or 884(f), with respect to which tax has been withheld under section 1441 or 1442 at 30% statutory withholding tax rate or subject to tax under Regulations section 1.884-4(a)(2)(ii) at a 30% statutory rate. See instructions.
							<span class="sty8991DotLn">......</span>
						</div>
					...
					<div class="styStdDivLS">
						...
						<div class="styLNDesc" style="height:26mm;width:81mm;">
							Portion of base erosion tax benefits reported on lines 2 through 11, on which tax is imposed by section 871 or 881, with respect to which tax has been withheld under section 1441 or 1442 at reduced withholding rate pursuant to income tax treaty or subject to a reduced rate of tax under Regulations section 1.884-4(a)(2)(ii). Multiply the amount of the base erosion tax benefit by a fraction equal to the rate of tax imposed under the treaty over the 30% statutory rate. See instructions.
							<span class="sty8991DotLn">...</span>
						</div>
						<div class="sty8991ScheduleBoxAmt" style="height:26mm;background-color:lightgrey;">&nbsp;</div>
						<div class="sty8991ScheduleBoxAmt" style="height:26mm;">
							<br/>
							<br/>
							<br/>
							<br/>
						...
						<div class="sty8991ScheduleBoxInd" style="height:26mm;background-color:lightgrey;">&nbsp;</div>
						<div class="sty8991ScheduleBoxInd" style="height:26mm;background-color:lightgrey;">&nbsp;</div>
						<div class="sty8991ScheduleBoxInd" style="height:26mm;background-color:lightgrey;">&nbsp;</div>
					</div>
					<!-- Line 15 -->
							...
							<tbody>
								...
								<xsl:if test="$shouldSepSchB or (count($FormData/WaiverDeductionsGrp) &lt; 13)">
									<xsl:call-template name="FillSchBCols">
										<xsl:with-param name="LineNumber" select="1"/> <!-- 1 + count($FormData/WaiverDeductionsGrp)-->
...
<!-- Additional Data table PART V -->
					...
					<xsl:if test="($Print = $Separated) and count($FormData/CapOrExpnsCostsInventoryGrp) &gt;= 3">
						<div class="styBB" style="width:187mm;float:none;border-top-width:0px;">
							<span class="styRepeatingDataTitle">Additional Questions</span>
						</div>
						<table class="styLeftOverTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<th class="styDepTblCell" scope="col" style="height:10mm;width:52mm;font-weight:normal;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(i)</span>Amount Capitalized or Included in COGS</th>
									<th class="styDepTblCell" scope="col" style="height:10mm;width:45mm;font-weight:normal;text-align:center;border-right-width:0px;vertical-align:top;">
										<span style="font-weight:bold">(ii)</span>Description of item</th>
									<th class="styDepTblCell" scope="col" style="height:10mm;width:45mm;font-weight:normal;border-right-width:0px;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(iii)</span>Line Item Reported on in Prior Year</th>
									<th class="styDepTblCell" scope="col" style="height:10mm;width:45mm;font-weight:normal;border-right-width:1px;text-align:center;vertical-align:top;">
										<span style="font-weight:bold">(iV)</span>Tax Year Form 3115 Was Filed</th>
								</tr>
							</thead>
							<tfoot/>
							<xsl:for-each select="$FormData/CapOrExpnsCostsInventoryGrp">
								<tr>
									...
									<td class="styTableCell" style="width:52mm;height:6mm;vertical-align:bottom;padding-right:0.75mm;border-left:1px;text-align:left;border-color:black">
									...
									<td class="styTableCell" style="width:45mm;height:6mm;vertical-align:bottom;padding-right:0.75mm;border-left:1px;border-right-width:1px;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="ItemShortDesc"/>
										</xsl:call-template>
									</td>
									<td class="styTableCell" style="width:45mm;height:6mm;vertical-align:bottom;text-align:center;padding-right:0.75mm;border-left:1px;border-right-width:1px;">
										<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="WhereReportedFormAndLineTxt"/>
										</xsl:call-template>
									</td>
...
<!-- Additional Data table Schedule B -->
	...
	<xsl:template name="FillPVCols">
		<xsl:param name="index"/>
		<xsl:param name="SepMessage" select="false()"/>
		<tr style="vertical-align:top;">
			<td class="styTableCellCtrInherit" style="font-weight:bold; border-bottom-width:0mm;"><xsl:value-of select="$index"/></td>
			<td class="styTableCellTextInherit"><xsl:choose>
				<xsl:when test="$SepMessage">
					See Additional Data Table
				</xsl:when>
