...
<!-- Last Modified by Jermaine Merchant on 04/24/2025 -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		...
		<html lang="EN-US">
            ...
            border-bottom:0px solid black;border-left:0px solid black;border-right:0px solid black;">
						<!-- Box covers Blank box, Employee's ssn and OMB no.... -->
						<div class="styIRSW2leftBox" style="width:186.9mm;height:8.47mm;border-left:0px; 
              border-bottom:1px solid black;">
                ...
                border-right:0px solid black">
								...
								<span style="font-size: 6.5pt;">OMB No. 1545-0029</span>
							</div>
							<!-- Closes OMB no -->
                ...
                border-left:0px solid black;border-right:0px solid black">
							...
							<div class="styIRSW2leftBox" style="width:30.9mm;height:8.47mm; 
                border-left:0px solid black;border-right:1px solid black">
						...
						<!-- Box covers from Employer Id num to box 14 Other -->
              ...
              border-bottom:1px solid black;border-left:1px solid black;">
							<!-- Box covers from Employer Id num to box F Employee's address and Zip code -->
							<div class="styIRSW2leftBox" style="width:100mm;height:auto; 
                border-left:0px solid black;border-right:0px solid black">
								<!-- Employer Identification number (EIN) -->
								<div class="styIRSW2leftBox" style="width:100mm;height:8.1mm; 
                border-left:0px solid black;border-right:0px solid black;border-top:0px solid black;border-bottom: 0px solid black;">
                  ...
                  <span style="width:.5mm"/>
								...
								<!-- Closes Employer Identification number (EIN) -->
								<!-- Employer's name, address, and ZIP code -->
								<div class="styIRSW2leftBox" style="width:100mm;height:26mm;border-left:0px solid black;border-right:0px solid black;border-top:1px solid black;border-bottom: 1px solid black;">
									<span style="width:1.5mm"/>
                  ...
                  <span style="width:.5mm"/>
								...
								<!-- Control number -->
								<div class="styIRSW2leftBox" style="width:100mm;height:8.6mm;  
                border-left:0px solid black;border-right:0px solid black;border-bottom:1px solid black;">
									<span style="width:1.5mm"/>
                  ...
                  <span style="width:.5mm"/>
								...
								<div class="styIRSW2leftBox" style="width:100mm;height:22.2mm;
                  border-left:0px solid black;border-right:0px solid black;border-bottom:0px solid black;">
                    ...
                    <span style="width:20mm"/>Suff.</span>
								...
								<div class="styIRSW2leftBox" style="width:100mm;height:24.7mm; 
                  border-left:0px solid black;border-right:0px solid black">
							...
							<!-- Closes Boxes (b,c,d,e,f) -->
							<!-- Box covers Boxes 1-10 -->
							<div class="styIRSW2leftBox" style="width:86.73mm;height:auto;
                  border-left:1px solid black;border-right:0px solid black;
                  border-bottom:0px solid black;">
								<!-- Box 1 -->
								<div class="styIRSW2leftBox" style="width:44.8mm;height:8.5mm;border-left:0px solid black;
                border-right:1px solid black;border-top:0px solid black;border-bottom:1px solid black;padding-left:1mm;">
									<!--<span style="width:1.5mm"/>-->
									<span style="font-size:6.5pt;font-weight:bold;padding-left:0.5mm;">1 
                  <span style="width:.5mm"/>
									</span>
									<span style="font-size: 6.5pt">Wages, tips, other compensation</span>
									<span style="padding-right:1mm;padding-top:1mm;width:38mm;float:inherit;text-align:right">
								...
								<!-- Closes Box 1-->
								<!-- Box 2 -->
								<div class="styIRSW2leftBox" style="width:41.6mm;height:8.5mm;border-left:0px solid black;
                border-right:0px solid black;border-top:0px solid black;border-bottom:1px solid black;border-right:1px solid black">
									<span style="width:2.4mm"/>
									<span style="font-size: 6.5pt;font-weight:bold;">2 
                  <span style="width:1.7mm"/>
									</span>
									<span style="font-size: 6.5pt">Federal income tax withheld</span>
									<span style="padding-top:1mm;width:36mm;float:inherit;text-align:right">
										<xsl:call-template name="PopulateAmount">
								...
								<!-- Closes Box 2-->
								<!-- Box 3 -->
								<div class="styIRSW2leftBox" style="width:44.8mm;height:8.5mm;
                    border-left:0px solid black;border-right:1px solid black;
                    border-top:0px solid black;border-bottom:1px solid black">
                      ...
                      <span style="width:.5mm"/>
									...
									<span style="padding-top:1mm;width:38mm;float:inherit;text-align:right">
										<xsl:call-template name="PopulateAmount">
								...
								<!-- Closes Box 3-->
								<!-- Box 4 -->
								<div class="styIRSW2leftBox" style="width:41.6mm;height:8.5mm;
                    border-left:0px solid black;border-right:1px solid black;
                    border-top:0px solid black;border-bottom:1px solid black">
                      ...
                      <span style="width:1.7mm"/>
									...
									<span style="font-size: 6.5pt">Social security tax withheld</span>
									<span style="padding-top:1mm;width:36mm;float:inherit;text-align:right">
										<xsl:call-template name="PopulateAmount">
                    ...
                    border-top:0px solid black;border-bottom:1px solid black">
                      ...
                      <span style="width:1.7mm"/>
								...
								<!-- Closes Box 6 -->
								<!-- Box 7 -->
								<div class="styIRSW2leftBox" style="width:44.5mm;height:8.5mm;
                    border-left:0px solid black;border-right:0px solid black;
                    border-top:0px solid black;border-bottom:1px solid black">
									<span style="width:1.5mm"/>
                      ...
                      <span style="width:.5mm"/>
								...
								<!-- Closes Box 7-->
								<!-- Box 8 -->
								<div class="styIRSW2leftBox" style="width:41.8mm;height:8.5mm;
                    border-left:1px solid black;border-right:1px solid black;
                    border-top:0px solid black;border-bottom:1px solid black">
									<span style="width:2.3mm"/>
                      ...
                      <span style="width:1.7mm"/>
								...
								<!-- Closes Box 8 -->
								<!-- Box 9 -->
								<div class="styIRSW2leftBox" style="width:44.5mm;height:8.5mm;solid black;border-left:0px solid black;border-right:0px solid black;
                    border-top:0px solid black;border-bottom:0px solid black;">
									<span style="width:44.2mm;height:8.3mm;background-color:lightgrey;">
										<!--<span style="width:1.5mm"/>-->
										<span style="font-size: 6.5pt;font-weight:bold;background-color:white;padding-left:1.5mm;">9
                      <span style="width:.5mm"/>
										</span>
										<span style="font-size: 6.5pt"/>
										<span style="padding-top:1mm;width:42.6mm;float:inherit;text-align:right">
											<!--<xsl:call-template name="PopulateText">
								...
								<!-- Closes Box 9-->
								<!-- Box 10 -->
								<div class="styIRSW2leftBox" style="width:41.8mm;height:8.5mm;border-left:1px solid black;
                border-right:1px solid black;border-top:0px solid black;border-bottom:0px solid black;">
                  ...
                  <span style="width:1.7mm"/>
							...
							<!-- Closes Boxes 1,2,3,4,5,6,7,8,9 and 10 -->
							<!-- Box covers Boxes 11, 12a, 12b, 12c, 12d, 13 and 14 -->
							<div class="styIRSW2leftBox" style="width:86.63mm;height:auto;border-left:0px;
                border-right:1px solid black;border-top:1px solid black;">
								<!-- Boxes 11-->
								<div class="styIRSW2leftBox" style="width:45.1mm;height:10.5mm;border-left:1px solid black;
                    border-right:1px solid black;border-top:0px;border-bottom:1px solid black;">
									<span style="width:.5mm"/>
                      ...
                      <span style="width:.5mm"/>
								...
								<div class="styIRSW2rightBox" style="width:41.25mm;border-left: 0px solid black;border-right: 0px solid black;">
									<!-- Code for No Data in Boxes 12a, 12b, 12c and 12d or less than 4 data items-->
									<xsl:if test="(count($FormW2Data/EmployersUseGrp) &lt;=4)">
										<div class="styIRSW2leftBox" style="width:38mm;height:auto; 
                    border-left:0px;border-right:0px;border-top:0px;border-bottom:0px">
											<!-- Boxes 12a, 12b, 12c and 12d -->
											<div class="styIRSW2leftBox" style="width:41.25mm;
                      border-left:0px;border-right:0px;border-top:0px;border-bottom:0px">
												<!-- Left Box 12a -->
												<div class="styIRSW2leftBox" style="width:41.25mm;height:3mm;
                        border-left:0px;border-right:0px;border-top:0px;border-bottom:0px">
                        ...
                        border-left:0px;border-right:1px solid black;border-bottom:1px solid black">
                          ...
                          border-right-width:0px;padding-bottom:.1mm;">c o d e</div>
												...
												<!-- Closes left box 12a-->
												<!-- Right Box 12a -->
												<div class="styIRSW2leftBox" style="width:29.1mm;height:7.5mm;border-top:0px;
                        border-left:0px;border-right:0px;border-bottom:1px solid black">
												...
												<!-- Left Box 12b -->
												<div class="styIRSW2leftBox" style="width:38mm;height:3mm;border-top:0px;
                        ...
                        border-left:0px;border-right:0px;border-bottom:1px solid black;">
											...
											<!-- Grey box -->
											<div class="styIRSW2leftBox" style="width:41.2mm;height:10mm;border-top:0px; 
                      ...
                      for No Data in Boxes 12a, 12b, 12c and 12d or less than 4 data items-->
									<xsl:if test="($Print = $Separated) and (count($FormW2Data/EmployersUseGrp)>4)">
										...
										<div class="styIRSW2leftBox" style="width:41.25mm;height:46.5mm; 
                    border-left:0px;border-right:0px;border-top:0px;border-bottom:0px">
											<!-- Boxes 12a, 12b, 12c and 12d -->
											<div class="styIRSW2leftBox" style="width:41.25mm;height:9.55mm;
                      border-left:0px;border-right:0px;border-top:0px;border-bottom:0px">
												<!-- Left Box 12a -->
												<div class="styIRSW2leftBox" style="width:39mm;height:3mm;
                        border-left:0px;border-right:0px;border-top:0px;border-bottom:0px">
													<span style="width:1mm"/>
												...
												<div class="styIRSW2leftBox" style="width:9mm;height:7.5mm;border-top:0px;
                        border-left:0px;border-right:1px solid black;border-bottom:1px solid black;float:left;">
                          ...
                          border-right-width:0px;padding-bottom:.1mm">c<br/>o<br/>d<br/>e</div>
												...
												<!-- Closes left box 12a-->
												<!-- Right Box 12a -->
												<div class="styIRSW2leftBox" style="width:32.1mm;height:7.5mm;font-size:6pt;border-top:0px;
                        border-left:0px;border-right:0px;border-bottom:1px solid black">
													<br/>
												...
												<!-- Closes Right Box 12a-->
												<!-- Left Box 12b -->
												<div class="styIRSW2leftBox" style="width:39mm;height:3mm;border-top:0px;
                        border-left:0px;border-right:0px;border-bottom:0px">
													<span style="width:1.5mm"/>
													<span style="font-size: 6.5pt;font-weight:bold;">12b
                           <span style="width:.5mm"/>
                        ...
                        border-left:0px;border-right:1px solid black;border-bottom:1px solid black;float:left;">
                          ...
                          border-right-width:0px;padding-bottom:.1mm">c<br/>o<br/>d<br/>e</div>
												...
												<!-- Closes Left Box 12b-->
												<!-- Right Box 12b -->
												<div class="styIRSW2leftBox" style="width:32.1mm;height:7.5mm;border-top:0px;
                        border-left:0px;border-right:0px;border-bottom:1px solid black">
													<br/>
												</div>
												<!-- Closes Right Box 12b-->
                        ...
                        border-left:0px;border-right:1px solid black;border-bottom:1px solid black;float:left;">
                          ...
                          border-right-width:0px;padding-bottom:.1mm">c<br/>o<br/>d<br/>e</div>
												...
												<!-- Right Box 12d -->
												<div class="styIRSW2leftBox" style="width:32.1mm;height:7.5mm;border-top:0px 
                        border-left:0px;border-right:0px;border-bottom:1px solid black;border-left:0px solid black;">
													<br/>
												</div>
												<!-- Closes Right Box 12d-->
											</div>
											...
											<div class="styIRSW2leftBox" style="width:41.05mm;height:10mm;border-top:0px; 
                      background-color:lightgrey;border-left:0px;border-right:0px;border-bottom:0px"/>
											<!-- Closes Grey Box-->
										</div>
                                  ...
                                  But uses code for No Data in Boxes 12a, 12b, 12c and 12d or less than 4 data items-->
									...
									<xsl:if test="(($Print = 'inline') and (count($FormW2Data/EmployersUseGrp)>4))">
										...
										<div class="styGenericDiv" style="width:37mm;height:3mm;border-top:0px;
                      border-left:0px;border-right:0px;border-bottom:0px;clear:none;">
                          ...
                          background-color:lightgrey;border-left:0px;border-right-width:0px;border-bottom:0px"/>
												<!--Closes Grey box-->
											</tbody>
										</table>
										<!--/div-->
									...
									<xsl:if test="(($Print != $Separated) and ($Print !='inline') and (count($FormW2Data/EmployersUseGrp)>4))">
										<!-- Boxes 12a, 12b, 12c and 12d -->
										<div class="styGenericDiv" style="width:36mm;height:3mm;border-top:0px;
                    border-left:0px;border-right:0px;border-bottom:0px;">
											<!-- Header Box 12a -->
											<!--<div class="styTableCellText" style="width:37mm;height:3mm;border-top:0px; 
                           border-left:0px;border-right:0px;border-bottom:0px;background-color:yellow">-->
										...
										<div style="float:right;width:2mm">
										...
										<!-- Big box for Box 12 and Grey Box-->
										<div class="styTableContainer" style="width:41.5mm;height:47mm;float:left;
                    clear:none;border-right:0px;border-bottom:0px;border-left:0px;border-top:0px" id="empUseGrptbl">
                              ...
                              border-left:0px;border-right:0px;border-bottom:1px solid black">
                                ...
                                border-left:0px;border-right:0px;border-bottom:1px solid black">
																	<br/>
																	<span style="padding-top:.5mm;width:20mm;float:bottom;font-size:6pt;
                                  text-align:right;">
																		<xsl:for-each select="$FormW2Data/EmployersUseGrp">
																			<xsl:choose>
																				<xsl:when test="position()=1">
                              ...
                              border-left:0px;border-right:0px;border-bottom:1px solid black">
                                ...
                                border-left:0px;border-right:1px solid black;border-bottom:0px solid black">
                                  ...
                                  border-right-width:0px;padding-bottom:.1mm">c o d e</div>
															...
															<!-- Closes Header 12b -->
															<!-- Right Box 12b -->
															<td class="styTableCellText" style="width:27mm;height:7.5mm;border-top:0px;
                              border-left:0px;border-right:0px;border-bottom:1px solid black">
																<br/>
																<br/>
																<span style="padding-top:.2mm;width:20mm;float:bottom;font-size:6pt;
                                text-align:right;">
																	<xsl:for-each select="$FormW2Data/EmployersUseGrp">
																		<xsl:choose>
																			<xsl:when test="position()=2">
                              ...
                              border-left:0px;border-right:0px;border-bottom:1px solid black">
                                ...
                                border-left:0px;border-right:1px solid black;border-bottom:0px solid black">
                                  ...
                                  border-right-width:0px;padding-bottom:.1mm">c o d e</div>
																...
																<!-- Closes Left Box 12c-->
																<!-- Right Box 12c -->
																<td class="styTableCellText" style="width:29mm;height:7.475mm;border-top:0px;
                                border-left:0px;border-right:0px;border-bottom:1px solid black">
																	<br/>
																	<br/>
																	<span style="padding-top:.2mm;width:20mm;float:bottom;
                                  text-align:right;font-size:6pt">
																		<xsl:for-each select="$FormW2Data/EmployersUseGrp">
																			<xsl:choose>
																				<xsl:when test="position()=3">
                                    ...
                                    height:3mm;border-left:0px;border-right:0px;border-bottom:1px solid black">
                                      ...
                                      border-bottom:0px solid black">
                                        ...
                                        border-right-width:0px;padding-top:.5mm;padding-bottom:.1mm">c o d e</div>
																			...
																			<!-- Closes Left Box 12e-->
																			<!-- Right Box 12e -->
																			<td class="styTableCellText" style="width:32mm;height:8.4mm;
                                      border-left:0px;border-right:0px;border-top:0px;border-bottom:1px solid black">
																				<span style="padding-top:.2mm;width:20mm;float:bottom;
                                        text-align:right;font-size:6pt">
																					<br/>
                                        ...
                                        border-left:0px;border-right:0px;border-top:0px;border-bottom:1px solid black">
                                          ...
                                          border-bottom:1px solid black">
																						<br/>
																						<br/>
																						<span style="padding-top:.2mm;width:20mm;
                                            float:bottom;text-align:right;font-size:6pt">
																							<xsl:call-template name="PopulateAmount">
																								<xsl:with-param name="TargetNode" select="EmployersUseAmt"/>
																							</xsl:call-template>
                          ...
                          background-color:lightgrey;border-left:0px;border-right-width:1px;border-bottom:0px"/>
								...
								<div class="styIRSW2leftBox" style="width:45.1mm;height:10.5mm;border-left:1px solid black;
                    border-right:1px solid black;border-top:0px;border-bottom:1px solid black;">
									<div class="styIRSW2leftBox" style="width:16.5mm;height:10.5mm;border-left:0px solid black;
                       ...
                       border-right:0px solid black;border-top:0px;border-bottom:0px solid black">
								...
								<!-- Closes Box 13-->
								<!-- Box 14 -->
								<div class="styGenericDiv" style="width:11.3mm;height:4mm;font-size:6.5pt;border-left:1px solid black">
									<span style="width:35.5mm;height:4mm;">
										<span style="font-weight:bold;">14</span>
										<span style="width:.5mm"/>Other</span>
								</div>
								<div style="float:right;width:3.2mm;height:4mm;padding-top:0px;border-right:1px solid black;">
									<!--Button display logic-->
									<xsl:call-template name="SetDynamicTableToggleButton">
								...
								<xsl:if test="($Print = 'inline') and (count($FormW2Data/OtherDeductionsBenefitsGrp) &lt;1)">
									<div class="styGenericDiv" style="width:45.1mm;height:24mm;font-size:7pt;
                      border-left:1px solid black;border-right:1px solid black;"/>
								</xsl:if>
								<!-- Line 14 inline print for all data except when blank-->
								<xsl:if test="($Print = 'inline') and (count($FormW2Data/OtherDeductionsBenefitsGrp) &gt; 1)">
									<div class="styGenericDiv" style="width:45.1mm;height:auto;font-size:7pt;
                      border-left:1px solid black;border-right:1px solid black;">
                          ...
                          <tr>
                            <th class="styTableCellHeader" scope="col" style="vertical-align:top;padding-top:0mm;
                              font-size:7pt;width:41mm;border-bottom-width:0px;border-right:0px;">
											...
											<tbody>
												<xsl:if test="(count($FormW2Data/OtherDeductionsBenefitsGrp) &gt;=1)">
													...
													<xsl:for-each select="$FormW2Data/OtherDeductionsBenefitsGrp">
														<tr>
															<td class="styTableCellText" style="width:43mm;height:2mm;border-bottom:0px;
								...
								<!-- Line 14 inline print for all data except when blank, and OtherDeductionsBenefitsGrp equals to 1-->
								<xsl:if test="($Print = 'inline') and (count($FormW2Data/OtherDeductionsBenefitsGrp) = 1)">
									<div class="styGenericDiv" style="width:45.1mm;height:27mm;font-size:7pt;
                      border-left:1px solid black;border-right:1px solid black;">
										<!--This next section was commented out due to display problems with inline printing.-->
										<!--<div class="styTableContainer" style="width:41mm;height:22.5mm;border-right:0px;
                           border-bottom:0px solid black;border-left:1px solid black" id="othDedBen">-->
                            ...
                            <th class="styTableCellHeader" scope="col" style="vertical-align:top;padding-top:0mm;
                              font-size:7pt;width:41mm;border-bottom-width:0px;border-right:0px;">
								...
								<xsl:if test="($Print != 'inline') and ($Print !=$Separated)">
									<div class="styTableContainer" style="width:45.1mm;height:27mm;border-right-width:1px;
                      border-bottom:0px solid black;border-left:1px solid black" id="othDedBen">
										<!-- print logic -->
										<xsl:call-template name="SetInitialState"/>
										<!-- end-->
                      ...
                      border-left:1px solid black;border-right:1px solid black;">
						...
						<!-- Close Boxes from Employer Id num to box 14 Other -->
						<div class="styGenericDiv" style="width:187mm;">
							<div class="styTableContainer" style="width:187mm;border-bottom-width:0px;" id="StateLocalTaxTbl">
								<xsl:call-template name="SetInitialState"/>
								<table class="styTable" cellspacing="0" style="width:182mm;border-collapse:collapse;font-size:6pt;border-color:black;">
									...
									<tbody>
										...
										<xsl:if test="(($Print = $Separated) and (count($FormW2Data/W2StateLocalTaxGrp) &gt; 2)) or (count($FormW2Data/W2StateLocalTaxGrp) &lt;= 1)">
											<tr>
												<td class="styTableCell" style="text-align:left;width:auto;border-bottom-width:1px;">
													<span style="width:0px;"/>
												</td>
												<td class="styTableCell" style="text-align:left;width:auto;border-bottom-width:1px;">
													<span style="width:0px;"/>
												</td>
												<td class="styTableCell" style="text-align:right;width:auto;border-bottom-width:1px;">
													<span style="width:0px;"/>
												</td>
												<td class="styTableCell" style="text-align:right;width:auto;border-bottom-width:1px;">
													<span style="width:0px;"/>
												...
												<td class="styTableCell" style="text-align:left;width:auto;border-right-width:0px;border-bottom-width:1px;">
													<span style="width:0px;"/>
												</td>
											</tr>
										</xsl:if>
              ...
              border-right:0px solid black;padding:top:5mm">
               ...
               border-right:0px solid black">
								...
								<span class="styTY" style="height:12mm;">2025</span>
							</div>
               ...
               border-right:0px solid black">
							...
							<br/>
							<div class="styIRSW2leftBox" style="width:105mm;border-left:0px;
               border-right:0px solid black">
              ...
              border-bottom:0px solid black;">-->
						...
						<!-- Closes footer of form -->
					</div>
					<!-- Page Break before Additional Data-->
	...
	<xsl:template name="CreateLine12TableRowsColored">
        ...
        width:100%;height:5mm;border-right-width:0px;<xsl:value-of select="$IsLast"/>
			</xsl:attribute>
			<xsl:attribute name="class">
				<xsl:choose>
					<xsl:when test="position() mod 2 = 1">styDepTblRow1</xsl:when>
