				...
				<form name="IRS8379" style="font-family:arial;">
					...
					<div class="styBB" style="width:187mm;">
								...
								<span>	
									<input type="checkbox" class="styCkbox" alt="Joint Return Indicator Yes">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/JointReturnInd"/>
											<xsl:with-param name="BackupName">IRS8379YesJointReturnInd</xsl:with-param>
										</xsl:call-template>
									</input>
									...
									</label><b>Yes. </b><span style="width:1mm;"/>Go to line 3.
								</span><br/>	
								<!-- ++++++++++++++ No Checkbox +++++++++++++ -->
								<span>
									<input type="checkbox" class="styCkbox" alt="Joint Return Indicator No">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/JointReturnInd"/>
											<xsl:with-param name="BackupName">IRS8379NoJointReturnInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
									...
									</label><span style="width:8mm;"><b>No.</b></span>
						...
						<div class="styIRS8379LineItem" style="height:32mm;">
							...
							<div class="styIRS8379LNDesc" style="width:181mm;height:15mm">
							...
							<div class="styIRS8379LNDesc" style="width:181mm;">	
								...
								<span>
									<input type="checkbox" class="styCkbox" alt="Joint Pay Past Due Debts Indicator Yes">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/JointPayPastDueDebtsInd"/>
											<xsl:with-param name="BackupName">IRS8379YesJointPayPastDueDebtsInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
									...
									</label><b>Yes. </b><span style="width:1mm;"/>Go to line 4.
								</span>
								<br/>
								<!-- ++++++++++++++ No Checkbox +++++++++++++ -->
								<span>
									<input type="checkbox" class="styCkbox" alt="Joint Pay Past Due Debts Indicator No">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/JointPayPastDueDebtsInd"/>
											<xsl:with-param name="BackupName">IRS8379NoJointPayPastDueDebtsInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
										...
										<span style="width:8mm;"><b>No.</b></span>
						...
						<div class="styIRS8379LineItem" style="height:22mm;">
							...
							<div class="styIRS8379LNDesc" style="width:181mm;">
								...
								<span>
									<input type="checkbox" class="styCkbox" alt="Obligated To Pay Past Due Debts Indicator Yes">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/ObligatedToPayPastDueDebtsInd"/>
											<xsl:with-param name="BackupName">IRS8379YesObligatedToPayPastDueDebtsInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
										...
										<b>Yes. </b><span style="width:1mm;"/>Yes.
										<b>Stop here.</b> Do not file this form. You are not an injured spouse.<br/>
										<span style="width:7.7mm;"/>
										<b>Note:</b> If the past-due amount is for a federal tax liability owed by both you and your spouse, you may qualify for innocent spouse <br/>
								...
								<!-- ++++++++++++++ No Checkbox +++++++++++++ -->
									<input type="checkbox" class="styCkbox" alt="Obligated To Pay Past Due Debts Indicator No">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/ObligatedToPayPastDueDebtsInd"/>
											<xsl:with-param name="BackupName">IRS8379NoObligatedToPayPastDueDebtsInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
									...
									<span style="width:8mm;"><b>No.</b></span>Go to line 5.
								</span>
							</div>
						</div>
						<br/>
						...
						<div class="styIRS8379LineItem" style="height:18mm;">
							...
							<div class="styIRS8379LNDesc" style="width:181mm;">
								...
								<span>	
									<input type="checkbox" class="styCkbox" alt="Community Property State Indicator Yes">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/CommunityPropertyStateInd"/>
											<xsl:with-param name="BackupName">IRS8379YesCommunityPropertyStateInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
										...
										<b>Yes. </b><span style="width:1mm;"/>Yes. Enter the name(s) of the community property state(s)
									<span style="width:83mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px;text-align:center;">
								...
								<!-- ++++++++++++++ No Checkbox +++++++++++++ -->
									<input type="checkbox" class="styCkbox" alt="Community Property State Indicator No">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/CommunityPropertyStateInd"/>
											<xsl:with-param name="BackupName">IRS8379NoCommunityPropertyStateInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
									...
									<span style="width:8mm;"><b>No.</b></span>Go to line 6.
								</span>	
							</div>
						</div>
						<!-- (5b) ////////////////////////////////////////////////////--><!--
						...
						<div class="styIRS8379LineItem" style="height:14mm;">
							...
							<div class="styIRS8379LNDesc" style="width:181mm;">
								...
								<span>	
									<input type="checkbox" class="styCkbox" alt="Payments Made And Reported Indicator Yes">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/PaymentsMadeAndReportedInd"/>
											<xsl:with-param name="BackupName">IRS8379YesPaymentsMadeAndReportedInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
										...
										<b>Yes. </b><span style="width:1mm;"/>Skip lines 7 through 9 and <b>go to Part II</b> and complete the rest of this form.<br/>
								<!-- ++++++++++++++ No Checkbox +++++++++++++ -->
									<input type="checkbox" class="styCkbox" alt="Payments Made And Reported Indicator No">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/PaymentsMadeAndReportedInd"/>
											<xsl:with-param name="BackupName">IRS8379NoPaymentsMadeAndReportedInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
										...
										<span style="width:8mm;"><b>No.</b></span>Go to line 7.
								</span>
							</div>
						</div>
						<br/>
						...
						<div class="styIRS8379LineItem" style="height:14mm;">
							...
							<div class="styIRS8379LNDesc" style="width:181mm;">
								...
								<span>	
									<input type="checkbox" class="styCkbox" alt="Earned Income Indicator Yes">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/EarnedIncomeInd"/>
											<xsl:with-param name="BackupName">IRS8379YesEarnedIncomeInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
										...
										<b>Yes. </b><span style="width:1mm;"/>Go to line 8.<br/>
								<!-- ++++++++++++++ No Checkbox +++++++++++++ -->
									<input type="checkbox" class="styCkbox" alt="Earned Income Indicator No">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/EarnedIncomeInd"/>
											<xsl:with-param name="BackupName">IRS8379NoEarnedIncomeInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
										...
										<span style="width:8mm;"><b>No.</b></span>Skip line 8 and go to line 9.
								</span>
							</div>
						</div>
						<br/>
						...
						<div class="styIRS8379LineItem" style="height:14mm;">
							...
							<div class="styIRS8379LNDesc" style="width:181mm;">
								...
								<span>	
									<input type="checkbox" class="styCkbox" alt="E I C Or Additional Child Tax Credit Indicator Yes">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/EICOrAdditionalChildTaxCrInd"/>
											<xsl:with-param name="BackupName">IRS8379YesEICOrAdditionalChildTaxCrInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
										...
										<b>Yes. </b><span style="width:1mm;"/>Skip line 9 and <b>go to Part II</b> and complete the rest of this form.<br/>
								<!-- ++++++++++++++ No Checkbox +++++++++++++ -->
									<input type="checkbox" class="styCkbox" alt="E I C Or Additional Child Tax Credit Indicator No">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/EICOrAdditionalChildTaxCrInd"/>
											<xsl:with-param name="BackupName">IRS8379NoEICOrAdditionalChildTaxCrInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
									...
									<span style="width:8mm;"><b>No.</b></span>Go to line 9.
								</span>
							</div>
						</div>
						<br/>
						...
						<div class="styIRS8379LineItem" style="height:14mm;">
							...
							<div class="styIRS8379LNDesc" style="width:181mm;">
								...
								<span>	
									<input type="checkbox" class="styCkbox" alt="Refundable Tax Credit Claim Indicator Yes">
										<xsl:call-template name="PopulateYesCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/RefundableTaxCreditClaimInd"/>
											<xsl:with-param name="BackupName">IRS8379YesRefundableTaxCreditClaimInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
										...
										<b>Yes. </b><span style="width:1mm;"/><b>Go to Part II</b> and complete the rest of this form.<br/>
								<!-- ++++++++++++++ No Checkbox +++++++++++++ -->
									<input type="checkbox" class="styCkbox" alt="Refundable Tax Credit Claim Indicator No">
										<xsl:call-template name="PopulateNoCheckbox">
											<xsl:with-param name="TargetNode" select="$Form8379Data/RefundableTaxCreditClaimInd"/>
											<xsl:with-param name="BackupName">IRS8379NoRefundableTaxCreditClaimInd</xsl:with-param>
										</xsl:call-template>
									</input>
									<span style="width:2mm;"/>
									<label>
									...
									<span style="width:8mm;"><b>No.</b></span><b>Stop here.</b> Do not file this form. You are not an injured spouse.
								</span>
							</div>
						</div>
						<br/>
							...
							<div class="styIRS8379LNDesc" style="width:181mm;padding-top:0px;">
								<div class="styIRS8379CleanDiv" style="padding-top:0px;width:100%; height:auto;font-size:8.5pt;">
									...
									<span>
										...
										<input type="checkbox" class="styCkbox" alt="Alternate Address Indicator Yes">
											<xsl:call-template name="PopulateYesCheckbox">
												<xsl:with-param name="TargetNode" select="$Form8379Data/AlternateAddressInd"/>
												<xsl:with-param name="BackupName">IRS8379YesAlternateAddressInd</xsl:with-param>
											</xsl:call-template>
										</input>
									</span>
									<span style="width:2mm;"/>
									...
									<span>
										...
										<input type="checkbox" class="styCkbox" alt="Alternate Address Indicator No">
											<xsl:call-template name="PopulateNoCheckbox">
												<xsl:with-param name="TargetNode" select="$Form8379Data/AlternateAddressInd"/>
												<xsl:with-param name="BackupName">IRS8379NoAlternateAddressInd</xsl:with-param>
											</xsl:call-template>
										</input>
									</span>
									<span style="width:2mm;"/>
