...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
				...
				<form id="IRS940ScheduleA">
					...
					<div class="styTBB" style="width:187mm;border-bottom-width:0px;float:none;clear:both;">
						...
						<div class="styTYBox" style="width:30mm;height:100%;float:right;border-left-width:0px;">
							<div style="font-size:12pt;font-family:Courier New;font-weight:bold;float:right;">860312</div>
							<div class="styOMB" style="border-bottom-width:0px;padding-top:4mm;text-align:right;font-size:7pt;">OMB No. 1545-0029</div>
						</div>
					</div>
	...
	<div style="width:186.5mm;">
		...
		<!--Right Column-->
		<div class="styIRS940SATableColumn" style="width:93mm;float:right;border:black solid 0px;border-left-width:0px;border-right-width:2px;">
			<div class="styIRS940SATableRow">
				<div style="float:left;">
					<div class="styIRS940SAHeaderPA">Postal Abbreviation</div>
					<div class="styIRS940SAHeaderLong">FUTA<br/>Taxable Wages</div>
		...
		<div class="pageEnd" style="width:187mm;">
			<span style="float:left;clear:none;font-weight:bold;">For Paperwork Reduction Act Notice, see Page 2.</span>
			<span style="float:left;clear:none;margin-left:20mm;font-size:6pt;padding-top:0.4mm;">Cat. No. 16997C</span>
			<span style="float:right;clear:none;font-size:6pt;padding-top:0.4mm;"><b>Schedule A (Form 940) 2025</b> Created 04/2/25</span>
		</div>
			...
			<div class="styIRS940SATableRow">
				<div class="styIRS940SAAmtBoxPA" style="text-align:center;">
					<span>
						...
						<input type="checkbox" class="styIRS940SACkbox" aria-label="FUTAStateCd[$StateAbrv]">
				...
				<xsl:choose>
					<xsl:when test="$StateAbrv = 'CA' or $StateAbrv = 'CT' or $StateAbrv = 'NY' or $StateAbrv = 'VI'">
