...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		...
		<html lang="EN-US">
				...
				<form id="IRS1040ScheduleE">
					...
					<div class="styBB" style="width:187mm;border-bottom-width:1px;">
						...
						<div class="styTableContainer" style="width:188mm;border-bottom-width:1px;height:auto;" id="PICctn">
							<!--<xsl:call-template name="SetInitialState"/> ss 2024.06.25 -->
											...
											<tr>
												...
												<xsl:if test="$pos &lt;= 3">
													...
													<td class="styTableCell" rowspan="1" style="width:37mm;border-right-width:0px;text-align:center;">
														<span class="styBoldText" style="font-size:8pt;text-align:center;">Properties:</span>
													</td>
            ...
            <span class="styBoldText" style="font-size:7pt;padding-top:.0mm;padding-left:5mm;float:right;">Schedule E (Form 1040) 2025</span>
          </div>
          <div class="pageEnd" style="width:187mm;" />
					<!-- end page 1 footer -->
					<!-- Page 2 -->
					<div class="styTBB" style="height:5.5mm;width:187mm;">
						<span style="float:left;clear:none;padding-top:1mm;">Schedule E (Form 1040) 2025</span>
					...
					<div class="styBB" style="width:187mm;border-bottom-width:0px;">
						...
						<div class="styTableContainer" style="width:187mm;height:auto;" id="partnerSorpTbl2Id">
							...
							<table class="styTable" style="float:none;clear:both;" cellspacing="0">
								<thead class="styTableThead">
									<tr style="height:auto;">
										<td class="styTableCellHeader" scope="col" style="width:5mm;float:left;clear:none;height:8.5mm;">
											<span class="styTableCellPad"/>
										</td>
                  ...
                  Income or Loss From Real Estate Mortgage Investment Conduits (REMICs)-Residual Holder 
							...
							<table class="styTable" cellspacing="0" style="width:187mm;">
								<thead class="styTableThead">
									<tr style="width:187mm;">
										...
										<th class="styTableCellHeader" style="width:32mm;border-right-width:0px;" colspan="2">
						...
						<div class="pageEnd" style="height:6mm;width:187mm;">
							...
							<div class="stySmallText" style="width:66mm;text-align:right;">
								<span class="styBoldText" style="font-weight:bold;font-size:7pt">Schedule E (Form 1040) 2025</span>
							</div>
						</div>
					</div>
					<!-- end page 2 footer -->
					...
					<xsl:if test="($Print = $Separated) and (count($FormData/PropertyRealEstAndRoyaltyGroup) &gt; 3)"><div style="display:block; page-break-inside:avoid">
					...
					<xsl:if test="($Print = $Separated) and (count($FormData/PartnershipOrSCorpGroup) &gt; 4)"><div style="display:block; page-break-inside:avoid">
					...
					<!-- End Separated Repeating data table -->
					<!-- Begin Separated Repeating data table -->
					<xsl:if test="($Print = $Separated) and (count($FormData/EstateAndTrustGroup) &gt; 3)"><div style="display:block; page-break-inside:avoid">
					...
					<xsl:if test="($Print = $Separated) and (count($FormData/EstateAndTrustGroup) &gt; 3)"><div style="display:block; page-break-inside:avoid">
						...
						<table class="styDepTbl" cellspacing="0" style="font-size:7pt;">
							<thead class="styTableThead">
								<tr class="styDepTblHdr">
									<td class="styDepTblCell" scope="col" rowspan="2" style="width:3.5mm;"/>
					...
					<!-- End Separated Repeating data table -->
					<!-- Begin Separated Repeating data table -->
					<xsl:if test="($Print = $Separated) and (count($FormData/REMICGroup) &gt; 4)"><div style="display:block; page-break-inside:avoid">
