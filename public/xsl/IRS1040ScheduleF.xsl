		...
		<html lang="EN-US">
				...
				<form name="Form1040ScheduleF">
					...
					<div class="styBB" style="width:187mm;height:21mm;">
						<div class="styFNBox" style="width:35mm;height:21mm;">
							...
							<div style="padding-top:6mm;">
								...
								<br/>
								<span class="styAgency">Internal Revenue Service <span style="width:1mm"/></span>
							</div>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:152mm;height:4.5mm;padding-top:1.5mm;">
							<span style="float:left;">
								Did you "materially participate" in the operation of this business during 2025? If "No," see instructions for limit on passive losses
          ...
          <!-- Line G -->
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:67.5mm;height:4mm;">
							<span style="float:left">Amount received in 2025</span>
							<span class="styDotLn" style="float:right;padding-right:1mm;">........</span>
						</div>
					...
					<div style="width:187mm;">
						...
						<div class="styLNDesc" style="width:80mm;height:4mm;">
							If election to defer to 2026 is attached, check here
							<!--<span class="styDotLn" style="float:right;padding-right:1mm;">..</span>-->
							<xsl:call-template name="SetFormLinkInline">
	...
	<xsl:if test="($Print = $Separated) or (count($Form1040SchFData/FarmExpensesGrp/OtherFarmExpensesGrp/OtherFarmExpense) &lt;= 5) ">
					...
					<div style="width:187mm;">
						...
						<div style="float:right;">
							...
							<span class="styBoldText">Schedule F (Form 1040) 2025 </span>
						</div>
					</div>
					...
					<!-- Header -->
					<div class="styBB" style="width:187mm;">
						<div style="float:left;">Schedule F (Form 1040) 2025 <span style="width:120mm;"/>
						</div>
					...
					<div style="width:187mm;">
						...
						<div style="width:60mm;text-align:right;">
							<span class="styBoldText" style="font-weight:bold;">Schedule F (Form 1040) 2025</span>
						</div>
					</div>
					<br/>
					<br class="pageEnd"/>
