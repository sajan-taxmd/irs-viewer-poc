	...
	<xsl:template match="/">
            ...
            <span class="styFormNumber">1065</span>
                ...
                <br/>
						...
						<div class="styLblNameAddr" style="border-width:1px;width:118.5mm;height:auto;">
							...
							<div class="styNameAddr" style="width:118.5mm;height:12mm;font-size:8px;border-left-width:1px;padding-left:1px;">Name of partnership<br/>
							...
							<div class="styNameAddr" style="width:95.5mm;height:12mm;border-left-width:1px;">
							  Number and street<br/><br/>
								<span class="stySmallText" style="padding-left:2mm;width:95mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
							...
							<div class="styNameAddr" style="width:22.4mm;height:12mm;border-left-width:1px;">
							  Room or suite no.<br/><br/>
								<!--<span class="stySmallText" style="padding-left:2mm;width:80mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
										<xsl:with-param name="TargetNode">AddressLine1Txt</xsl:with-param>
									</xsl:call-template>
									<br/>
								...
								<span class="stySmallText" style="width:22.5mm;border-left-width:1px;">
								</span>-->
							</div>							
							<div class="styNameAddr" style="border-bottom-width:0px;width:32mm;height:18mm;border-left-width:1px;">City or town<br/><br/>
							...
							<div class="styNameAddr" style="border-bottom-width:0px;width:32mm;height:18mm;border-left-width:1px;">State or province<br/><br/>							
								<span class="stySmallText" style="padding-left:2mm;padding-top:5mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
							...
							<div class="styNameAddr" style="border-bottom-width:0px;width:31.5mm;height:18mm;border-left-width:1px;">Country<br/><br/>							
								<span class="stySmallText" style="padding-left:2mm;padding-top:5mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
							...
							<div class="styNameAddr" style="border-bottom-width:0px;width:22mm;height:18mm;border-left-width:1px;">ZIP or foreign postal code<br/><br/>							
								<span class="stySmallText" style="padding-left:2mm;padding-top:3mm;">
									<xsl:call-template name="PopulateReturnHeaderFiler">
      ...
      Number of Schedules K-1. Attach one for each person who was a partner at any time during the tax year 
						...
						<div style="width:181mm;float:right;clear:none">
							...
							<div class="styLNDesc" style="width:57mm;height:4mm;">
						      ...
						      <!-- Form to Form Link -->
								...
								<span style="width:24mm;text-align:right;border-bottom:solid black 1px;font-size:6.5pt;">
									<xsl:call-template name="PopulateAmount">
											<xsl:with-param name="TargetNode" select="$Form1065Data/GrossReceiptsOrSalesAmt"/>
									</xsl:call-template>
								</span>
						...
						<div style="width:181mm;float:right;clear:none;">
							...
							<div class="styLNDesc" style="width:132mm;height:4mm;">
							  Net gain (loss) from Form 4797, Part II, line 17 (attach Form 4797)
								...
								<span style="width:1mm"/>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">Form 1065, Income - Line 6</xsl:with-param>
									<xsl:with-param name="TargetNode" select="$Form1065Data/TotalOrdinaryGainLossAmt/@form4684Cd"/>
								</xsl:call-template>
								<!--Dotted Line-->
								<span style="width:1.8mm"/>
								<span style=" letter-spacing:3.1mm; font-weight:bold; ">.........</span>
					...
					<div class="styBB" style="width:187mm;">
						...
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftLtrBox" style="height:4.5mm;padding-top:0.5mm;">
								<span style="width:4px;"/>b
							</div>
							<div class="styLNDesc" style="width:92mm;height:4.5mm;">
							...
							<div class="styLNRightNumBox" style="height:4.5mm" aria-label="Amount of line 16a less 16b">16c</div>
							<div class="styLNAmountBox" style="height:4.5mm">
								<xsl:call-template name="PopulateAmount">
							...
							<div class="styLNDesc" style="width:132mm;height:4mm;">
								...
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">
									  Form 1065, Line 23 - Three And One Half Percent</xsl:with-param>
									<xsl:with-param name="TargetNode" select="$Form1065Data/OrdinaryBusinessIncomeLossAmt/@threeAndOneHalfPercentAmt"/>
								</xsl:call-template>
								<span style="width:1mm"/>
								<xsl:call-template name="LinkToLeftoverDataTableInline">
									<xsl:with-param name="Desc">
									  Form 1065, Line 23 - Qlfy Therapeutic Discovery Credit</xsl:with-param>
					...
					<div class="styBB" style="width:187mm;">
						<div class="styIRS1065VTImageBox" style="height:49mm;padding-top:9mm;">
						...
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftNumBox" style="height:4mm;">32a</div>
							<div class="styLNDesc" style="width:132mm;height:4mm;">
							...
							<div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0;padding-bottom:0mm">32a</div>
							<div class="styLNAmountBox" style="height:4.5mm;border-bottom-width:0;padding-bottom:0mm">
								<xsl:call-template name="PopulateAmount">
						...
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftLtrBox" style="height:4mm;">
								<span style="width:4px;padding-top:3.5mm;"/>b
							</div>
							<div class="styLNDesc" style="width:132mm;height:mm;">
								Routing number 
								<span style="width:35mm;text-align:center;border-bottom:solid black 1px;">
									<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form1065Data/DirectDepositGrp/RoutingTransitNum"/>
									</xsl:call-template>
								</span>
								...
								<input type="checkbox" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1065Data/DirectDepositGrp/CheckingAccountInd"/>
										<xsl:with-param name="BackupName">IRS1065CheckingAccountInd</xsl:with-param>
									</xsl:call-template>
								</input>
								<label>
									<xsl:call-template name="PopulateLabel">
								...
								<input type="checkbox" class="styCkbox">
									<xsl:call-template name="PopulateCheckbox">
										<xsl:with-param name="TargetNode" select="$Form1065Data/DirectDepositGrp/SavingsAccountInd"/>
										<xsl:with-param name="BackupName">IRS1065SavingsAccountInd</xsl:with-param>
									</xsl:call-template>
								</input>
								<label>
									<xsl:call-template name="PopulateLabel">
							...
							<div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0;background:gray;"></div>
							<div class="styLNAmountBox" style="height:4.5mm;border-bottom-width:0;background:gray;">
							</div>
						</div>
						<div style="width:181mm;float:right;clear:none;">
							<div class="styLNLeftLtrBox" style="height:4.5mm;padding-top:1.5mm;">
								<span style="width:4px;"/>d
							</div>
							<div class="styLNDesc" style="width:132mm;height:4.5mm;padding-top:1.5mm;">
								Account number 
								<span style="width:90mm;text-align:center;border-bottom:solid black 1px;">
									<xsl:call-template name="PopulateText">
											<xsl:with-param name="TargetNode" select="$Form1065Data/DirectDepositGrp/DepositorAccountNum"/>
									</xsl:call-template>
								</span>
							</div>
							<div class="styLNRightNumBox" style="height:4.5mm;border-bottom-width:0;background:gray;"></div>
					...
					<div class="pageEnd" style="width:187mm;padding-top:1mm;">
						...
						<div style="float:right;">
							<span style="width:40px;"/>  
							  Form <span class="styBoldText" style="font-size:8pt;">1065</span> (2025)
						</div>
					</div>
					<p style="page-break-before: always"/>
					...
					<div class="styBB" style="width:187mm;padding-top:.5mm;">
						<div style="float:left;">Form 1065 (2025)<span style="width:148mm;"/>
						</div>
		...
		<thead class="styTableThead">
			<tr>
				...
				<th class="styTableCellHeader" style="width:34mm;vertical-align:top;font-size:6.5pt;border-color:black;border-right-width:0;font-weight:normal" scope="col">
					<b>(iv)</b>
                Percentage <br/>owned in voting stock
				</th>
			</tr>
		</thead>
		<tfoot/>
	...
	<table class="styTable" cellspacing="0">
		<thead class="styTableThead">
			<tr>
				...
				<th class="styTableCellHeader" style="width:26mm;vertical-align:center;font-size:6.5pt;border-color:black;font-weight:normal;" scope="col">
					<b>(iii)</b>
              Type of <br/>entity
				</th>
				<th class="styTableCellHeader" style="width:29mm;vertical-align:center;font-size:6.5pt;border-color:black;font-weight:normal;" scope="col">
					<b>(iv)</b>
				...
				<th class="styTableCellHeader" style="width:33mm;vertical-align:top;font-size:6.5pt;border-color:black;black;border-right-width:0;font-weight:normal;" scope="col">
					<b>(v)</b>
                   Maximum <br/>percentage owned in <br/>profit, loss, or capital
				</th>
			</tr>
		</thead>
		<tfoot/>
...
<!-- End Set Initial Height of Above Table -->
					...
					<div style="width:187mm">
						...
						<div class="styLNDesc" style="height:4mm; width:167mm;">Does the partnership satisfy 
							...
							<span class="styIRS1065LNYesNoBox" style="height:4mm;border-left-width:1;border-right-width:1;">Yes</span>
							<span class="styIRS1065LNYesNoBox" style="height:4mm;border-left-width:1;">No</span>
					</div>
					<div style="width:187mm">
					...
					<div class="styBB" style="width:187mm">
						...
						<div class="styLNDesc" style="height:4mm;width:167mm">
						  During the tax year, did the partnership have any debt that was canceled, was forgiven, or had the 
					...
					<div class="styBB" style="width:187mm">
						...
						<div class="styLNDesc" style="height:9mm;width:167mm">
							At any time during calendar year 2025,
...
effective date 
					...
					<div style="width:187mm">
						...
						<div class="styLNDesc" style="height:4mm;width:167mm">
						  For this tax year, did the partnership make an optional basis adjustment under section 743(b)? If “Yes,” enter the total aggregate 			
						</div>
						<div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom-width:0"/>
						<div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom-width:0"/>
					</div>						  
					...
					<div style="width:187mm">
						...
						<div class="styIRS1065LNYesNoBox" style="height:4mm;border-left-width:1;border-right-width:1;border-bottom-width:1;">Yes</div>
						<div class="styIRS1065LNYesNoBox" style="height:4mm;border-left-width:1;border-bottom-width:1;">No</div>
					</div>					
					<div style="width:187mm">                          
						<div class="styLNLeftNumBox" style="height:4mm; padding-left:3.5mm;"></div>
						<div class="styLNDesc" style="height:4mm;width:167mm">                          
					...
					<div style="width:187mm">
						...
						<div class="styLNDesc" style="height:4mm;width:167mm">
						  section 734(b) adjustments for all partnership property made in the tax year. The partnership must also attach a statement showing
					</div>
					<div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom:0"/>
					<div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom:0"/>
					</div>
					<div style="width:187mm">
						<div class="styLNLeftLtrBox" style="height:4mm;padding-left:4mm"></div>
						<div class="styLNDesc" style="height:4mm;width:167mm">
						  the computation and allocation of each basis adjustment. See instructions
						<span style="width:1.8mm"/>
						<span style=" letter-spacing:3.1mm; font-weight:bold; ">..................</span>
					</div>	
						<div class="styIRS1065LNYesNoBox" style="height:4mm; border-left-width:1; border-bottom-width:0;font-weight:normal;">
					...
					<div class="styBB" style="width:187mm">
						...
						<div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom:0;border-top:1;"/>
						<div class="styIRS1065LNYesNoBox" style="height:4mm;background:gray;border-bottom:0;border-top:1;"/>
					</div>	
					<!-- SCHEDULE B Line 11-->
					<div class="styBB" style="width:187mm">
...
Disregarded Entities (FDEs) and Foreign Branches (FBs), enter the number of Forms 8858 attached. See instructions
							...
							<span style="width:34mm;text-align:right;border-bottom:solid black 1px;">
								<xsl:call-template name="PopulateAmount">
									<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/Form8858AttachedCnt"/>
								</xsl:call-template>
							</span>
					...
					<div class="styBB" style="width:187mm">
						<div class="styLNLeftLtrBox" style="height:4mm;padding-left:4mm">b</div>
						<div class="styLNDesc" style="height:auto;width:167mm">
						  The owner of a qualified business unit (QBU) as defined in section 989(a) with a functional currency different than its owner (including a foreign disregarded entity, foreign branch, or foreign partnership) is required to file Form 8964, Information Return of U.S. Persons With Respect to Certain Qualified Business Units, and related schedules. Enter the number of Forms 8964 attached to this Form 1065
							<span style="width:25mm;text-align:right;border-bottom:solid black 1px;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/Form8964USQBUCnt"/>
								</xsl:call-template>
							</span>
							   to Forms 5471 for controlled foreign corporations owned by the partnership
							<span style="width:25mm;text-align:right;border-bottom:solid black 1px;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/Form8964CFCQBUCnt"/>
								</xsl:call-template>
							</span>							
							    and to Forms 8865 for controlled foreign partnerships owned by the partnership 
							<span style="width:25mm;text-align:right;border-bottom:solid black 1px;">
								<xsl:call-template name="PopulateText">
									<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/Form8964FPSQBUCnt"/>
								</xsl:call-template>
							</span>	
						</div>
						<div class="styIRS1065LNYesNoBox" style="height:16.5mm;background:gray;border-bottom-width:0"/>
						<div class="styIRS1065LNYesNoBox" style="height:16.5mm;background:gray;border-bottom-width:0"/>
					</div>
					<!-- SCHEDULE B Line 14-->
					<div class="styBB" style="width:187mm">
					...
					<div class="styBB" style="width:187mm">
						...
						<div class="styIRS1065LNYesNoBox" style="height:8mm;right-border-width:0;background:gray;border-bottom-width:0;"/>
						<div class="styIRS1065LNYesNoBox" style="height:8mm;background:gray;border-bottom-width:0;"/>
					</div>
					<!-- SCHEDULE B Line 18-->
					<div class="styBB" style="width:187mm">
					...
					<div class="styBB" style="width:187mm">
						<div class="styLNLeftNumBox" style="height:4mm;">19</div>
						<div class="styLNDesc" style="height:auto;width:167mm">
						  During the partnership’s tax year, did the partnership make any payments, or receive any payments allocable to foreign partners, that would require it to file Forms 1042 and 1042-S under chapter 3 (sections 1441 through 1464) or chapter 4 (sections 1471
						</div>
						<div class="styIRS1065LNYesNoBox" style="height:7mm;right-border-width:0;background:gray;border-bottom-width:0;"/>
						<div class="styIRS1065LNYesNoBox" style="height:7mm;background:gray;border-bottom-width:0;"/>
...
8996, line 15
					...
					<div class="styBB" style="width:187mm">
						<div style="width:187mm">
						<div class="styLNLeftNumBox" style="height:4mm;padding-top:1.5mm;">28</div>
						<div class="styLNDesc" style="height:4mm;width:167mm;padding-top:1.5mm;">
						...
						<div style="width:187mm">                          
							<div class="styLNLeftNumBox" style="height:4mm;padding-left:3.5mm;"></div>
							<div class="styLNDesc" style="height:9.5mm;width:167mm">
								trade or business of your partnership, and was the ownership percentage (by vote or value) for
								...
								<div class="styIRS1065LNYesNoBox" style="height:9.5mm;background:gray;border-bottom:0"/>
								<div class="styIRS1065LNYesNoBox" style="height:9.5mm;background:gray;border-bottom:0"/>
						</div>
						<div style="width:187mm">                          
						<div class="styLNLeftNumBox" style="height:4mm; padding-left:3.5mm;"></div>						  
					...
					<!-- SCHEDULE B Line 31-->
					<div style="width:187mm">
						<div class="styLNLeftNumBox" style="height:4mm;padding-left:1.5mm;">31</div>
						<div class="styLNDesc" style="height:4mm;width:167mm;">
						  Reserved for future use
							<span style=" letter-spacing:3.2mm; font-weight:bold; ">.................................</span>
						</div>
						<div class="styIRS1065LNYesNoBox" style="height:4mm;right-border-width:0;border-bottom-width:0;background:gray;"/>
						<div class="styIRS1065LNYesNoBox" style="height:4mm;border-bottom-width:0;background:gray;"/>
						<!--<div class="styLNDesc" style="height:6mm;width:167mm;">
						  Did a direct or indirect partner request information from this partnership to compute the corporate alternative minimum tax, either for the current tax year or prior tax years, and the partnership hasn't received notification from the partner or indirect partner that  
						</div>
						<div class="styIRS1065LNYesNoBox" style="height:6mm;right-border-width:0;background:gray;border-bottom-width:0;"/>
						<div class="styIRS1065LNYesNoBox" style="height:6mm;background:gray;border-bottom-width:0;"/>-->
					</div>					
					<div class="styBB" style="width:187mm">
						<!--<div class="styLNLeftNumBox" style="height:4mm; padding-left:3.5mm;"></div>
						<div class="styLNDesc" style="height:4mm;width:167mm;">
						  such information isn't required?
							<span style=" letter-spacing:3.2mm; font-weight:bold; ">..............................</span>
						</div>
						<div class="styIRS1065LNYesNoBox" style="height:4mm;border-left-width:1;border-bottom-width:0;font-weight:normal;">
							<xsl:call-template name="PopulateYesBoxText">
					...
					<!-- SCHEDULE B Line 32-->
					<div class="styBB" style="width:187mm">
						<div class="styLNLeftNumBox" style="height:5mm;padding-left:1.5mm;padding-top:2mm;">32</div>
						<div class="styLNDesc" style="height:5mm;width:167mm">
						  Check this box if an election out of subchapter K under section 761 is being made. See instructions
								<span style=" letter-spacing:3.2mm;font-weight:bold; ">.........</span>  
							<input class="styCkBox" alt="ElectOutSubchapterKSect761Ind" type="checkbox" name="Checkbox">
								<xsl:call-template name="PopulateCheckbox">
									<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/ElectOutSubchapterKSect761Ind"/>
									<xsl:with-param name="BackupName">IRS1065ElectOutSubchapterKSect761Ind</xsl:with-param>
								</xsl:call-template>
							</input>
						</div>
						<div class="styIRS1065LNYesNoBox" style="height:5mm;background:gray;border-bottom:0"/>
					...
					<!-- SCHEDULE B Line 33-->
					<div style="width:187mm">
						<div class="styLNLeftNumBox" style="height:4mm; padding-left:1.5mm;padding-top:1mm;">33</div>
					...
					<div class="styBB" style="height:10mm;width:187mm;font-size:8pt;padding-top:2mm;">
					...
					<br/>
					<div style="width:187mm;">
						<div class="styNameAddr" style="height:12mm;width:94mm;font-size:7pt;">
                          First name of PR (or entity name)<br/><br/>
							<xsl:choose>
						...
						<div class="styNameAddr" style="height:12mm;width:93mm;font-size:7pt;border-left-width:1px;">
                          Last name of PR<br/><br/>
						</div>
					</div>
					<div style="width:187mm;">
						<div class="styNameAddr" style="height:12.5mm;width:18mm;font-size:7pt;border-right-width:1px;">
                          U.S. Address of PR</div>
						<div class="styNameAddr" style="height:12.5mm;width:66mm;font-size:7pt;border-right-width:1px;">
							Street <br/><br/>
							<xsl:choose>
								<xsl:when test="$Form1065ScheduleB/EntityPRDesignationGrp/BusinessName/BusinessNameLine1Txt">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/EntityPRDesignationGrp/USAddress/AddressLine1Txt"/>
									</xsl:call-template><br/>
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/EntityPRDesignationGrp/USAddress/AddressLine2Txt"/>
									</xsl:call-template>
								</xsl:when>									
								<xsl:otherwise>									
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/IndividualPRDesignationGrp/USAddress/AddressLine1Txt"/>
									</xsl:call-template><br/>									
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/IndividualPRDesignationGrp/USAddress/AddressLine2Txt"/>
									</xsl:call-template>
								</xsl:otherwise>
							</xsl:choose>
						</div>
						<div class="styNameAddr" style="height:12.5mm;width:41mm;font-size:7pt;border-right-width:1px;">
							City <br/><br/>
							<xsl:choose>
								<xsl:when test="$Form1065ScheduleB/EntityPRDesignationGrp/BusinessName/BusinessNameLine1Txt">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/EntityPRDesignationGrp/USAddress/CityNm"/>
									</xsl:call-template>
								</xsl:when>									
								<xsl:otherwise>									
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/IndividualPRDesignationGrp/USAddress/CityNm"/>
									</xsl:call-template>
								</xsl:otherwise>
							</xsl:choose>
						</div>
						<div class="styNameAddr" style="height:12.5mm;width:11mm;font-size:7pt;border-right-width:1px;">
							State <br/><br/>
							<xsl:choose>
								<xsl:when test="$Form1065ScheduleB/EntityPRDesignationGrp/BusinessName/BusinessNameLine1Txt">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/EntityPRDesignationGrp/USAddress/StateAbbreviationCd"/>
									</xsl:call-template>
								</xsl:when>									
								<xsl:otherwise>									
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/IndividualPRDesignationGrp/USAddress/StateAbbreviationCd"/>
									</xsl:call-template>
								</xsl:otherwise>
							</xsl:choose>
						</div>
						<div class="styNameAddr" style="height:12.5mm;width:18mm;font-size:7pt;border-right-width:1px;">
							...
							<xsl:choose>
								<xsl:when test="$Form1065ScheduleB/EntityPRDesignationGrp/BusinessName/BusinessNameLine1Txt">
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/EntityPRDesignationGrp/USAddress/ZIPCd"/>
									</xsl:call-template>
								</xsl:when>									
								<xsl:otherwise>									
									<xsl:call-template name="PopulateText">
										<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/IndividualPRDesignationGrp/USAddress/ZIPCd"/>
									</xsl:call-template>
								</xsl:otherwise>
							</xsl:choose>
						</div>
						<div class="styNameAddr" style="height:12.5mm;font-size:7pt;width:33mm;">
                          U.S. phone number of PR <br/><br/>
							<xsl:choose>
								<xsl:when test="$Form1065ScheduleB/EntityPRDesignationGrp/BusinessName/BusinessNameLine1Txt">
					...
					<div class="styBB" style="width:187mm;height:6mm;font-size:7pt;padding-top:2mm;">
                          Name of designated individual (DI) if PR is an entity
					</div>
					<div style="width:187mm;">
						<div class="styNameAddr" style="height:9.5mm;width:94mm;font-size:7pt;">
							First Name of DI <br/><br/>
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/EntityPRDesignationGrp/IndividualDesigneeApptGrp/PersonNm"/>
							</xsl:call-template>
						</div>
						<div class="styNameAddr" style="height:9.5mm;width:93mm;font-size:7pt;border-left-width:1px;">
							Last Name of DI <br/><br/>
						</div>
					</div>
					<div style="width:187mm;">
						<div class="styNameAddr" style="height:12.5mm;width:18mm;font-size:7pt;border-right-width:1px;">
                          U.S. Address of DI</div>
						<div class="styNameAddr" style="height:12.5mm;width:66mm;font-size:7pt;border-right-width:1px;">
							Street <br/><br/>
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/EntityPRDesignationGrp/IndividualDesigneeApptGrp/USAddress/AddressLine1Txt"/>
							</xsl:call-template><br/>
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/EntityPRDesignationGrp/IndividualDesigneeApptGrp/USAddress/AddressLine2Txt"/>
							</xsl:call-template>							
						</div>
						<div class="styNameAddr" style="height:12.5mm;width:41mm;font-size:7pt;border-right-width:1px;">
							City <br/><br/>
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/EntityPRDesignationGrp/IndividualDesigneeApptGrp/USAddress/CityNm"/>
							</xsl:call-template>
						</div>
						<div class="styNameAddr" style="height:12.5mm;width:11mm;font-size:7pt;border-right-width:1px;">
							State <br/><br/>
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/EntityPRDesignationGrp/IndividualDesigneeApptGrp/USAddress/StateAbbreviationCd"/>
							</xsl:call-template>
						</div>
						<div class="styNameAddr" style="height:12.5mm;width:18mm;font-size:7pt;border-right-width:1px;">
							ZIP Code <br/><br/>
							<xsl:call-template name="PopulateText">
								<xsl:with-param name="TargetNode" select="$Form1065ScheduleB/EntityPRDesignationGrp/IndividualDesigneeApptGrp/USAddress/ZIPCd"/>
							</xsl:call-template>
						</div>
						<div class="styNameAddr" style="height:12.5mm;font-size:7pt;width:33mm;">
                          U.S. phone number of PR <br/><br/>
					...
					<div class="styBB" style="width:187mm;">
								...
								<!-- Begin Schedule K section "Credit and Credit Recapture", Line 15a-f -->
									<div style="width:187mm;">
									<div class="styIRS1065VTImageBox" style="width:11mm;height:32.1mm;padding-left:1mm;border-bottom:1px solid black;">
								...
								<!-- Begin Schedule K section "International Transactions", Line 16a-b -->
								<div style="width:187mm;">
									<div class="styIRS1065VTImageBox" style="width:11mm;height:13mm;border-bottom:1px solid black;padding-left:.5mm;padding-top:1mm;">
										<img src="{$ImagePath}/1065_Transactions.gif" alt="International"/>
									</div>

								<!-- Schedule K, Line 16a -->

									<div class="styLNLeftNumBox" style="padding-top:1mm;">16a</div>
									<div class="styIRS1065LNDesc" style="width:124.5mm;padding-top:1mm;">
											Attach Schedule K-2 (Form 1065), Partners’ Distributive Share Items--International, and check
									</div>		
									<div class="styLNRightNumBox" style="width:11.5mm;background-color:lightgrey;border-bottom:0;"/>
									<div class="styLNAmountBox" style="background-color:lightgrey;border-bottom:0;"/>											
									<div class="styLNLeftNumBox"></div>
									<div class="styIRS1065LNDesc" style="width:124.5mm;height:4.5mm;">
											this box to indicate that you are reporting items of international tax relevance
										<xsl:call-template name="LinkToLeftoverDataTableInline">
											<xsl:with-param name="Desc">
											  Form 1065, Schedule K, Line 16a - International Tax Relevance Reporting Indicator</xsl:with-param>
										...
										<span style="float:right;padding-left:4px;">
											<span class="styIRS1065DotLn">...</span>
											<input class="styCkBox" style="width:3mm;height:3mm;" alt="IntntlTaxRelevanceRptgInd" type="checkbox" name="Checkbox">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="$Form1065ScheduleK/IntntlTaxRelevanceRptgInd"/>
									...
									<div class="styLNRightNumBox" style="height:4.5mm;width:11.5mm;border-bottom:0;background-color:lightgrey;"/>
									<div class="styLNAmountBox" style="height:4.5mm;border-bottom:0;background-color:lightgrey"/>

								<!-- Schedule K, Line 16b -->

									<div class="styIRS1065LNLeftLtrBoxTD" style="height:4.5mm;border-bottom:1px solid black;">b</div>
									<div class="styIRS1065LNDesc" style="width:124.5mm;border-bottom:1px solid black;height:4.5mm;">								
										Check this box if you qualified for an exception to filing Schedule K-2 (Form 1065)
										<span style="float:right;padding-left:4px;">
											<span class="styIRS1065DotLn">...</span>
											<input class="styCkBox" style="width:3mm;height:3mm;" alt="DomesticFilingExceptionInd" type="checkbox" name="Checkbox">
												<xsl:call-template name="PopulateCheckbox">
													<xsl:with-param name="TargetNode" select="$Form1065ScheduleK/DomesticFilingExceptionInd"/>
													<xsl:with-param name="BackupName">IRS1065DomesticFilingExceptionInd</xsl:with-param>
												</xsl:call-template>
											</input>
										</span>
									</div>
						...
						<table class="styTable" cellspacing="0" style="width:187mm;">
							<thead class="styTableThead">
								<tr>
									...
									<th class="styTableCellHeader" style="width:25mm;border-color:black;border-top-width:1px;border-left-width:1px;font-size:7pt;vertical-align:top;" scope="col">
            ...
            (ii)<span style="width:3px;"/><span class="styNormalText">Individual</span> <br/><span class="styNormalText" style="padding-left:1mm;">(active)</span>
									</th>
									<th class="styTableCellHeader" style="width:25mm;border-color:black;border-top-width:1px;font-size:7pt;" scope="col">
            (iii)<span style="width:3px;"/><span class="styNormalText">Individual</span> <br/><span class="styNormalText" style="padding-left:1mm;">(passive)</span>
									</th>
									<th class="styTableCellHeader" style="width:25mm;border-color:black;border-top-width:1px;font-size:7pt;vertical-align:top;" scope="col">
            (iv)<span style="width:3px;"/><span class="styNormalText">Partnership</span>
									</th>
									<th class="styTableCellHeader" style="width:25mm;border-color:black;border-top-width:1px; font-size:7pt;" scope="col">
            (v)<span style="width:3px;"/><span class="styNormalText">Exempt</span> <br/><span class="styNormalText" style="padding-left:1mm;">organization</span>
									</th>
									<th class="styTableCellHeader" style="width:25mm;border-color:black;border-top-width:1px;font-size:7pt;" scope="col">
            (vi)<br/><span class="styNormalText" style="font-size:6pt;"> Nominee/Other</span>
				...
				<div style="width:187mm;">
					...
					<div style="height:55.5mm;width:187mm;border-style:solid;border-color:black;border-width:0px 0px 1px 0px">
						...
						<table class="styTable" style="width:93.5mm;float:left;font-size:7pt;height:59mm;" cellspacing="0">
							...
							<tbody>
								...
								<tr class="styGenericDiv">
									<td class="styLNLeftNumBoxSD" style="height:7.5mm;width:4mm;padding-top:1.5mm;padding-bottom:0mm;">5</td>
									...
									<td class="styLNAmountBoxNBB" style="height:7.5mm;border-right-width:1px;padding-top:3mm;padding-bottom:0mm;">
										<xsl:call-template name="PopulateAmount">
						...
						<table class="styTable" style="height:50mm;width:93.5mm;float:left;font-size:7pt;" cellspacing="0">
							...
							<tbody>
								...
								<tr class="styGenericDiv">
									...
									<td class="styLNDesc" style="height:12mm;width:57mm;font-size:7pt;padding-left:4mm;padding-bottom:0mm;" colspan="2">
									  Income (loss) (<i>Analysis of Net Income (Loss) per Return</i>, line 1). Subtract line 8 from line 5
										<!--Dotted Line-->
										<span class="styDotLn" style="float:right;clear:none;padding-right:2mm;">.........</span>
									</td>
									<td class="styLNAmountBox" style="height:10mm;border-bottom-width:0px;padding-top:6mm;padding-bottom:0mm;">
										<xsl:call-template name="PopulateAmount">
					...
					<table class="styLeftOverTbl">
						...
						<xsl:call-template name="PopulateLeftoverRowAmount">
						   <xsl:with-param name="Desc">Form 1065, Line 6 - Net gain (loss) from Form 4797, Part II, line 17
						   </xsl:with-param>
						   <xsl:with-param name="TargetNode" select="$Form1065Data/TotalOrdinaryGainLossAmt/@form4684Cd"/>
						   <xsl:with-param name="DescWidth" select="130"/>
						</xsl:call-template>						
						<xsl:call-template name="PopulateLeftoverRowAmount">
						   <xsl:with-param name="Desc">Form 1065, Line 23 - Three And One Half Percent
						   </xsl:with-param>
						   <xsl:with-param name="TargetNode" select="$Form1065Data/OrdinaryBusinessIncomeLossAmt/@threeAndOneHalfPercentAmt"/>
						   <xsl:with-param name="DescWidth" select="130"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
						   <xsl:with-param name="Desc">Form 1065, Line 23 - Qualifying Therapeutic Discovery Credit
						   </xsl:with-param>
						   <xsl:with-param name="TargetNode" select="$Form1065Data/OrdinaryBusinessIncomeLossAmt/@qlfyTherapeuticDiscoveryCrAmt"/>
						   <xsl:with-param name="DescWidth" select="130"/>
						</xsl:call-template>
						...
						<xsl:call-template name="PopulateLeftoverRowAmount">
						   <xsl:with-param name="Desc">Form 1065, Schedule K, Line 13d - Section 59(e)(2) expenditures
						   </xsl:with-param>
						   <xsl:with-param name="TargetNode" select="$Form1065ScheduleK/Sect59e2ExpenditureDesc"/>
						   <xsl:with-param name="DescWidth" select="130"/>
						</xsl:call-template>
						<xsl:call-template name="PopulateLeftoverRowAmount">
							<xsl:with-param name="Desc">Form 1065, Schedule K, Line 13e - Other deductions (see instructions)
						   </xsl:with-param>
							<xsl:with-param name="TargetNode" select="$Form1065ScheduleK/OtherDeductionsAmt/@otherDeductionsDesc"/>
							<xsl:with-param name="DescWidth" select="130"/>
						</xsl:call-template>
