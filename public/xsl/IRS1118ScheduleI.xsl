      ...
      <span style="font-size:6pt;">(Rev. December, 2021)</span> 
		...
		<!-- Form Subtitle -->
			...
			<span style="font-weight:bold;padding-top:.5mm;">
			   Go to <a style="text-decoration:none;color:black;" href="http://www.irs.gov/Form1118" title="Link to IRS.gov"> 
			   <i>www.irs.gov/Form1118</i></a> for the latest information.
			</span>
			<br/>
			<div>
				<span style="width:123mm;font-family:Arial;font-weight:bold;font-size:7pt;padding-top:1mm">
				 For calendar year 20
					<span style="float:none;text-align:left;width:3mm">
						<xsl:value-of select="substring($RtnHdrData/TaxYr,3,2)"/>
					</span> or tax year beginning
					<span style="float:none;text-align:left;width:8mm">
