...
<!-- Updated By Iskilu Lawal 01/28/2025 UWR # 998273  -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="CreateFormHeader">
		<div class="styIRSW2VICleanDiv" style="float:none;clear:both;width:187mm;border-width:0px 0px 0px 0px;height:auto;display:block;">
			<!-- Left (Top) -->
				...
				<form name="IRSW2VI">
							...
							<div class="styIRSW2VICleanDiv" style="width:28%;height:100%;">
								<div class="styIRSW2VILNDesc" style="width:100%;font-size:8pt;padding-left:5px;">
									...
									<div class="styIRSW2VILNDesc" style="width:100%;border-left-width:0px;">
										<span class="styBoldText">OMB No. 1545-0029</span>
									</div>
								</div>
							</div>
						</div>
                    ...
                    Suff.
							...
							<div class="styIRSW2VICleanDiv" style="width:25.12%;">
								...
								<!-- (14) Other-->
								<div style="width:46.6mm;border-left-width:0px;border-right:1px solid black;height:auto;display:block;">
									<div class="styIRSW2VICleanDiv" style="width:46.6mm;height:auto;border-width:0px 0px 0px 0px;display:block;">
										<div class="styIRSW2VILNLeftNumBox" style="padding-right:9px;display:block;">14</div>
										<div class="styIRSW2VILNDesc" style="width:auto;display:block;">Other</div>
										<div class="styIRSW2VICleanDiv" style="width:auto;float:right;border-left-width:0px;display:block;">
									...
									<div class="styTableContainerNBB" id="OtherDeductsBenefitsDiv">
										<xsl:attribute name="style">
                      width:100%;height:auto;border-right-width:0px;padding:0px 0px 0px 0px;display:block;
